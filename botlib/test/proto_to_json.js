 ...
 */
const protoToJson = require('../proto_to_json.js');
const assert = require('assert');

describe('protoToJson', () => {
  const json = {
    'num': 0,
    'bool': true,
    'str': 's',
  ...
  it('should convert goog.protobuf.Struct to JSON', () => {
    assert.deepEqual(protoToJson.structProtoToJson(structProto), json);
  });
