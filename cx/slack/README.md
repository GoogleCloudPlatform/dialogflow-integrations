...
```shell
gcloud builds submit --tag gcr.io/PROJECT-ID/dialogflow-slack
```
...
```shell
gcloud beta run deploy --image gcr.io/PROJECT_ID/dialogflow-slack --service-account DIALOGFLOW_SERVICE_ACCOUNT --memory 1Gi
```
