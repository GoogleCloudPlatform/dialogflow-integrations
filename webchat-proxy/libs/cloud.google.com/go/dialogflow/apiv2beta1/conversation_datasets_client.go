...
type ConversationDatasetsCallOptions struct {
	...
	GetAnnotatedConversationDataset    []gax.CallOption
	ListAnnotatedConversationDatasets  []gax.CallOption
	DeleteAnnotatedConversationDataset []gax.CallOption
	ImportConversationData             []gax.CallOption
	LabelConversation                  []gax.CallOption
...
type internalConversationDatasetsClient interface {
	...
	GetAnnotatedConversationDataset(context.Context, *dialogflowpb.GetAnnotatedConversationDatasetRequest, ...gax.CallOption) (*dialogflowpb.AnnotatedConversationDataset, error)
	ListAnnotatedConversationDatasets(context.Context, *dialogflowpb.ListAnnotatedConversationDatasetsRequest, ...gax.CallOption) *AnnotatedConversationDatasetIterator
	DeleteAnnotatedConversationDataset(context.Context, *dialogflowpb.DeleteAnnotatedConversationDatasetRequest, ...gax.CallOption) error
	...
	LabelConversation(context.Context, *dialogflowpb.LabelConversationRequest, ...gax.CallOption) (*LabelConversationOperation, error)
	LabelConversationOperation(name string) *LabelConversationOperation
...
// DeleteConversationDataset deletes the specified conversation dataset and all annotated conversation
...
// GetAnnotatedConversationDataset retrieves the specified annotated conversation dataset.
//
// Deprecated: GetAnnotatedConversationDataset may be removed in a future version.
func (c *ConversationDatasetsClient) GetAnnotatedConversationDataset(ctx context.Context, req *dialogflowpb.GetAnnotatedConversationDatasetRequest, opts ...gax.CallOption) (*dialogflowpb.AnnotatedConversationDataset, error) {
	return c.internalClient.GetAnnotatedConversationDataset(ctx, req, opts...)
}

// ListAnnotatedConversationDatasets returns the list of all annotated conversation datasets that
// belong to a given conversation dataset.
//
// Deprecated: ListAnnotatedConversationDatasets may be removed in a future version.
func (c *ConversationDatasetsClient) ListAnnotatedConversationDatasets(ctx context.Context, req *dialogflowpb.ListAnnotatedConversationDatasetsRequest, opts ...gax.CallOption) *AnnotatedConversationDatasetIterator {
	return c.internalClient.ListAnnotatedConversationDatasets(ctx, req, opts...)
}

// DeleteAnnotatedConversationDataset deletes the specified annotated conversation dataset and annotations that
// belongs to it.
//
// Deprecated: DeleteAnnotatedConversationDataset may be removed in a future version.
func (c *ConversationDatasetsClient) DeleteAnnotatedConversationDataset(ctx context.Context, req *dialogflowpb.DeleteAnnotatedConversationDatasetRequest, opts ...gax.CallOption) error {
	return c.internalClient.DeleteAnnotatedConversationDataset(ctx, req, opts...)
}
...
//
// Deprecated: LabelConversation may be removed in a future version.
func (c *ConversationDatasetsClient) LabelConversation(ctx context.Context, req *dialogflowpb.LabelConversationRequest, opts ...gax.CallOption) (*LabelConversationOperation, error) {
	return c.internalClient.LabelConversation(ctx, req, opts...)
}

// LabelConversationOperation returns a new LabelConversationOperation from a given name.
// The name must be that of a previously created LabelConversationOperation, possibly from a different process.
func (c *ConversationDatasetsClient) LabelConversationOperation(name string) *LabelConversationOperation {
	return c.internalClient.LabelConversationOperation(name)
}
...
func (c *conversationDatasetsGRPCClient) CreateConversationDataset(ctx context.Context, req *dialogflowpb.CreateConversationDatasetRequest, opts ...gax.CallOption) (*CreateConversationDatasetOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.conversationDatasetsClient.CreateConversationDataset, req, settings.GRPC, c.logger, "CreateConversationDataset")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *conversationDatasetsGRPCClient) GetConversationDataset(ctx context.Context, req *dialogflowpb.GetConversationDatasetRequest, opts ...gax.CallOption) (*dialogflowpb.ConversationDataset, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.conversationDatasetsClient.GetConversationDataset, req, settings.GRPC, c.logger, "GetConversationDataset")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *conversationDatasetsGRPCClient) ListConversationDatasets(ctx context.Context, req *dialogflowpb.ListConversationDatasetsRequest, opts ...gax.CallOption) *ConversationDatasetIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*dialogflowpb.ConversationDataset, string, error) {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.conversationDatasetsClient.ListConversationDatasets, req, settings.GRPC, c.logger, "ListConversationDatasets")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
...
func (c *conversationDatasetsGRPCClient) DeleteConversationDataset(ctx context.Context, req *dialogflowpb.DeleteConversationDatasetRequest, opts ...gax.CallOption) (*DeleteConversationDatasetOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.conversationDatasetsClient.DeleteConversationDataset, req, settings.GRPC, c.logger, "DeleteConversationDataset")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *conversationDatasetsGRPCClient) GetAnnotatedConversationDataset(ctx context.Context, req *dialogflowpb.GetAnnotatedConversationDatasetRequest, opts ...gax.CallOption) (*dialogflowpb.AnnotatedConversationDataset, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).GetAnnotatedConversationDataset[0:len((*c.CallOptions).GetAnnotatedConversationDataset):len((*c.CallOptions).GetAnnotatedConversationDataset)], opts...)
	var resp *dialogflowpb.AnnotatedConversationDataset
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.conversationDatasetsClient.GetAnnotatedConversationDataset, req, settings.GRPC, c.logger, "GetAnnotatedConversationDataset")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *conversationDatasetsGRPCClient) ListAnnotatedConversationDatasets(ctx context.Context, req *dialogflowpb.ListAnnotatedConversationDatasetsRequest, opts ...gax.CallOption) *AnnotatedConversationDatasetIterator {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).ListAnnotatedConversationDatasets[0:len((*c.CallOptions).ListAnnotatedConversationDatasets):len((*c.CallOptions).ListAnnotatedConversationDatasets)], opts...)
	it := &AnnotatedConversationDatasetIterator{}
	req = proto.Clone(req).(*dialogflowpb.ListAnnotatedConversationDatasetsRequest)
	it.InternalFetch = func(pageSize int, pageToken string) ([]*dialogflowpb.AnnotatedConversationDataset, string, error) {
		resp := &dialogflowpb.ListAnnotatedConversationDatasetsResponse{}
		if pageToken != "" {
			req.PageToken = pageToken
		}
		if pageSize > math.MaxInt32 {
		...
		err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			var err error
			resp, err = executeRPC(ctx, c.conversationDatasetsClient.ListAnnotatedConversationDatasets, req, settings.GRPC, c.logger, "ListAnnotatedConversationDatasets")
			return err
		}, opts...)
		if err != nil {
			return nil, "", err
		...
		it.Response = resp
		return resp.GetAnnotatedConversationDatasets(), resp.GetNextPageToken(), nil
	}
	fetch := func(pageSize int, pageToken string) (string, error) {
		items, nextPageToken, err := it.InternalFetch(pageSize, pageToken)
		if err != nil {
...
func (c *conversationDatasetsGRPCClient) DeleteAnnotatedConversationDataset(ctx context.Context, req *dialogflowpb.DeleteAnnotatedConversationDatasetRequest, opts ...gax.CallOption) error {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).DeleteAnnotatedConversationDataset[0:len((*c.CallOptions).DeleteAnnotatedConversationDataset):len((*c.CallOptions).DeleteAnnotatedConversationDataset)], opts...)
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		_, err = executeRPC(ctx, c.conversationDatasetsClient.DeleteAnnotatedConversationDataset, req, settings.GRPC, c.logger, "DeleteAnnotatedConversationDataset")
		return err
	}, opts...)
	return err
}
...
func (c *conversationDatasetsGRPCClient) ImportConversationData(ctx context.Context, req *dialogflowpb.ImportConversationDataRequest, opts ...gax.CallOption) (*ImportConversationDataOperation, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.conversationDatasetsClient.ImportConversationData, req, settings.GRPC, c.logger, "ImportConversationData")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *conversationDatasetsGRPCClient) LabelConversation(ctx context.Context, req *dialogflowpb.LabelConversationRequest, opts ...gax.CallOption) (*LabelConversationOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).LabelConversation[0:len((*c.CallOptions).LabelConversation):len((*c.CallOptions).LabelConversation)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.conversationDatasetsClient.LabelConversation, req, settings.GRPC, c.logger, "LabelConversation")
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &LabelConversationOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}
...
func (c *conversationDatasetsRESTClient) CreateConversationDataset(ctx context.Context, req *dialogflowpb.CreateConversationDatasetRequest, opts ...gax.CallOption) (*CreateConversationDatasetOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v/conversationDatasets", req.GetParent())
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "CreateConversationDataset")
		if err != nil {
			return err
		}
...
func (c *conversationDatasetsRESTClient) GetConversationDataset(ctx context.Context, req *dialogflowpb.GetConversationDatasetRequest, opts ...gax.CallOption) (*dialogflowpb.ConversationDataset, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetConversationDataset")
		if err != nil {
			return err
		}
...
func (c *conversationDatasetsRESTClient) ListConversationDatasets(ctx context.Context, req *dialogflowpb.ListConversationDatasetsRequest, opts ...gax.CallOption) *ConversationDatasetIterator {
	...
	it.InternalFetch = func(pageSize int, pageToken string) ([]*dialogflowpb.ConversationDataset, string, error) {
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListConversationDatasets")
			if err != nil {
				return err
			}
			if err := unm.Unmarshal(buf, resp); err != nil {
...
func (c *conversationDatasetsRESTClient) DeleteConversationDataset(ctx context.Context, req *dialogflowpb.DeleteConversationDatasetRequest, opts ...gax.CallOption) (*DeleteConversationDatasetOperation, error) {
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "DeleteConversationDataset")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
//
// Deprecated: GetAnnotatedConversationDataset may be removed in a future version.
func (c *conversationDatasetsRESTClient) GetAnnotatedConversationDataset(ctx context.Context, req *dialogflowpb.GetAnnotatedConversationDatasetRequest, opts ...gax.CallOption) (*dialogflowpb.AnnotatedConversationDataset, error) {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return nil, err
	}
	...
	opts = append((*c.CallOptions).GetAnnotatedConversationDataset[0:len((*c.CallOptions).GetAnnotatedConversationDataset):len((*c.CallOptions).GetAnnotatedConversationDataset)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &dialogflowpb.AnnotatedConversationDataset{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "GetAnnotatedConversationDataset")
		if err != nil {
			return err
		}
...
//
// Deprecated: ListAnnotatedConversationDatasets may be removed in a future version.
func (c *conversationDatasetsRESTClient) ListAnnotatedConversationDatasets(ctx context.Context, req *dialogflowpb.ListAnnotatedConversationDatasetsRequest, opts ...gax.CallOption) *AnnotatedConversationDatasetIterator {
	it := &AnnotatedConversationDatasetIterator{}
	req = proto.Clone(req).(*dialogflowpb.ListAnnotatedConversationDatasetsRequest)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	it.InternalFetch = func(pageSize int, pageToken string) ([]*dialogflowpb.AnnotatedConversationDataset, string, error) {
		...
		baseUrl.Path += fmt.Sprintf("/v2beta1/%v/annotatedConversationDatasets", req.GetParent())
		...
		e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
			...
			buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "ListAnnotatedConversationDatasets")
			if err != nil {
				return err
			}
			if err := unm.Unmarshal(buf, resp); err != nil {
...
//
// Deprecated: DeleteAnnotatedConversationDataset may be removed in a future version.
func (c *conversationDatasetsRESTClient) DeleteAnnotatedConversationDataset(ctx context.Context, req *dialogflowpb.DeleteAnnotatedConversationDatasetRequest, opts ...gax.CallOption) error {
	baseUrl, err := url.Parse(c.endpoint)
	if err != nil {
		return err
	}
	...
	return gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		_, err = executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, nil, "DeleteAnnotatedConversationDataset")
		return err
	}, opts...)
}
...
func (c *conversationDatasetsRESTClient) ImportConversationData(ctx context.Context, req *dialogflowpb.ImportConversationDataRequest, opts ...gax.CallOption) (*ImportConversationDataOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v:importConversationData", req.GetName())
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "ImportConversationData")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
//
// Deprecated: LabelConversation may be removed in a future version.
func (c *conversationDatasetsRESTClient) LabelConversation(ctx context.Context, req *dialogflowpb.LabelConversationRequest, opts ...gax.CallOption) (*LabelConversationOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v:labelConversation", req.GetParent())
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "LabelConversation")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
// LabelConversationOperation returns a new LabelConversationOperation from a given name.
// The name must be that of a previously created LabelConversationOperation, possibly from a different process.
func (c *conversationDatasetsGRPCClient) LabelConversationOperation(name string) *LabelConversationOperation {
	return &LabelConversationOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
// LabelConversationOperation returns a new LabelConversationOperation from a given name.
// The name must be that of a previously created LabelConversationOperation, possibly from a different process.
func (c *conversationDatasetsRESTClient) LabelConversationOperation(name string) *LabelConversationOperation {
	override := fmt.Sprintf("/v2beta1/%s", name)
	return &LabelConversationOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
