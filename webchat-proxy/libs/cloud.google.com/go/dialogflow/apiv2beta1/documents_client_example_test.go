...
func ExampleDocumentsClient_ExportDocument() {
	...
	req := &dialogflowpb.ExportDocumentRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/dialogflow/apiv2beta1/dialogflowpb#ExportDocumentRequest.
	}
...
func ExampleDocumentsClient_GenerateDocument() {
	ctx := context.Background()
	// This snippet has been automatically generated and should be regarded as a code template only.
	// It will require modifications to work:
	// - It may require correct/in-range values for request initialization.
	...
	req := &dialogflowpb.GenerateDocumentRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/dialogflow/apiv2beta1/dialogflowpb#GenerateDocumentRequest.
	}
	op, err := c.GenerateDocument(ctx, req)
	if err != nil {
		// TODO: Handle error.
	}
