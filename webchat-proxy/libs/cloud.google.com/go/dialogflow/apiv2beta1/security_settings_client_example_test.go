...
func ExampleNewSecuritySettingsClient() {
	...
	c, err := dialogflow.NewSecuritySettingsClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
...
func ExampleNewSecuritySettingsRESTClient() {
	...
	// - It may require specifying regional endpoints when creating the service client as shown in:
	//   https://pkg.go.dev/cloud.google.com/go#hdr-Client_Options
	c, err := dialogflow.NewSecuritySettingsRESTClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
...
func ExampleSecuritySettingsClient_GetSecuritySettings() {
	...
	req := &dialogflowpb.GetSecuritySettingsRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/dialogflow/apiv2beta1/dialogflowpb#GetSecuritySettingsRequest.
	}
...
func ExampleSecuritySettingsClient_UpdateSecuritySettings() {
	...
	req := &dialogflowpb.UpdateSecuritySettingsRequest{
		// TODO: Fill request struct fields.
		// See https://pkg.go.dev/cloud.google.com/go/dialogflow/apiv2beta1/dialogflowpb#UpdateSecuritySettingsRequest.
	}
