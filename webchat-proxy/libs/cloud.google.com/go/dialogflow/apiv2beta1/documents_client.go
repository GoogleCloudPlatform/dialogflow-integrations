...
type DocumentsCallOptions struct {
	...
	GenerateDocument []gax.CallOption
...
type internalDocumentsClient interface {
	...
	GenerateDocument(context.Context, *dialogflowpb.GenerateDocumentRequest, ...gax.CallOption) (*GenerateDocumentOperation, error)
	GenerateDocumentOperation(name string) *GenerateDocumentOperation
...
// GenerateDocument creates a knowledge service document for specified knowledge type
...
//
//	response: Document
func (c *DocumentsClient) GenerateDocument(ctx context.Context, req *dialogflowpb.GenerateDocumentRequest, opts ...gax.CallOption) (*GenerateDocumentOperation, error) {
	return c.internalClient.GenerateDocument(ctx, req, opts...)
}

// GenerateDocumentOperation returns a new GenerateDocumentOperation from a given name.
// The name must be that of a previously created GenerateDocumentOperation, possibly from a different process.
func (c *DocumentsClient) GenerateDocumentOperation(name string) *GenerateDocumentOperation {
	return c.internalClient.GenerateDocumentOperation(name)
}
...
func (c *documentsGRPCClient) GenerateDocument(ctx context.Context, req *dialogflowpb.GenerateDocumentRequest, opts ...gax.CallOption) (*GenerateDocumentOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).GenerateDocument[0:len((*c.CallOptions).GenerateDocument):len((*c.CallOptions).GenerateDocument)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.documentsClient.GenerateDocument, req, settings.GRPC, c.logger, "GenerateDocument")
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &GenerateDocumentOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}
...
func (c *documentsRESTClient) ExportDocument(ctx context.Context, req *dialogflowpb.ExportDocumentRequest, opts ...gax.CallOption) (*ExportDocumentOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v:export", req.GetName())
...
//
//	response: Document
func (c *documentsRESTClient) GenerateDocument(ctx context.Context, req *dialogflowpb.GenerateDocumentRequest, opts ...gax.CallOption) (*GenerateDocumentOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v/documents:generate", req.GetParent())
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "GenerateDocument")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
// GenerateDocumentOperation returns a new GenerateDocumentOperation from a given name.
// The name must be that of a previously created GenerateDocumentOperation, possibly from a different process.
func (c *documentsGRPCClient) GenerateDocumentOperation(name string) *GenerateDocumentOperation {
	return &GenerateDocumentOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
// GenerateDocumentOperation returns a new GenerateDocumentOperation from a given name.
// The name must be that of a previously created GenerateDocumentOperation, possibly from a different process.
func (c *documentsRESTClient) GenerateDocumentOperation(name string) *GenerateDocumentOperation {
	override := fmt.Sprintf("/v2beta1/%s", name)
	return &GenerateDocumentOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
