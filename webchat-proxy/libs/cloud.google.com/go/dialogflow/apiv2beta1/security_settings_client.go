...
type internalSecuritySettingsClient interface {
	...
	GetSecuritySettings(context.Context, *dialogflowpb.GetSecuritySettingsRequest, ...gax.CallOption) (*dialogflowpb.SecuritySettings, error)
	UpdateSecuritySettings(context.Context, *dialogflowpb.UpdateSecuritySettingsRequest, ...gax.CallOption) (*dialogflowpb.SecuritySettings, error)
...
// GetSecuritySettings retrieves the current security settings for the specified project. The
// returned settings may be stale by up to 1 minute.
func (c *SecuritySettingsClient) GetSecuritySettings(ctx context.Context, req *dialogflowpb.GetSecuritySettingsRequest, opts ...gax.CallOption) (*dialogflowpb.SecuritySettings, error) {
	return c.internalClient.GetSecuritySettings(ctx, req, opts...)
}

// UpdateSecuritySettings updates the security settings for the specified project.
func (c *SecuritySettingsClient) UpdateSecuritySettings(ctx context.Context, req *dialogflowpb.UpdateSecuritySettingsRequest, opts ...gax.CallOption) (*dialogflowpb.SecuritySettings, error) {
...
type securitySettingsGRPCClient struct {
	...
	// The gRPC API client.
	securitySettingsClient dialogflowpb.SecuritySettingsServiceClient
...
func NewSecuritySettingsClient(ctx context.Context, opts ...option.ClientOption) (*SecuritySettingsClient, error) {
	...
	c := &securitySettingsGRPCClient{
		connPool:               connPool,
		securitySettingsClient: dialogflowpb.NewSecuritySettingsServiceClient(connPool),
...
func (c *securitySettingsGRPCClient) GetSecuritySettings(ctx context.Context, req *dialogflowpb.GetSecuritySettingsRequest, opts ...gax.CallOption) (*dialogflowpb.SecuritySettings, error) {
	...
	var resp *dialogflowpb.SecuritySettings
...
func (c *securitySettingsGRPCClient) UpdateSecuritySettings(ctx context.Context, req *dialogflowpb.UpdateSecuritySettingsRequest, opts ...gax.CallOption) (*dialogflowpb.SecuritySettings, error) {
...
// GetSecuritySettings retrieves the current security settings for the specified project. The
// returned settings may be stale by up to 1 minute.
func (c *securitySettingsRESTClient) GetSecuritySettings(ctx context.Context, req *dialogflowpb.GetSecuritySettingsRequest, opts ...gax.CallOption) (*dialogflowpb.SecuritySettings, error) {
	...
	resp := &dialogflowpb.SecuritySettings{}
...
// UpdateSecuritySettings updates the security settings for the specified project.
func (c *securitySettingsRESTClient) UpdateSecuritySettings(ctx context.Context, req *dialogflowpb.UpdateSecuritySettingsRequest, opts ...gax.CallOption) (*dialogflowpb.SecuritySettings, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v", req.GetSettings().GetName())
