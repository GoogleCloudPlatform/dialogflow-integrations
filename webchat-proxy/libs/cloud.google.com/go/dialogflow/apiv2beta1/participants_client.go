...
type ParticipantsCallOptions struct {
	...
	SuggestSmartComposeAnswers  []gax.CallOption
	SuggestDialogflowAssists    []gax.CallOption
	SuggestKnowledgeAssist      []gax.CallOption
	ListSuggestions             []gax.CallOption
	CompileSuggestion           []gax.CallOption
	BidiEndpointInteract        []gax.CallOption
...
type internalParticipantsClient interface {
	...
	SuggestSmartComposeAnswers(context.Context, *dialogflowpb.SuggestSmartComposeAnswersRequest, ...gax.CallOption) (*dialogflowpb.SuggestSmartComposeAnswersResponse, error)
	SuggestDialogflowAssists(context.Context, *dialogflowpb.SuggestDialogflowAssistsRequest, ...gax.CallOption) (*dialogflowpb.SuggestDialogflowAssistsResponse, error)
	...
	BidiEndpointInteract(context.Context, ...gax.CallOption) (dialogflowpb.Participants_BidiEndpointInteractClient, error)
...
// SuggestSmartComposeAnswers gets smart compose suggestions for a participant based on specific
// historical messages.
func (c *ParticipantsClient) SuggestSmartComposeAnswers(ctx context.Context, req *dialogflowpb.SuggestSmartComposeAnswersRequest, opts ...gax.CallOption) (*dialogflowpb.SuggestSmartComposeAnswersResponse, error) {
	return c.internalClient.SuggestSmartComposeAnswers(ctx, req, opts...)
}

// SuggestDialogflowAssists gets Dialogflow assist answers for a participant based on specific
// historical messages.
func (c *ParticipantsClient) SuggestDialogflowAssists(ctx context.Context, req *dialogflowpb.SuggestDialogflowAssistsRequest, opts ...gax.CallOption) (*dialogflowpb.SuggestDialogflowAssistsResponse, error) {
	return c.internalClient.SuggestDialogflowAssists(ctx, req, opts...)
}
...
// BidiEndpointInteract bidirectional interaction of an endpoint with the conversation.
...
//
// This method is not supported for the REST transport.
func (c *ParticipantsClient) BidiEndpointInteract(ctx context.Context, opts ...gax.CallOption) (dialogflowpb.Participants_BidiEndpointInteractClient, error) {
	return c.internalClient.BidiEndpointInteract(ctx, opts...)
}
...
func (c *participantsGRPCClient) SuggestSmartComposeAnswers(ctx context.Context, req *dialogflowpb.SuggestSmartComposeAnswersRequest, opts ...gax.CallOption) (*dialogflowpb.SuggestSmartComposeAnswersResponse, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).SuggestSmartComposeAnswers[0:len((*c.CallOptions).SuggestSmartComposeAnswers):len((*c.CallOptions).SuggestSmartComposeAnswers)], opts...)
	var resp *dialogflowpb.SuggestSmartComposeAnswersResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.participantsClient.SuggestSmartComposeAnswers, req, settings.GRPC, c.logger, "SuggestSmartComposeAnswers")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *participantsGRPCClient) SuggestDialogflowAssists(ctx context.Context, req *dialogflowpb.SuggestDialogflowAssistsRequest, opts ...gax.CallOption) (*dialogflowpb.SuggestDialogflowAssistsResponse, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).SuggestDialogflowAssists[0:len((*c.CallOptions).SuggestDialogflowAssists):len((*c.CallOptions).SuggestDialogflowAssists)], opts...)
	var resp *dialogflowpb.SuggestDialogflowAssistsResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.participantsClient.SuggestDialogflowAssists, req, settings.GRPC, c.logger, "SuggestDialogflowAssists")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *participantsGRPCClient) BidiEndpointInteract(ctx context.Context, opts ...gax.CallOption) (dialogflowpb.Participants_BidiEndpointInteractClient, error) {
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, c.xGoogHeaders...)
	var resp dialogflowpb.Participants_BidiEndpointInteractClient
	opts = append((*c.CallOptions).BidiEndpointInteract[0:len((*c.CallOptions).BidiEndpointInteract):len((*c.CallOptions).BidiEndpointInteract)], opts...)
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		c.logger.DebugContext(ctx, "api streaming client request", "serviceName", serviceName, "rpcName", "BidiEndpointInteract")
		resp, err = c.participantsClient.BidiEndpointInteract(ctx, settings.GRPC...)
		c.logger.DebugContext(ctx, "api streaming client response", "serviceName", serviceName, "rpcName", "BidiEndpointInteract")
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
// SuggestSmartComposeAnswers gets smart compose suggestions for a participant based on specific
// historical messages.
func (c *participantsRESTClient) SuggestSmartComposeAnswers(ctx context.Context, req *dialogflowpb.SuggestSmartComposeAnswersRequest, opts ...gax.CallOption) (*dialogflowpb.SuggestSmartComposeAnswersResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v/suggestions:suggestSmartComposeAnswers", req.GetParent())
	...
	opts = append((*c.CallOptions).SuggestSmartComposeAnswers[0:len((*c.CallOptions).SuggestSmartComposeAnswers):len((*c.CallOptions).SuggestSmartComposeAnswers)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &dialogflowpb.SuggestSmartComposeAnswersResponse{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "SuggestSmartComposeAnswers")
		if err != nil {
			return err
		}
...
// SuggestDialogflowAssists gets Dialogflow assist answers for a participant based on specific
// historical messages.
func (c *participantsRESTClient) SuggestDialogflowAssists(ctx context.Context, req *dialogflowpb.SuggestDialogflowAssistsRequest, opts ...gax.CallOption) (*dialogflowpb.SuggestDialogflowAssistsResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v/suggestions:suggestDialogflowAssists", req.GetParent())
	...
	opts = append((*c.CallOptions).SuggestDialogflowAssists[0:len((*c.CallOptions).SuggestDialogflowAssists):len((*c.CallOptions).SuggestDialogflowAssists)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &dialogflowpb.SuggestDialogflowAssistsResponse{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "SuggestDialogflowAssists")
		if err != nil {
			return err
		}
...
//
// This method is not supported for the REST transport.
func (c *participantsRESTClient) BidiEndpointInteract(ctx context.Context, opts ...gax.CallOption) (dialogflowpb.Participants_BidiEndpointInteractClient, error) {
	return nil, errors.New("BidiEndpointInteract not yet supported for REST clients")
}
