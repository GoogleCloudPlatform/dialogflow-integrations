...
type ConversationModelsCallOptions struct {
	...
	CopyConversationModel     []gax.CallOption
...
type internalConversationModelsClient interface {
	...
	CopyConversationModel(context.Context, *dialogflowpb.CopyConversationModelRequest, ...gax.CallOption) (*CopyConversationModelOperation, error)
	CopyConversationModelOperation(name string) *CopyConversationModelOperation
...
// CopyConversationModel copys a model. The source model needs to be in undeployed or deployed
// state.
//
// This method is a long-running
// operation (at https://cloud.google.com/dialogflow/es/docs/how/long-running-operations).
...
//	response:
//	ConversationModel
func (c *ConversationModelsClient) CopyConversationModel(ctx context.Context, req *dialogflowpb.CopyConversationModelRequest, opts ...gax.CallOption) (*CopyConversationModelOperation, error) {
	return c.internalClient.CopyConversationModel(ctx, req, opts...)
}

// CopyConversationModelOperation returns a new CopyConversationModelOperation from a given name.
// The name must be that of a previously created CopyConversationModelOperation, possibly from a different process.
func (c *ConversationModelsClient) CopyConversationModelOperation(name string) *CopyConversationModelOperation {
	return c.internalClient.CopyConversationModelOperation(name)
}
...
func (c *conversationModelsGRPCClient) CopyConversationModel(ctx context.Context, req *dialogflowpb.CopyConversationModelRequest, opts ...gax.CallOption) (*CopyConversationModelOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "parent", url.QueryEscape(req.GetParent()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).CopyConversationModel[0:len((*c.CallOptions).CopyConversationModel):len((*c.CallOptions).CopyConversationModel)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.conversationModelsClient.CopyConversationModel, req, settings.GRPC, c.logger, "CopyConversationModel")
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &CopyConversationModelOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}
...
func (c *conversationModelsRESTClient) CreateConversationModel(ctx context.Context, req *dialogflowpb.CreateConversationModelRequest, opts ...gax.CallOption) (*CreateConversationModelOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v/conversationModels", req.GetParent())
...
//	response:
//	ConversationModel
func (c *conversationModelsRESTClient) CopyConversationModel(ctx context.Context, req *dialogflowpb.CopyConversationModelRequest, opts ...gax.CallOption) (*CopyConversationModelOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v/conversationModels:copy", req.GetParent())
	...
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		...
		buf, err := executeHTTPRequest(ctx, c.httpClient, httpReq, c.logger, jsonReq, "CopyConversationModel")
		if err != nil {
			return err
		}
		if err := unm.Unmarshal(buf, resp); err != nil {
...
func (c *conversationModelsRESTClient) DeployConversationModel(ctx context.Context, req *dialogflowpb.DeployConversationModelRequest, opts ...gax.CallOption) (*DeployConversationModelOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v:deploy", req.GetName())
...
func (c *conversationModelsRESTClient) UndeployConversationModel(ctx context.Context, req *dialogflowpb.UndeployConversationModelRequest, opts ...gax.CallOption) (*UndeployConversationModelOperation, error) {
	...
	baseUrl.Path += fmt.Sprintf("/v2beta1/%v:undeploy", req.GetName())
...
// CopyConversationModelOperation returns a new CopyConversationModelOperation from a given name.
// The name must be that of a previously created CopyConversationModelOperation, possibly from a different process.
func (c *conversationModelsGRPCClient) CopyConversationModelOperation(name string) *CopyConversationModelOperation {
	return &CopyConversationModelOperation{
...
// CopyConversationModelOperation returns a new CopyConversationModelOperation from a given name.
// The name must be that of a previously created CopyConversationModelOperation, possibly from a different process.
func (c *conversationModelsRESTClient) CopyConversationModelOperation(name string) *CopyConversationModelOperation {
