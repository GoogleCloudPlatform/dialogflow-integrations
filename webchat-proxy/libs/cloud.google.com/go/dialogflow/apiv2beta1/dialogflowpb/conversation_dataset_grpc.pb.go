...
const (
	ConversationDatasets_CreateConversationDataset_FullMethodName          = "/google.cloud.dialogflow.v2beta1.ConversationDatasets/CreateConversationDataset"
	ConversationDatasets_GetConversationDataset_FullMethodName             = "/google.cloud.dialogflow.v2beta1.ConversationDatasets/GetConversationDataset"
	ConversationDatasets_ListConversationDatasets_FullMethodName           = "/google.cloud.dialogflow.v2beta1.ConversationDatasets/ListConversationDatasets"
	ConversationDatasets_DeleteConversationDataset_FullMethodName          = "/google.cloud.dialogflow.v2beta1.ConversationDatasets/DeleteConversationDataset"
	ConversationDatasets_GetAnnotatedConversationDataset_FullMethodName    = "/google.cloud.dialogflow.v2beta1.ConversationDatasets/GetAnnotatedConversationDataset"
	ConversationDatasets_ListAnnotatedConversationDatasets_FullMethodName  = "/google.cloud.dialogflow.v2beta1.ConversationDatasets/ListAnnotatedConversationDatasets"
	ConversationDatasets_DeleteAnnotatedConversationDataset_FullMethodName = "/google.cloud.dialogflow.v2beta1.ConversationDatasets/DeleteAnnotatedConversationDataset"
	ConversationDatasets_ImportConversationData_FullMethodName             = "/google.cloud.dialogflow.v2beta1.ConversationDatasets/ImportConversationData"
	ConversationDatasets_LabelConversation_FullMethodName                  = "/google.cloud.dialogflow.v2beta1.ConversationDatasets/LabelConversation"
)
...
type ConversationDatasetsClient interface {
	...
	GetAnnotatedConversationDataset(ctx context.Context, in *GetAnnotatedConversationDatasetRequest, opts ...grpc.CallOption) (*AnnotatedConversationDataset, error)
	// Deprecated: Do not use.
	// Returns the list of all annotated conversation datasets that
	// belong to a given conversation dataset.
	ListAnnotatedConversationDatasets(ctx context.Context, in *ListAnnotatedConversationDatasetsRequest, opts ...grpc.CallOption) (*ListAnnotatedConversationDatasetsResponse, error)
	// Deprecated: Do not use.
	// Deletes the specified annotated conversation dataset and annotations that
	// belongs to it.
	DeleteAnnotatedConversationDataset(ctx context.Context, in *DeleteAnnotatedConversationDatasetRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	...
	LabelConversation(ctx context.Context, in *LabelConversationRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
}
...
// Deprecated: Do not use.
func (c *conversationDatasetsClient) GetAnnotatedConversationDataset(ctx context.Context, in *GetAnnotatedConversationDatasetRequest, opts ...grpc.CallOption) (*AnnotatedConversationDataset, error) {
	out := new(AnnotatedConversationDataset)
	err := c.cc.Invoke(ctx, ConversationDatasets_GetAnnotatedConversationDataset_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Deprecated: Do not use.
func (c *conversationDatasetsClient) ListAnnotatedConversationDatasets(ctx context.Context, in *ListAnnotatedConversationDatasetsRequest, opts ...grpc.CallOption) (*ListAnnotatedConversationDatasetsResponse, error) {
	out := new(ListAnnotatedConversationDatasetsResponse)
	err := c.cc.Invoke(ctx, ConversationDatasets_ListAnnotatedConversationDatasets_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Deprecated: Do not use.
func (c *conversationDatasetsClient) DeleteAnnotatedConversationDataset(ctx context.Context, in *DeleteAnnotatedConversationDatasetRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ConversationDatasets_DeleteAnnotatedConversationDataset_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Deprecated: Do not use.
func (c *conversationDatasetsClient) LabelConversation(ctx context.Context, in *LabelConversationRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, ConversationDatasets_LabelConversation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConversationDatasetsServer interface {
	...
	// Deprecated: Do not use.
	// Retrieves the specified annotated conversation dataset.
	GetAnnotatedConversationDataset(context.Context, *GetAnnotatedConversationDatasetRequest) (*AnnotatedConversationDataset, error)
	// Deprecated: Do not use.
	// Returns the list of all annotated conversation datasets that
	// belong to a given conversation dataset.
	ListAnnotatedConversationDatasets(context.Context, *ListAnnotatedConversationDatasetsRequest) (*ListAnnotatedConversationDatasetsResponse, error)
	// Deprecated: Do not use.
	// Deletes the specified annotated conversation dataset and annotations that
	// belongs to it.
	DeleteAnnotatedConversationDataset(context.Context, *DeleteAnnotatedConversationDatasetRequest) (*emptypb.Empty, error)
	// Import data into the specified conversation dataset. Note that it
	// is not allowed to import data to a conversation dataset that
	// already has data in it.
	//
	...
	// - `response`:
	// [LabelConversationResponse][google.cloud.dialogflow.v2beta1.LabelConversationResponse]
	LabelConversation(context.Context, *LabelConversationRequest) (*longrunningpb.Operation, error)
}
...
func (UnimplementedConversationDatasetsServer) GetAnnotatedConversationDataset(context.Context, *GetAnnotatedConversationDatasetRequest) (*AnnotatedConversationDataset, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAnnotatedConversationDataset not implemented")
}
func (UnimplementedConversationDatasetsServer) ListAnnotatedConversationDatasets(context.Context, *ListAnnotatedConversationDatasetsRequest) (*ListAnnotatedConversationDatasetsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListAnnotatedConversationDatasets not implemented")
}
func (UnimplementedConversationDatasetsServer) DeleteAnnotatedConversationDataset(context.Context, *DeleteAnnotatedConversationDatasetRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteAnnotatedConversationDataset not implemented")
}
...
func (UnimplementedConversationDatasetsServer) LabelConversation(context.Context, *LabelConversationRequest) (*longrunningpb.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LabelConversation not implemented")
}
...
func _ConversationDatasets_GetAnnotatedConversationDataset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAnnotatedConversationDatasetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationDatasetsServer).GetAnnotatedConversationDataset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConversationDatasets_GetAnnotatedConversationDataset_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationDatasetsServer).GetAnnotatedConversationDataset(ctx, req.(*GetAnnotatedConversationDatasetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ConversationDatasets_ListAnnotatedConversationDatasets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListAnnotatedConversationDatasetsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationDatasetsServer).ListAnnotatedConversationDatasets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConversationDatasets_ListAnnotatedConversationDatasets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationDatasetsServer).ListAnnotatedConversationDatasets(ctx, req.(*ListAnnotatedConversationDatasetsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ConversationDatasets_DeleteAnnotatedConversationDataset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteAnnotatedConversationDatasetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationDatasetsServer).DeleteAnnotatedConversationDataset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConversationDatasets_DeleteAnnotatedConversationDataset_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationDatasetsServer).DeleteAnnotatedConversationDataset(ctx, req.(*DeleteAnnotatedConversationDatasetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ConversationDatasets_LabelConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LabelConversationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationDatasetsServer).LabelConversation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConversationDatasets_LabelConversation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationDatasetsServer).LabelConversation(ctx, req.(*LabelConversationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ConversationDatasets_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAnnotatedConversationDataset",
			Handler:    _ConversationDatasets_GetAnnotatedConversationDataset_Handler,
		},
		{
			MethodName: "ListAnnotatedConversationDatasets",
			Handler:    _ConversationDatasets_ListAnnotatedConversationDatasets_Handler,
		},
		{
			MethodName: "DeleteAnnotatedConversationDataset",
			Handler:    _ConversationDatasets_DeleteAnnotatedConversationDataset_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _ConversationDatasets_LabelConversation_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "google/cloud/dialogflow/v2beta1/conversation_dataset.proto",
}
