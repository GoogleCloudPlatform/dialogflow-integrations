...
const (
	ConversationModels_CreateConversationModel_FullMethodName   = "/google.cloud.dialogflow.v2beta1.ConversationModels/CreateConversationModel"
	ConversationModels_GetConversationModel_FullMethodName      = "/google.cloud.dialogflow.v2beta1.ConversationModels/GetConversationModel"
	ConversationModels_ListConversationModels_FullMethodName    = "/google.cloud.dialogflow.v2beta1.ConversationModels/ListConversationModels"
	ConversationModels_DeleteConversationModel_FullMethodName   = "/google.cloud.dialogflow.v2beta1.ConversationModels/DeleteConversationModel"
	ConversationModels_CopyConversationModel_FullMethodName     = "/google.cloud.dialogflow.v2beta1.ConversationModels/CopyConversationModel"
	ConversationModels_DeployConversationModel_FullMethodName   = "/google.cloud.dialogflow.v2beta1.ConversationModels/DeployConversationModel"
	ConversationModels_UndeployConversationModel_FullMethodName = "/google.cloud.dialogflow.v2beta1.ConversationModels/UndeployConversationModel"
)
...
type ConversationModelsClient interface {
	...
	// Copys a model. The source model needs to be in undeployed or deployed
	// state.
	//
	// This method is a [long-running
	// operation](https://cloud.google.com/dialogflow/es/docs/how/long-running-operations).
	...
	//
	// - `metadata`:
	// [CopyConversationModelOperationMetadata][google.cloud.dialogflow.v2beta1.CopyConversationModelOperationMetadata]
	// - `response`:
	// [ConversationModel][google.cloud.dialogflow.v2beta1.ConversationModel]
	CopyConversationModel(ctx context.Context, in *CopyConversationModelRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
...
func (c *conversationModelsClient) CopyConversationModel(ctx context.Context, in *CopyConversationModelRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, ConversationModels_CopyConversationModel_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConversationModelsServer interface {
	...
	// - `response`:
	// [ConversationModel][google.cloud.dialogflow.v2beta1.ConversationModel]
	CopyConversationModel(context.Context, *CopyConversationModelRequest) (*longrunningpb.Operation, error)
	// Deploys a model. If a model is already deployed, deploying it
	// has no effect. A model can only serve prediction requests after it gets
	// deployed. For article suggestion, custom model will not be used unless
	// it is deployed.
...
func (UnimplementedConversationModelsServer) CopyConversationModel(context.Context, *CopyConversationModelRequest) (*longrunningpb.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CopyConversationModel not implemented")
}
...
func _ConversationModels_CopyConversationModel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CopyConversationModelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationModelsServer).CopyConversationModel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConversationModels_CopyConversationModel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationModelsServer).CopyConversationModel(ctx, req.(*CopyConversationModelRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ConversationModels_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.cloud.dialogflow.v2beta1.ConversationModels",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CopyConversationModel",
			Handler:    _ConversationModels_CopyConversationModel_Handler,
		},
		{
	...
	Metadata: "google/cloud/dialogflow/v2beta1/conversation_model.proto",
}
