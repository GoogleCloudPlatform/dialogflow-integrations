...
const (
	Fulfillments_GetFulfillment_FullMethodName    = "/google.cloud.dialogflow.v2beta1.Fulfillments/GetFulfillment"
	Fulfillments_UpdateFulfillment_FullMethodName = "/google.cloud.dialogflow.v2beta1.Fulfillments/UpdateFulfillment"
)
