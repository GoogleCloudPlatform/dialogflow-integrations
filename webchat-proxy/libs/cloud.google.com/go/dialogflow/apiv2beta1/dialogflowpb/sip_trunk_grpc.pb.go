...
const (
	...
	SipTrunks_InitiateSipOptionsPing_FullMethodName = "/google.cloud.dialogflow.v2beta1.SipTrunks/InitiateSipOptionsPing"
	SipTrunks_DisableSipOptionsPing_FullMethodName  = "/google.cloud.dialogflow.v2beta1.SipTrunks/DisableSipOptionsPing"
)
...
type SipTrunksClient interface {
	...
	// Initiate SIP options pinging for specified trunk / peer hostname.
	InitiateSipOptionsPing(ctx context.Context, in *InitiateSipOptionsPingRequest, opts ...grpc.CallOption) (*InitiateSipOptionsPingResponse, error)
	// Disables SIP options pinging for specified trunk / peer hostname.
	DisableSipOptionsPing(ctx context.Context, in *DisableSipOptionsPingRequest, opts ...grpc.CallOption) (*DisableSipOptionsPingResponse, error)
}
...
func (c *sipTrunksClient) InitiateSipOptionsPing(ctx context.Context, in *InitiateSipOptionsPingRequest, opts ...grpc.CallOption) (*InitiateSipOptionsPingResponse, error) {
	out := new(InitiateSipOptionsPingResponse)
	err := c.cc.Invoke(ctx, SipTrunks_InitiateSipOptionsPing_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sipTrunksClient) DisableSipOptionsPing(ctx context.Context, in *DisableSipOptionsPingRequest, opts ...grpc.CallOption) (*DisableSipOptionsPingResponse, error) {
	out := new(DisableSipOptionsPingResponse)
	err := c.cc.Invoke(ctx, SipTrunks_DisableSipOptionsPing_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SipTrunksServer interface {
	...
	// Initiate SIP options pinging for specified trunk / peer hostname.
	InitiateSipOptionsPing(context.Context, *InitiateSipOptionsPingRequest) (*InitiateSipOptionsPingResponse, error)
	// Disables SIP options pinging for specified trunk / peer hostname.
	DisableSipOptionsPing(context.Context, *DisableSipOptionsPingRequest) (*DisableSipOptionsPingResponse, error)
}
...
func (UnimplementedSipTrunksServer) InitiateSipOptionsPing(context.Context, *InitiateSipOptionsPingRequest) (*InitiateSipOptionsPingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitiateSipOptionsPing not implemented")
}
func (UnimplementedSipTrunksServer) DisableSipOptionsPing(context.Context, *DisableSipOptionsPingRequest) (*DisableSipOptionsPingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DisableSipOptionsPing not implemented")
}
...
func _SipTrunks_InitiateSipOptionsPing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitiateSipOptionsPingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SipTrunksServer).InitiateSipOptionsPing(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SipTrunks_InitiateSipOptionsPing_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SipTrunksServer).InitiateSipOptionsPing(ctx, req.(*InitiateSipOptionsPingRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SipTrunks_DisableSipOptionsPing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DisableSipOptionsPingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SipTrunksServer).DisableSipOptionsPing(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SipTrunks_DisableSipOptionsPing_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SipTrunksServer).DisableSipOptionsPing(ctx, req.(*DisableSipOptionsPingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SipTrunks_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "InitiateSipOptionsPing",
			Handler:    _SipTrunks_InitiateSipOptionsPing_Handler,
		},
		{
			MethodName: "DisableSipOptionsPing",
			Handler:    _SipTrunks_DisableSipOptionsPing_Handler,
		},
	},
