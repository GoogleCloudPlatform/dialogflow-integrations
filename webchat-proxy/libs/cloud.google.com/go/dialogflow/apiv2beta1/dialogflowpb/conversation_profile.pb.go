...
type ConversationProfile struct {
	...
	TelephonySttConfig *TelephonySttConfig `protobuf:"bytes,15,opt,name=telephony_stt_config,json=telephonySttConfig,proto3" json:"telephony_stt_config,omitempty"`
	...
	// Configuration for Call Companion.
	CallCompanionConfig *CallCompanionConfig `protobuf:"bytes,19,opt,name=call_companion_config,json=callCompanionConfig,proto3" json:"call_companion_config,omitempty"`
	...
	// Optional. Disabled conversation profile cannot be used in
...
func (x *ConversationProfile) GetTelephonySttConfig() *TelephonySttConfig {
	if x != nil {
		return x.TelephonySttConfig
	}
	return nil
}
...
func (x *ConversationProfile) GetCallCompanionConfig() *CallCompanionConfig {
	if x != nil {
		return x.CallCompanionConfig
	}
	return nil
}
...
func (x *ConversationProfile) GetDisabled() bool {
	if x != nil {
		return x.Disabled
	}
	return false
...
type AutomatedAgentConfig struct {
	...
	// this field is set.
	RouterConfig *AutomatedAgentConfig_RouterConfig `protobuf:"bytes,2,opt,name=router_config,json=routerConfig,proto3" json:"router_config,omitempty"`
	...
	// Optional. If enabled, Dialogflow CX agent will proactively process the
	// partial audio transcripts, instead of waiting for the end of the utterance
	// signal.
	EnableCxProactiveProcessing bool `protobuf:"varint,4,opt,name=enable_cx_proactive_processing,json=enableCxProactiveProcessing,proto3" json:"enable_cx_proactive_processing,omitempty"`
	// Optional. If true, Dialogflow will stream the audio bytes from Cloud TTS
	// for speech synthesis using the StreamingSynthesize api.
	EnableStreamingSynthesize bool `protobuf:"varint,5,opt,name=enable_streaming_synthesize,json=enableStreamingSynthesize,proto3" json:"enable_streaming_synthesize,omitempty"`
	// If true, pass all inputs to runtime backend without any processing such as
	// speech recognition or text-to-speech.
	UsePassThroughMode bool `protobuf:"varint,6,opt,name=use_pass_through_mode,json=usePassThroughMode,proto3" json:"use_pass_through_mode,omitempty"`
}
...
func (x *AutomatedAgentConfig) GetRouterConfig() *AutomatedAgentConfig_RouterConfig {
	if x != nil {
...
func (x *AutomatedAgentConfig) GetEnableCxProactiveProcessing() bool {
	if x != nil {
...
func (x *AutomatedAgentConfig) GetEnableStreamingSynthesize() bool {
	if x != nil {
...
func (x *AutomatedAgentConfig) GetUsePassThroughMode() bool {
	if x != nil {
		return x.UsePassThroughMode
	}
	return false
}
...
type HumanAgentAssistantConfig struct {
	...
	// and
	// [end_user_suggestion_config][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.end_user_suggestion_config]
	// instead. Resource name of the agent assistant to use. Format:
	// `projects/<Project ID>/humanAgentAssistants/<Human Agent Assistant ID>`.
	//
	// Legacy event based workflow:
	// There are two ways to get automatic generated suggestion,
	//  1. have
	//     [notification_config][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.notification_config]
	//     configured and call
	//     [Participants.ListSuggestions][google.cloud.dialogflow.v2beta1.Participants.ListSuggestions]
	//     to fetch latest suggestion.
	//  2. call
	//     [Participants.ListSuggestions][google.cloud.dialogflow.v2beta1.Participants.ListSuggestions]
	//     periodically to fetch
	//     suggestion updates.
	//
	// `ArticleSuggestion` and `Faq` are returned together if configured. We will
	// always try to compile `ArticleSuggestion` and `Faq` suggestion if they are
	// configured in
	// [HumanAgentAssistant][google.cloud.dialogflow.v2beta1.HumanAgentAssistant].
	//
	// Changes in new event based workflow:
	//  1. Each suggestion contains exactly one suggestion type.
	//  2. Suggestion of different type is in Pub/Sub event, nothing will be
	//     returned in the deprecated
	//     [Participants.ListSuggestions][google.cloud.dialogflow.v2beta1.Participants.ListSuggestions]
	//     API.
	//
	// Migration:
	...
	// [end_user_suggestion_config][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.end_user_suggestion_config]
	// is present,
	// [name][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.name] will
	// be ignored, and we will use the new workflow. Otherwise, we will continue
	// to use the old workflow. If
	// [human_agent_suggestion_config][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.human_agent_suggestion_config]
	// or
	// [end_user_suggestion_config][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.end_user_suggestion_config]
	// is not present,
...
// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
func (x *HumanAgentAssistantConfig) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type NotificationConfig struct {
	...
	// Whether the Pub/Sub message content needs to be redacted when possible. For
	// example, when this is set to True for
	// new_message_event_notification_config, the transcripts will be redacted
	// based on security_settings.
	UseRedactedData bool `protobuf:"varint,3,opt,name=use_redacted_data,json=useRedactedData,proto3" json:"use_redacted_data,omitempty"`
}
...
func (x *NotificationConfig) GetUseRedactedData() bool {
	if x != nil {
		return x.UseRedactedData
	}
	return false
}
...
// Defines the Speech-to-Text configuration applied to telephony integrations.
type TelephonySttConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Disables the behavior that truncates the transcripts.
	// By default, we truncate transcripts longer than 256 characters.
	DisableTranscriptTruncation bool `protobuf:"varint,1,opt,name=disable_transcript_truncation,json=disableTranscriptTruncation,proto3" json:"disable_transcript_truncation,omitempty"`
	// Defines the max duration allowed per utterance for speech transcription.
	// Overrides the default value of 15s.
	// Value should not be over 60s or below 15s.
	MaxSpeechDuration *durationpb.Duration `protobuf:"bytes,2,opt,name=max_speech_duration,json=maxSpeechDuration,proto3" json:"max_speech_duration,omitempty"`
	// Do not add punctuation in speech transcription.
	DisableAutomaticPunctuation bool `protobuf:"varint,3,opt,name=disable_automatic_punctuation,json=disableAutomaticPunctuation,proto3" json:"disable_automatic_punctuation,omitempty"`
}

func (x *TelephonySttConfig) Reset() {
	*x = TelephonySttConfig{}
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TelephonySttConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TelephonySttConfig) ProtoMessage() {}

func (x *TelephonySttConfig) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TelephonySttConfig.ProtoReflect.Descriptor instead.
func (*TelephonySttConfig) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_rawDescGZIP(), []int{6}
}

func (x *TelephonySttConfig) GetDisableTranscriptTruncation() bool {
	if x != nil {
		return x.DisableTranscriptTruncation
	}
	return false
}

func (x *TelephonySttConfig) GetMaxSpeechDuration() *durationpb.Duration {
	if x != nil {
...
func (x *TelephonySttConfig) GetDisableAutomaticPunctuation() bool {
	if x != nil {
...
type SipConfig struct {
	...
	UseMultiSdpPorts bool `protobuf:"varint,2,opt,name=use_multi_sdp_ports,json=useMultiSdpPorts,proto3" json:"use_multi_sdp_ports,omitempty"`
	...
	UseProgress bool `protobuf:"varint,7,opt,name=use_progress,json=useProgress,proto3" json:"use_progress,omitempty"`
	...
	// Ingores any media direction in the reINVITE SDP offer. Reuse the previous
	// media direction.
...
func (x *SipConfig) GetUseMultiSdpPorts() bool {
	if x != nil {
		return x.UseMultiSdpPorts
	}
	return false
}
...
func (x *SipConfig) GetUseProgress() bool {
	if x != nil {
		return x.UseProgress
	}
	return false
}
...
// Defines the Call Companion configuration.
type CallCompanionConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Whether call companion is enabled for conversations started with this
	// profile.
	Enabled bool `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// Whether to wait on initialization at the beginning of the call.
	WaitOnInitialization bool `protobuf:"varint,2,opt,name=wait_on_initialization,json=waitOnInitialization,proto3" json:"wait_on_initialization,omitempty"`
}

func (x *CallCompanionConfig) Reset() {
	*x = CallCompanionConfig{}
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CallCompanionConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CallCompanionConfig) ProtoMessage() {}

func (x *CallCompanionConfig) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CallCompanionConfig.ProtoReflect.Descriptor instead.
func (*CallCompanionConfig) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_rawDescGZIP(), []int{8}
}

func (x *CallCompanionConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *CallCompanionConfig) GetWaitOnInitialization() bool {
	if x != nil {
		return x.WaitOnInitialization
	}
	return false
}
...
func (*SetSuggestionFeatureConfigOperationMetadata) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_rawDescGZIP(), []int{17}
}
...
func (*ClearSuggestionFeatureConfigOperationMetadata) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_rawDescGZIP(), []int{18}
}
...
// The configurations of the Dialogflow router.
type AutomatedAgentConfig_RouterConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// ID of the Dialogflow v2 agent environment for Dialogflow Router to use.
	// If both agent_v2 and agent_v3 are set, Dialogflow will invoke router to
	// route the query to the corresponding V2 or V3 agent.
	// Format: `projects/<Project ID>/locations/<Location
	...
	// [DetectIntentRequest](/dialogflow/docs/reference/rpc/google.cloud.dialogflow.v2beta1#google.cloud.dialogflow.v2beta1.DetectIntentRequest)
	// for more details.
	AgentV2 string `protobuf:"bytes,1,opt,name=agent_v2,json=agentV2,proto3" json:"agent_v2,omitempty"`
	// ID of the Dialogflow v3 agent environment for Dialogflow Router to use.
	// If both agent_v2 and agent_v3 are set, Dialogflow will invoke router to
	// route the query to the corresponding V2 or V3 agent.
	// Format: `projects/<Project ID>/locations/<Location
	// ID>/locations/<Location ID>/agents/<Agent Id>/environments/<Environment
	// ID or '-'>`. If environment is not specified, the default `draft`
	...
	// for more details.
	// You'll need both dialogflow.sessions.detectIntent and
	// dialogflow.participants.analyzeContent to make calls to Dialogflow
	// router.
	AgentV3 string `protobuf:"bytes,2,opt,name=agent_v3,json=agentV3,proto3" json:"agent_v3,omitempty"`
	// The traffic split configuration to control how much traffic should go
	// to the V3 agent. This configuration only applies when both
	// [agent_v2][google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.agent_v2]
	// and
	// [agent_v3][google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.agent_v3]
	// match a query. If only a single agent matches a query, Dialogflow sends
	// the query directly to the respective agent. The key of the map is V3 head
	// intent ID. Format: `projects/<Project ID>/locations/<Location
	// ID>/locations/<Location ID>/agents/<Agent ID>/intents/<Intent ID>`.
	TrafficSplitConfig map[string]*AutomatedAgentConfig_RouterConfig_TrafficSplitConfig `protobuf:"bytes,3,rep,name=traffic_split_config,json=trafficSplitConfig,proto3" json:"traffic_split_config,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *AutomatedAgentConfig_RouterConfig) Reset() {
	*x = AutomatedAgentConfig_RouterConfig{}
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AutomatedAgentConfig_RouterConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AutomatedAgentConfig_RouterConfig) ProtoMessage() {}

func (x *AutomatedAgentConfig_RouterConfig) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AutomatedAgentConfig_RouterConfig.ProtoReflect.Descriptor instead.
func (*AutomatedAgentConfig_RouterConfig) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_rawDescGZIP(), []int{1, 0}
}

func (x *AutomatedAgentConfig_RouterConfig) GetAgentV2() string {
	if x != nil {
		return x.AgentV2
	}
	return ""
...
func (x *AutomatedAgentConfig_RouterConfig) GetAgentV3() string {
	if x != nil {
		return x.AgentV3
	}
	return ""
...
func (x *AutomatedAgentConfig_RouterConfig) GetTrafficSplitConfig() map[string]*AutomatedAgentConfig_RouterConfig_TrafficSplitConfig {
	if x != nil {
...
// How much traffic should go to
// [agent_v3][google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.agent_v3]
// instead of
// [agent_v2][google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.agent_v2]
// by intent.
//
// This configuration only applies when both
// [agent_v2][google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.agent_v2]
// and
// [agent_v3][google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.agent_v3]
// match a query. If only a single agent matches a query, Dialogflow sends
// the query directly to the respective agent.
//
// There are the following cases when both agents match:
//
// * If the intent is not specified in the traffic split, the query goes to
// [agent_v3][google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.agent_v3].
//   - If the matched V3 intent is specified in the traffic split,
//     [traffic_v3_percentage][] determines the probability that the query
//     goes to
//     [agent_v3][google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.agent_v3]
//     using a consistent random choice seeded on the conversation id.
type AutomatedAgentConfig_RouterConfig_TrafficSplitConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The ratio[0, 1] of the traffic that will go to the V3 agent.
	// 1.0 by default.
	TrafficV3Ratio float32 `protobuf:"fixed32,1,opt,name=traffic_v3_ratio,json=trafficV3Ratio,proto3" json:"traffic_v3_ratio,omitempty"`
}

func (x *AutomatedAgentConfig_RouterConfig_TrafficSplitConfig) Reset() {
	*x = AutomatedAgentConfig_RouterConfig_TrafficSplitConfig{}
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AutomatedAgentConfig_RouterConfig_TrafficSplitConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AutomatedAgentConfig_RouterConfig_TrafficSplitConfig) ProtoMessage() {}

func (x *AutomatedAgentConfig_RouterConfig_TrafficSplitConfig) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AutomatedAgentConfig_RouterConfig_TrafficSplitConfig.ProtoReflect.Descriptor instead.
func (*AutomatedAgentConfig_RouterConfig_TrafficSplitConfig) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_rawDescGZIP(), []int{1, 0, 0}
}

func (x *AutomatedAgentConfig_RouterConfig_TrafficSplitConfig) GetTrafficV3Ratio() float32 {
	if x != nil {
		return x.TrafficV3Ratio
	}
	return 0
}
...
type HumanAgentAssistantConfig_SuggestionFeatureConfig struct {
	...
	// including ARTICLE_SUGGESTION, FAQ, SMART_REPLY, DIALOGFLOW_ASSIST.
	//
	// Tries to compile suggestions for matched participants in
	// [AnalyzeContentRequest][google.cloud.dialogflow.v2beta1.AnalyzeContentRequest]
	// and put the suggestions in
	// [AnalyzeContentResponse][google.cloud.dialogflow.v2beta1.AnalyzeContentResponse]
	// if enabled.
	//
	// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
	EnableInlineSuggestion bool `protobuf:"varint,2,opt,name=enable_inline_suggestion,json=enableInlineSuggestion,proto3" json:"enable_inline_suggestion,omitempty"`
	...
	// personalization on suggestions.
	//
	// Supported features: SMART_REPLY.
	EnablePersonalization bool `protobuf:"varint,11,opt,name=enable_personalization,json=enablePersonalization,proto3" json:"enable_personalization,omitempty"`
	...
	// Deprecated, use
	// [suggestion_trigger_settings][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig.suggestion_trigger_settings]
	// instead.
	//
	// Trigger Model is a feature that predicts whether human agent
	// assistant needs to provide suggestions on the current message with the
	// context of the current conversation. User can choose whether to enable
	// this feature or not by setting this field. If TriggerModelMode is
	// enabled, human agent assistant will only generate suggestions when the
	// score from the model prediction result exceeds a certain threshold. If
	// the TriggerModelMode is disabled, human agent assistant will try to
	// generate suggestions for every message. If it is set to
	// TRIGGER_MODEL_MODE_UNSPECIFIED, it will default to the behavior of
	// TRIGGER_MODEL_MODE_ENABLED.
	//
	// Currently, only article suggestion will use this field and it will only
	// take effect in event based suggestion.
	//
	// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
	TriggerModelMode TriggerModelMode `protobuf:"varint,4,opt,name=trigger_model_mode,json=triggerModelMode,proto3,enum=google.cloud.dialogflow.v2beta1.TriggerModelMode" json:"trigger_model_mode,omitempty"`
	// Settings of suggestion trigger.
	//
...
// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
func (x *HumanAgentAssistantConfig_SuggestionFeatureConfig) GetEnableInlineSuggestion() bool {
	if x != nil {
		return x.EnableInlineSuggestion
	}
	return false
}
...
func (x *HumanAgentAssistantConfig_SuggestionFeatureConfig) GetEnablePersonalization() bool {
	if x != nil {
		return x.EnablePersonalization
	}
	return false
}
...
// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
func (x *HumanAgentAssistantConfig_SuggestionFeatureConfig) GetTriggerModelMode() TriggerModelMode {
	if x != nil {
...
type HumanAgentAssistantConfig_SuggestionConfig struct {
	...
	// [SuggestionFeatureConfig][google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig]
	// instead, if both are provided, config in `SuggestionFeatureConfig` will
	// override settings in `human_agent_assistant`.
	//
	// Resource name of the human agent assistant to use.
	// Format: `projects/<Project ID>/locations/<Location
	// ID>/humanAgentAssistants/<Human Agent Assistant ID>`.
	//
	// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
	HumanAgentAssistant string `protobuf:"bytes,1,opt,name=human_agent_assistant,json=humanAgentAssistant,proto3" json:"human_agent_assistant,omitempty"`
...
// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
func (x *HumanAgentAssistantConfig_SuggestionConfig) GetHumanAgentAssistant() string {
	if x != nil {
...
type HumanAgentAssistantConfig_SuggestionQueryConfig struct {
	...
	// [DEPRECATED] Please use context_filter_settings instead.
	// The flag to enable suggestion_context feature during suggestion time.
	//
	// If `use_suggestion_context` is false, suggestions will be based on
	// unfiltered conversation history, including messages between customer and
	// virtual agent.
	//
	// If `use_suggestion_context` is true, suggestions will be only based on
	// customer messages except the last message that triggers hand-off (e.g. "I
	// want to talk to human agent.") when handing off to human agent. Following
	// suggestions generated during conversation between customer and human
	// agent will not include conversation history between customer and virtual
	// agent.
	//
	// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
	UseSuggestionContext bool `protobuf:"varint,6,opt,name=use_suggestion_context,json=useSuggestionContext,proto3" json:"use_suggestion_context,omitempty"`
	...
	// Optional. The search config for the data store. Supported features:
	// KNOWLEDGE_ASSIST.
	DataStoreSearchConfig *SearchConfig `protobuf:"bytes,10,opt,name=data_store_search_config,json=dataStoreSearchConfig,proto3" json:"data_store_search_config,omitempty"`
}
...
// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
func (x *HumanAgentAssistantConfig_SuggestionQueryConfig) GetUseSuggestionContext() bool {
	if x != nil {
		return x.UseSuggestionContext
	}
	return false
}
...
func (x *HumanAgentAssistantConfig_SuggestionQueryConfig) GetDataStoreSearchConfig() *SearchConfig {
	if x != nil {
		return x.DataStoreSearchConfig
	}
	return nil
}
...
type HumanAgentAssistantConfig_MessageAnalysisConfig struct {
	...
	// Optional. Enable sentiment analysis in conversation messages on [agent
	// assist
	// stage](https://cloud.google.com/dialogflow/priv/docs/contact-center/basics#stages).
	// If unspecified, defaults to false. If this flag is set to true,
	// `enable_sentiment_analysis` will be ignored.
	//
	// Note that the v2 model will only analyze sentiment for end-user messages.
	//
	...
	// If Pub/Sub notification is configured, result will be in
	// [ConversationEvent.new_message_payload.SentimentAnalysisResult][google.cloud.dialogflow.v2beta1.ConversationEvent.new_message_payload].
	EnableSentimentAnalysisV2 bool `protobuf:"varint,4,opt,name=enable_sentiment_analysis_v2,json=enableSentimentAnalysisV2,proto3" json:"enable_sentiment_analysis_v2,omitempty"`
...
func (x *HumanAgentAssistantConfig_MessageAnalysisConfig) GetEnableSentimentAnalysisV2() bool {
	if x != nil {
		return x.EnableSentimentAnalysisV2
	}
	return false
}
...
type HumanAgentAssistantConfig_SuggestionQueryConfig_KnowledgeBaseQuerySource struct {
	...
	// Deprecated, the field is no longer has any effect.
	// We will only return FAQ doc in faq suggestion and return
	// ARTICLE_SUGGESTION doc in article suggestion.
	//
	// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
...
// Deprecated: Marked as deprecated in google/cloud/dialogflow/v2beta1/conversation_profile.proto.
func (x *HumanAgentAssistantConfig_SuggestionQueryConfig_KnowledgeBaseQuerySource) GetKnowledgeTypes() []Document_KnowledgeType {
	if x != nil {
...
type HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource struct {
	...
	// router will be invoked (and override the agent setting above) if this
	// field is set.
	RouterConfig *AutomatedAgentConfig_RouterConfig `protobuf:"bytes,2,opt,name=router_config,json=routerConfig,proto3" json:"router_config,omitempty"`
...
func (x *HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource) Reset() {
	*x = HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource{}
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource) GetRouterConfig() *AutomatedAgentConfig_RouterConfig {
	if x != nil {
		return x.RouterConfig
	}
	return nil
...
func (x *HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource) GetWorkflow() string {
	if x != nil {
		return x.Workflow
	}
	return ""
...
func (x *HumanAgentAssistantConfig_SuggestionQueryConfig_ContextFilterSettings) Reset() {
	*x = HumanAgentAssistantConfig_SuggestionQueryConfig_ContextFilterSettings{}
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *HumanAgentAssistantConfig_SuggestionQueryConfig_Sections) Reset() {
	*x = HumanAgentAssistantConfig_SuggestionQueryConfig_Sections{}
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource_HumanAgentSideConfig) Reset() {
	*x = HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource_HumanAgentSideConfig{}
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *HumanAgentHandoffConfig_LivePersonConfig) Reset() {
	*x = HumanAgentHandoffConfig_LivePersonConfig{}
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *HumanAgentHandoffConfig_SalesforceLiveAgentConfig) Reset() {
	*x = HumanAgentHandoffConfig_SalesforceLiveAgentConfig{}
	mi := &file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_rawDesc = []byte{
	...
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x70,
	...
	0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x68, 0x75, 0x6d, 0x61, 0x6e, 0x5f, 0x61, 0x67, 0x65,
	0x6e, 0x74, 0x5f, 0x61, 0x73, 0x73, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x74, 0x61, 0x31, 0x2f, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x2e,
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x0f, 0x0a, 0x13, 0x43,
	...
	0x02, 0x52, 0x0b, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x40,
	...
	0x6d, 0x65, 0x12, 0x31, 0x0a, 0x12, 0x75, 0x73, 0x65, 0x5f, 0x62, 0x69, 0x64, 0x69, 0x5f, 0x73,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x18, 0x17, 0x20, 0x01, 0x28, 0x08, 0x42, 0x03,
	0xe0, 0x41, 0x01, 0x52, 0x10, 0x75, 0x73, 0x65, 0x42, 0x69, 0x64, 0x69, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x69, 0x6e, 0x67, 0x12, 0x6b, 0x0a, 0x16, 0x61, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74,
	...
	,
	...
	,
	...
	0x6c, 0x65, 0x7d, 0x12, 0x53, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x7b, 0x70,
	...
	0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x7d, 0x22, 0xf6, 0x06, 0x0a, 0x14, 0x41, 0x75, 0x74,
	...
	0x12, 0x67, 0x0a, 0x0d, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x42, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f,
	0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x41, 0x75, 0x74, 0x6f, 0x6d, 0x61,
	0x74, 0x65, 0x64, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x52,
	0x6f, 0x75, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0c, 0x72, 0x6f, 0x75,
	0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x3f, 0x0a, 0x0b, 0x73, 0x65, 0x73,
	...
	,
	...
	,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x2e, 0x54, 0x72, 0x61, 0x66, 0x66, 0x69, 0x63, 0x53, 0x70, 0x6c, 0x69, 0x74,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38,
	0x01, 0x22, 0xcb, 0x2c, 0x0a, 0x19, 0x48, 0x75, 0x6d, 0x61, 0x6e, 0x41, 0x67, 0x65, 0x6e, 0x74,
	0x41, 0x73, 0x73, 0x69, 0x73, 0x74, 0x61, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	0x16, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x02, 0x18,
	0x01, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x64, 0x0a, 0x13, 0x6e, 0x6f, 0x74, 0x69, 0x66,
	...
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x8e, 0x01,
	0x0a, 0x1d, 0x68, 0x75, 0x6d, 0x61, 0x6e, 0x5f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x75,
	...
	0x69, 0x67, 0x52, 0x1a, 0x68, 0x75, 0x6d, 0x61, 0x6e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x53, 0x75,
	0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x88,
	0x01, 0x0a, 0x1a, 0x65, 0x6e, 0x64, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x73, 0x75, 0x67, 0x67,
	0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x04, 0x20,
	...
	0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x88, 0x01, 0x0a, 0x17, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x61, 0x6e, 0x61, 0x6c, 0x79, 0x73, 0x69, 0x73, 0x5f, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x50, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f,
	...
	,
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x52, 0x11, 0x73, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f,
	0x6e, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x3c, 0x0a, 0x18, 0x65, 0x6e, 0x61, 0x62,
	0x6c, 0x65, 0x5f, 0x69, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x73, 0x75, 0x67, 0x67, 0x65, 0x73,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x42, 0x02, 0x18, 0x01, 0x52, 0x16,
	0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x53, 0x75, 0x67, 0x67,
	0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x41, 0x0a, 0x1d, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65,
	...
	0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x35, 0x0a, 0x16, 0x65, 0x6e, 0x61,
	0x62, 0x6c, 0x65, 0x5f, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08, 0x52, 0x15, 0x65, 0x6e, 0x61, 0x62, 0x6c,
	0x65, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	0x6f, 0x64, 0x65, 0x12, 0x94, 0x01, 0x0a, 0x1b, 0x73, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x74, 0x74, 0x69,
	0x6e, 0x67, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x54, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66,
	...
	0x65, 0x72, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x73, 0x0a, 0x0c, 0x71, 0x75,
	...
	0x8e, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x12, 0x94, 0x01, 0x0a, 0x1b, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x54, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77,
	...
	,
	...
	,
	...
	0x65, 0x51, 0x75, 0x65, 0x72, 0x79, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x9a, 0x01, 0x0a,
	0x15, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x64, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c,
	...
	0x63, 0x65, 0x48, 0x00, 0x52, 0x13, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0xa0, 0x01, 0x0a, 0x17, 0x64, 0x69,
	0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x66, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f,
	0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x48, 0x75,
	0x6d, 0x61, 0x6e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x41, 0x73, 0x73, 0x69, 0x73, 0x74, 0x61, 0x6e,
	...
	,
	...
	0x73, 0x65, 0x73, 0x12, 0x64, 0x0a, 0x0f, 0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x37, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c,
	0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x44,
	0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x4b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67,
	0x65, 0x54, 0x79, 0x70, 0x65, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0e, 0x6b, 0x6e, 0x6f, 0x77, 0x6c,
	0x65, 0x64, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x73, 0x1a, 0x5f, 0x0a, 0x13, 0x44, 0x6f, 0x63,
	...
	0x09, 0x64, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x1a, 0xe7, 0x03, 0x0a, 0x15, 0x44,
	...
	,
	...
	0x74, 0x53, 0x69, 0x64, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x14, 0x68, 0x75, 0x6d,
	0x61, 0x6e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x53, 0x69, 0x64, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x12, 0x1a, 0x0a, 0x08, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x1a, 0x55, 0x0a,
	0x14, 0x48, 0x75, 0x6d, 0x61, 0x6e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x53, 0x69, 0x64, 0x65, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x3d, 0x0a, 0x05, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x27, 0xe0, 0x41, 0x01, 0xfa, 0x41, 0x21, 0x0a, 0x1f, 0x64, 0x69,
	...
	0x6f, 0x70, 0x49, 0x76, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x1a, 0xb6, 0x02,
	0x0a, 0x08, 0x53, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x8a, 0x01, 0x0a, 0x0d, 0x73,
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0e, 0x32, 0x65, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62,
	...
	0x6e, 0x66, 0x69, 0x67, 0x2e, 0x53, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x53, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0c, 0x73, 0x65, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x73, 0x22, 0x9c, 0x01, 0x0a, 0x0b, 0x53, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1c, 0x0a, 0x18, 0x53, 0x45, 0x43, 0x54, 0x49,
	...
	0x54, 0x49, 0x45, 0x53, 0x10, 0x06, 0x42, 0x0e, 0x0a, 0x0c, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0x97, 0x01, 0x0a, 0x17, 0x43, 0x6f, 0x6e, 0x76, 0x65,
	0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x12, 0x46, 0x0a, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x30, 0xfa, 0x41, 0x2d, 0x0a, 0x2b, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c,
	...
	,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x95, 0x01, 0x0a, 0x1c, 0x73, 0x61, 0x6c, 0x65, 0x73,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x86, 0x02, 0x0a, 0x12, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69,
	...
	0x69, 0x63, 0x12, 0x68, 0x0a, 0x0e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x66, 0x6f,
	0x72, 0x6d, 0x61, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x41, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67,
	0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x4e, 0x6f, 0x74,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x2a, 0x0a, 0x11,
	0x75, 0x73, 0x65, 0x5f, 0x72, 0x65, 0x64, 0x61, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x75, 0x73, 0x65, 0x52, 0x65, 0x64, 0x61,
	0x63, 0x74, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x22, 0x44, 0x0a, 0x0d, 0x4d, 0x65, 0x73, 0x73,
	...
	,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x52, 0x14, 0x63, 0x6f, 0x6e, 0x76,
	0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73,
	0x12, 0x26, 0x0a, 0x0f, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x74, 0x6f,
	0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6e, 0x65, 0x78, 0x74, 0x50,
	0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x6a, 0x0a, 0x1d, 0x47, 0x65, 0x74, 0x43,
	0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0xdf, 0x01, 0x0a, 0x20, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43,
	0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69,
	...
	0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
	0x52, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x6c, 0x0a, 0x14, 0x63, 0x6f, 0x6e, 0x76,
	...
	0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x22, 0xd2, 0x01, 0x0a, 0x20, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f,
	0x66, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x6c, 0x0a, 0x14, 0x63,
	0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x72, 0x6f, 0x66,
	0x69, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x34, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66,
	...
	0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x40, 0x0a, 0x0b, 0x75, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4d, 0x61, 0x73, 0x6b, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52,
	0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x22, 0x6d, 0x0a, 0x20, 0x44,
	...
	0x66, 0x69, 0x6c, 0x65, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xd4, 0x02, 0x0a, 0x21, 0x53,
	...
	0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x93, 0x01, 0x0a, 0x19,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x22, 0xb6, 0x02, 0x0a, 0x23, 0x43, 0x6c, 0x65, 0x61, 0x72, 0x53, 0x75, 0x67, 0x67, 0x65,
	...
	0x65, 0x12, 0x61, 0x0a, 0x10, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74,
	0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x31, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f,
	...
	0x52, 0x6f, 0x6c, 0x65, 0x12, 0x74, 0x0a, 0x17, 0x73, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69,
	...
	0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0xf6, 0x02, 0x0a, 0x2b, 0x53,
	0x65, 0x74, 0x53, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x65, 0x61, 0x74,
	...
	0x69, 0x6d, 0x65, 0x22, 0xf8, 0x02, 0x0a, 0x2d, 0x43, 0x6c, 0x65, 0x61, 0x72, 0x53, 0x75, 0x67,
	...
	0x15, 0x0a, 0x14, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50,
	0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x12, 0xa5, 0x02, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74,
	0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66,
	0x69, 0x6c, 0x65, 0x73, 0x12, 0x40, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c,
	0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76,
	...
	0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x83, 0x01, 0xda, 0x41, 0x06, 0x70,
	0x61, 0x72, 0x65, 0x6e, 0x74, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x74, 0x5a, 0x3f, 0x12, 0x3d, 0x2f,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x31, 0x2f, 0x76,
	...
	0x92, 0x02, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x3e, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67,
	...
	0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
	0x22, 0x81, 0x01, 0xda, 0x41, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x74,
	0x5a, 0x3f, 0x12, 0x3d, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x7b, 0x6e, 0x61,
	...
	0x7d, 0x12, 0x31, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x7b, 0x6e, 0x61, 0x6d,
	0x65, 0x3d, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x2a, 0x2f, 0x63, 0x6f, 0x6e,
	0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
	0x73, 0x2f, 0x2a, 0x7d, 0x12, 0xdc, 0x02, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43,
	0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x22, 0xc5, 0x01, 0xda, 0x41,
	0x1b, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x2c, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x82, 0xd3, 0xe4, 0x93,
	0x02, 0xa0, 0x01, 0x3a, 0x14, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x5a, 0x55, 0x3a, 0x14, 0x63, 0x6f, 0x6e,
	0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c,
	0x65, 0x22, 0x3d, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x7b, 0x70, 0x61, 0x72,
	...
	0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69,
	0x6c, 0x65, 0x73, 0x12, 0x8b, 0x03, 0x0a, 0x19, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6f,
	0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c,
	0x65, 0x12, 0x41, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65,
	0x74, 0x61, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72,
	...
	0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76,
	0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x22, 0xf4, 0x01, 0xda, 0x41, 0x20,
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0xca, 0x01, 0x3a, 0x14, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x5a, 0x6a, 0x3a,
	0x14, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x72,
	0x6f, 0x66, 0x69, 0x6c, 0x65, 0x32, 0x52, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f,
	...
	0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2f, 0x2a, 0x7d, 0x32, 0x46, 0x2f, 0x76, 0x32, 0x62, 0x65,
	...
	0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2f, 0x2a,
	0x7d, 0x12, 0xfa, 0x01, 0x0a, 0x19, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x76,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x81, 0x01, 0xda, 0x41, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x74, 0x5a, 0x3f, 0x2a, 0x3d, 0x2f, 0x76,
	...
	0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2f, 0x2a, 0x7d, 0x2a, 0x31, 0x2f, 0x76, 0x32,
	...
	0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2f, 0x2a, 0x7d, 0x12, 0xf7,
	0x03, 0x0a, 0x1a, 0x53, 0x65, 0x74, 0x53, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e,
	0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x42, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61,
	0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e,
	...
	0x22, 0xf5, 0x02, 0xca, 0x41, 0x42, 0x0a, 0x13, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61,
	...
	0x67, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0xd0, 0x01, 0x3a, 0x01, 0x2a, 0x5a, 0x6d, 0x3a, 0x01, 0x2a,
	...
	0x74, 0x75, 0x72, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x5c, 0x2f, 0x76, 0x32, 0x62,
	...
	0x72, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0xff, 0x03, 0x0a, 0x1c, 0x43, 0x6c, 0x65,
	0x61, 0x72, 0x53, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x65, 0x61, 0x74,
	0x75, 0x72, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x44, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66,
	0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6c, 0x65, 0x61,
	...
	,
	...
	0x74, 0x75, 0x72, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x5e, 0x2f, 0x76, 0x32, 0x62,
	0x65, 0x74, 0x61, 0x31, 0x2f, 0x7b, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x3d, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x73, 0x2f, 0x2a, 0x2f, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2f, 0x2a, 0x7d, 0x3a, 0x63, 0x6c,
	...
	0x66, 0x6c, 0x6f, 0x77, 0x42, 0xac, 0x02, 0xea, 0x41, 0x7c, 0x0a, 0x2c, 0x64, 0x69, 0x61, 0x6c,
	0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x70, 0x69,
	...
	0x74, 0x69, 0x6e, 0x67, 0x73, 0x7d, 0x0a, 0x23, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66,
	0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x18, 0x43, 0x6f, 0x6e,
	0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
...
var file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_goTypes = []any{
	...
	(*TelephonySttConfig)(nil),                                                // 8: google.cloud.dialogflow.v2beta1.TelephonySttConfig
	(*SipConfig)(nil),                                                         // 9: google.cloud.dialogflow.v2beta1.SipConfig
	(*CallCompanionConfig)(nil),                                               // 10: google.cloud.dialogflow.v2beta1.CallCompanionConfig
	(*ListConversationProfilesRequest)(nil),                                   // 11: google.cloud.dialogflow.v2beta1.ListConversationProfilesRequest
	(*ListConversationProfilesResponse)(nil),                                  // 12: google.cloud.dialogflow.v2beta1.ListConversationProfilesResponse
	(*GetConversationProfileRequest)(nil),                                     // 13: google.cloud.dialogflow.v2beta1.GetConversationProfileRequest
	(*CreateConversationProfileRequest)(nil),                                  // 14: google.cloud.dialogflow.v2beta1.CreateConversationProfileRequest
	(*UpdateConversationProfileRequest)(nil),                                  // 15: google.cloud.dialogflow.v2beta1.UpdateConversationProfileRequest
	(*DeleteConversationProfileRequest)(nil),                                  // 16: google.cloud.dialogflow.v2beta1.DeleteConversationProfileRequest
	(*SetSuggestionFeatureConfigRequest)(nil),                                 // 17: google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigRequest
	(*ClearSuggestionFeatureConfigRequest)(nil),                               // 18: google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigRequest
	(*SetSuggestionFeatureConfigOperationMetadata)(nil),                       // 19: google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigOperationMetadata
	(*ClearSuggestionFeatureConfigOperationMetadata)(nil),                     // 20: google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigOperationMetadata
	(*AutomatedAgentConfig_RouterConfig)(nil),                                 // 21: google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig
	(*AutomatedAgentConfig_RouterConfig_TrafficSplitConfig)(nil),              // 22: google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.TrafficSplitConfig
	nil, // 23: google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.TrafficSplitConfigEntry
	(*HumanAgentAssistantConfig_SuggestionTriggerSettings)(nil),                                        // 24: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionTriggerSettings
	(*HumanAgentAssistantConfig_SuggestionFeatureConfig)(nil),                                          // 25: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig
	(*HumanAgentAssistantConfig_SuggestionConfig)(nil),                                                 // 26: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionConfig
	(*HumanAgentAssistantConfig_SuggestionQueryConfig)(nil),                                            // 27: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig
	(*HumanAgentAssistantConfig_ConversationModelConfig)(nil),                                          // 28: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.ConversationModelConfig
	(*HumanAgentAssistantConfig_ConversationProcessConfig)(nil),                                        // 29: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.ConversationProcessConfig
	(*HumanAgentAssistantConfig_MessageAnalysisConfig)(nil),                                            // 30: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.MessageAnalysisConfig
	(*HumanAgentAssistantConfig_SuggestionQueryConfig_KnowledgeBaseQuerySource)(nil),                   // 31: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.KnowledgeBaseQuerySource
	(*HumanAgentAssistantConfig_SuggestionQueryConfig_DocumentQuerySource)(nil),                        // 32: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.DocumentQuerySource
	(*HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource)(nil),                      // 33: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource
	(*HumanAgentAssistantConfig_SuggestionQueryConfig_ContextFilterSettings)(nil),                      // 34: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.ContextFilterSettings
	(*HumanAgentAssistantConfig_SuggestionQueryConfig_Sections)(nil),                                   // 35: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.Sections
	(*HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource_HumanAgentSideConfig)(nil), // 36: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource.HumanAgentSideConfig
	(*HumanAgentHandoffConfig_LivePersonConfig)(nil),                                                   // 37: google.cloud.dialogflow.v2beta1.HumanAgentHandoffConfig.LivePersonConfig
	(*HumanAgentHandoffConfig_SalesforceLiveAgentConfig)(nil),                                          // 38: google.cloud.dialogflow.v2beta1.HumanAgentHandoffConfig.SalesforceLiveAgentConfig
	(*timestamppb.Timestamp)(nil),                                                                      // 39: google.protobuf.Timestamp
	(*SpeechToTextConfig)(nil),                                                                         // 40: google.cloud.dialogflow.v2beta1.SpeechToTextConfig
	(*SynthesizeSpeechConfig)(nil),                                                                     // 41: google.cloud.dialogflow.v2beta1.SynthesizeSpeechConfig
	(*durationpb.Duration)(nil),                                                                        // 42: google.protobuf.Duration
	(*fieldmaskpb.FieldMask)(nil),                                                                      // 43: google.protobuf.FieldMask
	(Participant_Role)(0),                                                                              // 44: google.cloud.dialogflow.v2beta1.Participant.Role
	(SuggestionFeature_Type)(0),                                                                        // 45: google.cloud.dialogflow.v2beta1.SuggestionFeature.Type
	(*SuggestionFeature)(nil),                                                                          // 46: google.cloud.dialogflow.v2beta1.SuggestionFeature
	(*RaiSettings)(nil),                                                                                // 47: google.cloud.dialogflow.v2beta1.RaiSettings
	(TriggerModelMode)(0),                                                                              // 48: google.cloud.dialogflow.v2beta1.TriggerModelMode
	(*SearchConfig)(nil),                                                                               // 49: google.cloud.dialogflow.v2beta1.SearchConfig
	(Document_KnowledgeType)(0),                                                                        // 50: google.cloud.dialogflow.v2beta1.Document.KnowledgeType
...
var file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_depIdxs = []int32{
	39, // 0: google.cloud.dialogflow.v2beta1.ConversationProfile.create_time:type_name -> google.protobuf.Timestamp
	39, // 1: google.cloud.dialogflow.v2beta1.ConversationProfile.update_time:type_name -> google.protobuf.Timestamp
	...
	40, // 9: google.cloud.dialogflow.v2beta1.ConversationProfile.stt_config:type_name -> google.cloud.dialogflow.v2beta1.SpeechToTextConfig
	8,  // 10: google.cloud.dialogflow.v2beta1.ConversationProfile.telephony_stt_config:type_name -> google.cloud.dialogflow.v2beta1.TelephonySttConfig
	9,  // 11: google.cloud.dialogflow.v2beta1.ConversationProfile.sip_config:type_name -> google.cloud.dialogflow.v2beta1.SipConfig
	10, // 12: google.cloud.dialogflow.v2beta1.ConversationProfile.call_companion_config:type_name -> google.cloud.dialogflow.v2beta1.CallCompanionConfig
	41, // 13: google.cloud.dialogflow.v2beta1.ConversationProfile.tts_config:type_name -> google.cloud.dialogflow.v2beta1.SynthesizeSpeechConfig
	21, // 14: google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.router_config:type_name -> google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig
	42, // 15: google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.session_ttl:type_name -> google.protobuf.Duration
	6,  // 16: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.notification_config:type_name -> google.cloud.dialogflow.v2beta1.NotificationConfig
	26, // 17: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.human_agent_suggestion_config:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionConfig
	26, // 18: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.end_user_suggestion_config:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionConfig
	30, // 19: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.message_analysis_config:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.MessageAnalysisConfig
	37, // 20: google.cloud.dialogflow.v2beta1.HumanAgentHandoffConfig.live_person_config:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentHandoffConfig.LivePersonConfig
	38, // 21: google.cloud.dialogflow.v2beta1.HumanAgentHandoffConfig.salesforce_live_agent_config:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentHandoffConfig.SalesforceLiveAgentConfig
	1,  // 22: google.cloud.dialogflow.v2beta1.NotificationConfig.message_format:type_name -> google.cloud.dialogflow.v2beta1.NotificationConfig.MessageFormat
	42, // 23: google.cloud.dialogflow.v2beta1.TelephonySttConfig.max_speech_duration:type_name -> google.protobuf.Duration
	42, // 24: google.cloud.dialogflow.v2beta1.SipConfig.max_audio_recording_duration:type_name -> google.protobuf.Duration
	2,  // 25: google.cloud.dialogflow.v2beta1.ListConversationProfilesResponse.conversation_profiles:type_name -> google.cloud.dialogflow.v2beta1.ConversationProfile
	2,  // 26: google.cloud.dialogflow.v2beta1.CreateConversationProfileRequest.conversation_profile:type_name -> google.cloud.dialogflow.v2beta1.ConversationProfile
	2,  // 27: google.cloud.dialogflow.v2beta1.UpdateConversationProfileRequest.conversation_profile:type_name -> google.cloud.dialogflow.v2beta1.ConversationProfile
	43, // 28: google.cloud.dialogflow.v2beta1.UpdateConversationProfileRequest.update_mask:type_name -> google.protobuf.FieldMask
	44, // 29: google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigRequest.participant_role:type_name -> google.cloud.dialogflow.v2beta1.Participant.Role
	25, // 30: google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigRequest.suggestion_feature_config:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig
	44, // 31: google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigRequest.participant_role:type_name -> google.cloud.dialogflow.v2beta1.Participant.Role
	45, // 32: google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigRequest.suggestion_feature_type:type_name -> google.cloud.dialogflow.v2beta1.SuggestionFeature.Type
	44, // 33: google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigOperationMetadata.participant_role:type_name -> google.cloud.dialogflow.v2beta1.Participant.Role
	45, // 34: google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigOperationMetadata.suggestion_feature_type:type_name -> google.cloud.dialogflow.v2beta1.SuggestionFeature.Type
	39, // 35: google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigOperationMetadata.create_time:type_name -> google.protobuf.Timestamp
	44, // 36: google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigOperationMetadata.participant_role:type_name -> google.cloud.dialogflow.v2beta1.Participant.Role
	45, // 37: google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigOperationMetadata.suggestion_feature_type:type_name -> google.cloud.dialogflow.v2beta1.SuggestionFeature.Type
	39, // 38: google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigOperationMetadata.create_time:type_name -> google.protobuf.Timestamp
	23, // 39: google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.traffic_split_config:type_name -> google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.TrafficSplitConfigEntry
	22, // 40: google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.TrafficSplitConfigEntry.value:type_name -> google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig.TrafficSplitConfig
	46, // 41: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig.suggestion_feature:type_name -> google.cloud.dialogflow.v2beta1.SuggestionFeature
	47, // 42: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig.rai_settings:type_name -> google.cloud.dialogflow.v2beta1.RaiSettings
	48, // 43: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig.trigger_model_mode:type_name -> google.cloud.dialogflow.v2beta1.TriggerModelMode
	24, // 44: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig.suggestion_trigger_settings:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionTriggerSettings
	27, // 45: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig.query_config:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig
	28, // 46: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig.conversation_model_config:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.ConversationModelConfig
	29, // 47: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig.conversation_process_config:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.ConversationProcessConfig
	25, // 48: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionConfig.feature_configs:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig
	31, // 49: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.knowledge_base_query_source:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.KnowledgeBaseQuerySource
	32, // 50: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.document_query_source:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.DocumentQuerySource
	33, // 51: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.dialogflow_query_source:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource
	34, // 52: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.context_filter_settings:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.ContextFilterSettings
	35, // 53: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.sections:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.Sections
	49, // 54: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.data_store_search_config:type_name -> google.cloud.dialogflow.v2beta1.SearchConfig
	50, // 55: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.KnowledgeBaseQuerySource.knowledge_types:type_name -> google.cloud.dialogflow.v2beta1.Document.KnowledgeType
	21, // 56: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource.router_config:type_name -> google.cloud.dialogflow.v2beta1.AutomatedAgentConfig.RouterConfig
	36, // 57: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource.human_agent_side_config:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource.HumanAgentSideConfig
	0,  // 58: google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.Sections.section_types:type_name -> google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.Sections.SectionType
	11, // 59: google.cloud.dialogflow.v2beta1.ConversationProfiles.ListConversationProfiles:input_type -> google.cloud.dialogflow.v2beta1.ListConversationProfilesRequest
	13, // 60: google.cloud.dialogflow.v2beta1.ConversationProfiles.GetConversationProfile:input_type -> google.cloud.dialogflow.v2beta1.GetConversationProfileRequest
	14, // 61: google.cloud.dialogflow.v2beta1.ConversationProfiles.CreateConversationProfile:input_type -> google.cloud.dialogflow.v2beta1.CreateConversationProfileRequest
	15, // 62: google.cloud.dialogflow.v2beta1.ConversationProfiles.UpdateConversationProfile:input_type -> google.cloud.dialogflow.v2beta1.UpdateConversationProfileRequest
	16, // 63: google.cloud.dialogflow.v2beta1.ConversationProfiles.DeleteConversationProfile:input_type -> google.cloud.dialogflow.v2beta1.DeleteConversationProfileRequest
	17, // 64: google.cloud.dialogflow.v2beta1.ConversationProfiles.SetSuggestionFeatureConfig:input_type -> google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigRequest
	18, // 65: google.cloud.dialogflow.v2beta1.ConversationProfiles.ClearSuggestionFeatureConfig:input_type -> google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigRequest
	12, // 66: google.cloud.dialogflow.v2beta1.ConversationProfiles.ListConversationProfiles:output_type -> google.cloud.dialogflow.v2beta1.ListConversationProfilesResponse
	2,  // 67: google.cloud.dialogflow.v2beta1.ConversationProfiles.GetConversationProfile:output_type -> google.cloud.dialogflow.v2beta1.ConversationProfile
	2,  // 68: google.cloud.dialogflow.v2beta1.ConversationProfiles.CreateConversationProfile:output_type -> google.cloud.dialogflow.v2beta1.ConversationProfile
	2,  // 69: google.cloud.dialogflow.v2beta1.ConversationProfiles.UpdateConversationProfile:output_type -> google.cloud.dialogflow.v2beta1.ConversationProfile
	51, // 70: google.cloud.dialogflow.v2beta1.ConversationProfiles.DeleteConversationProfile:output_type -> google.protobuf.Empty
	52, // 71: google.cloud.dialogflow.v2beta1.ConversationProfiles.SetSuggestionFeatureConfig:output_type -> google.longrunning.Operation
	52, // 72: google.cloud.dialogflow.v2beta1.ConversationProfiles.ClearSuggestionFeatureConfig:output_type -> google.longrunning.Operation
...
func file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_init() {
	...
	file_google_cloud_dialogflow_v2beta1_conversation_profile_proto_msgTypes[25].OneofWrappers = []any{
