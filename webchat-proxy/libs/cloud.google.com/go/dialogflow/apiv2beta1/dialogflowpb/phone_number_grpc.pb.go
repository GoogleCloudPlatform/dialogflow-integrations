...
const (
	...
	PhoneNumbers_CreatePhoneNumber_FullMethodName        = "/google.cloud.dialogflow.v2beta1.PhoneNumbers/CreatePhoneNumber"
	...
	PhoneNumbers_InitiateWebRtcCall_FullMethodName       = "/google.cloud.dialogflow.v2beta1.PhoneNumbers/InitiateWebRtcCall"
	PhoneNumbers_InitiateStreamingApiCall_FullMethodName = "/google.cloud.dialogflow.v2beta1.PhoneNumbers/InitiateStreamingApiCall"
)
...
type PhoneNumbersClient interface {
	...
	// Create a phone number with a randomly generated virtual number.
	// The created number can only be called via web or SIP based endpoint.
	// It can't be called via PSTN.
	CreatePhoneNumber(ctx context.Context, in *CreatePhoneNumberRequest, opts ...grpc.CallOption) (*PhoneNumber, error)
	...
	// Initiates a WebRTC call to the given phone number.
	InitiateWebRtcCall(ctx context.Context, in *InitiateWebRtcCallRequest, opts ...grpc.CallOption) (*InitiateWebRtcCallResponse, error)
	// Initiates a call that streams audio via API.
	InitiateStreamingApiCall(ctx context.Context, in *InitiateStreamingApiCallRequest, opts ...grpc.CallOption) (*InitiateStreamingApiCallResponse, error)
}
...
func (c *phoneNumbersClient) CreatePhoneNumber(ctx context.Context, in *CreatePhoneNumberRequest, opts ...grpc.CallOption) (*PhoneNumber, error) {
	out := new(PhoneNumber)
	err := c.cc.Invoke(ctx, PhoneNumbers_CreatePhoneNumber_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *phoneNumbersClient) InitiateWebRtcCall(ctx context.Context, in *InitiateWebRtcCallRequest, opts ...grpc.CallOption) (*InitiateWebRtcCallResponse, error) {
	out := new(InitiateWebRtcCallResponse)
	err := c.cc.Invoke(ctx, PhoneNumbers_InitiateWebRtcCall_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *phoneNumbersClient) InitiateStreamingApiCall(ctx context.Context, in *InitiateStreamingApiCallRequest, opts ...grpc.CallOption) (*InitiateStreamingApiCallResponse, error) {
	out := new(InitiateStreamingApiCallResponse)
	err := c.cc.Invoke(ctx, PhoneNumbers_InitiateStreamingApiCall_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PhoneNumbersServer interface {
	...
	// The created number can only be called via web or SIP based endpoint.
	// It can't be called via PSTN.
	CreatePhoneNumber(context.Context, *CreatePhoneNumberRequest) (*PhoneNumber, error)
	// Updates the specified `PhoneNumber`.
	...
	// Initiates a WebRTC call to the given phone number.
	InitiateWebRtcCall(context.Context, *InitiateWebRtcCallRequest) (*InitiateWebRtcCallResponse, error)
	// Initiates a call that streams audio via API.
	InitiateStreamingApiCall(context.Context, *InitiateStreamingApiCallRequest) (*InitiateStreamingApiCallResponse, error)
}
...
func (UnimplementedPhoneNumbersServer) CreatePhoneNumber(context.Context, *CreatePhoneNumberRequest) (*PhoneNumber, error) {
...
func (UnimplementedPhoneNumbersServer) InitiateWebRtcCall(context.Context, *InitiateWebRtcCallRequest) (*InitiateWebRtcCallResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitiateWebRtcCall not implemented")
}
func (UnimplementedPhoneNumbersServer) InitiateStreamingApiCall(context.Context, *InitiateStreamingApiCallRequest) (*InitiateStreamingApiCallResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitiateStreamingApiCall not implemented")
}
...
func _PhoneNumbers_CreatePhoneNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreatePhoneNumberRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PhoneNumbersServer).CreatePhoneNumber(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PhoneNumbers_CreatePhoneNumber_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PhoneNumbersServer).CreatePhoneNumber(ctx, req.(*CreatePhoneNumberRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PhoneNumbers_InitiateWebRtcCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitiateWebRtcCallRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PhoneNumbersServer).InitiateWebRtcCall(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PhoneNumbers_InitiateWebRtcCall_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PhoneNumbersServer).InitiateWebRtcCall(ctx, req.(*InitiateWebRtcCallRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PhoneNumbers_InitiateStreamingApiCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitiateStreamingApiCallRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PhoneNumbersServer).InitiateStreamingApiCall(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PhoneNumbers_InitiateStreamingApiCall_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PhoneNumbersServer).InitiateStreamingApiCall(ctx, req.(*InitiateStreamingApiCallRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PhoneNumbers_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PhoneNumbers_CreatePhoneNumber_Handler,
		},
		{
		...
		{
			MethodName: "InitiateWebRtcCall",
			Handler:    _PhoneNumbers_InitiateWebRtcCall_Handler,
		},
		{
			MethodName: "InitiateStreamingApiCall",
			Handler:    _PhoneNumbers_InitiateStreamingApiCall_Handler,
		},
	},
