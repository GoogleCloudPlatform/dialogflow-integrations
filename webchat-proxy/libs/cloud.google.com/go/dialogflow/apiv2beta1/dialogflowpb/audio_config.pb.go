...
type VoiceSelectionParams_CustomVoiceParams_ReportedUsage int32

const (
	// Request with reported usage unspecified will be rejected.
	VoiceSelectionParams_CustomVoiceParams_REPORTED_USAGE_UNSPECIFIED VoiceSelectionParams_CustomVoiceParams_ReportedUsage = 0
	...
	VoiceSelectionParams_CustomVoiceParams_REALTIME VoiceSelectionParams_CustomVoiceParams_ReportedUsage = 1
	// For scenarios where the synthesized audio is downloadable and can be
	// reused. For example, the synthesized audio is downloaded, stored in
	// customer service system and played repeatedly.
	VoiceSelectionParams_CustomVoiceParams_OFFLINE VoiceSelectionParams_CustomVoiceParams_ReportedUsage = 2
)

// Enum value maps for VoiceSelectionParams_CustomVoiceParams_ReportedUsage.
var (
	VoiceSelectionParams_CustomVoiceParams_ReportedUsage_name = map[int32]string{
		0: "REPORTED_USAGE_UNSPECIFIED",
		1: "REALTIME",
		2: "OFFLINE",
	}
	VoiceSelectionParams_CustomVoiceParams_ReportedUsage_value = map[string]int32{
...
func (x VoiceSelectionParams_CustomVoiceParams_ReportedUsage) Enum() *VoiceSelectionParams_CustomVoiceParams_ReportedUsage {
	p := new(VoiceSelectionParams_CustomVoiceParams_ReportedUsage)
	*p = x
	return p
}

func (x VoiceSelectionParams_CustomVoiceParams_ReportedUsage) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (VoiceSelectionParams_CustomVoiceParams_ReportedUsage) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_dialogflow_v2beta1_audio_config_proto_enumTypes[5].Descriptor()
}

func (VoiceSelectionParams_CustomVoiceParams_ReportedUsage) Type() protoreflect.EnumType {
	return &file_google_cloud_dialogflow_v2beta1_audio_config_proto_enumTypes[5]
}

func (x VoiceSelectionParams_CustomVoiceParams_ReportedUsage) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use VoiceSelectionParams_CustomVoiceParams_ReportedUsage.Descriptor instead.
func (VoiceSelectionParams_CustomVoiceParams_ReportedUsage) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_audio_config_proto_rawDescGZIP(), []int{4, 0, 0}
}
...
func (CustomPronunciationParams_PhoneticEncoding) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_dialogflow_v2beta1_audio_config_proto_enumTypes[6].Descriptor()
}

func (CustomPronunciationParams_PhoneticEncoding) Type() protoreflect.EnumType {
	return &file_google_cloud_dialogflow_v2beta1_audio_config_proto_enumTypes[6]
}
...
type InputAudioConfig struct {
	...
	// If true, Dialogflow will call [cloud STT
	// v2](https://cloud.google.com/speech-to-text/v2/docs).
	UseSttV2 bool `protobuf:"varint,28,opt,name=use_stt_v2,json=useSttV2,proto3" json:"use_stt_v2,omitempty"`
}
...
func (x *InputAudioConfig) GetUseSttV2() bool {
	if x != nil {
		return x.UseSttV2
	}
	return false
...
type VoiceSelectionParams struct {
	...
	// service will use this custom voice instead of taking
	// [name][google.cloud.dialogflow.v2beta1.VoiceSelectionParams.name] and
	// [ssml_gender][google.cloud.dialogflow.v2beta1.VoiceSelectionParams.ssml_gender]
	// into account to select a voice. If the custom voice doesn't exist or isn't
	// accessible, Dialogflow will return an error.
	CustomVoice *VoiceSelectionParams_CustomVoiceParams `protobuf:"bytes,3,opt,name=custom_voice,json=customVoice,proto3" json:"custom_voice,omitempty"`
	// Optional. Key that is generated by Cloud TTS for the voice to clone. If
	// specified, Dialogflow will pass the key to Cloud TTS.
	VoiceCloningKey string `protobuf:"bytes,4,opt,name=voice_cloning_key,json=voiceCloningKey,proto3" json:"voice_cloning_key,omitempty"`
}
...
func (x *VoiceSelectionParams) GetCustomVoice() *VoiceSelectionParams_CustomVoiceParams {
	if x != nil {
...
func (x *VoiceSelectionParams) GetVoiceCloningKey() string {
	if x != nil {
...
type SynthesizeSpeechConfig struct {
	...
	// Adjusts the speaking pace based on the voice's learned speed distribution
	...
	// Recommended for achieving consistent speech pace eg. customer care bots.
	SpeakingPace float64 `protobuf:"fixed64,7,opt,name=speaking_pace,json=speakingPace,proto3" json:"speaking_pace,omitempty"`
}
...
func (x *SynthesizeSpeechConfig) GetSpeakingPace() float64 {
	if x != nil {
		return x.SpeakingPace
	}
	return 0
}
...
type SpeechToTextConfig struct {
	...
	// Defines the list of other language codes in addition to the one provided
	// by the conversation profile that may be detected as the language code for
	// the utterances over the conversation. See [Language
	// Support](https://cloud.google.com/dialogflow/docs/reference/language)
	// for a list of the currently supported language codes.
	AlternativeLanguageCodes []string `protobuf:"bytes,3,rep,name=alternative_language_codes,json=alternativeLanguageCodes,proto3" json:"alternative_language_codes,omitempty"`
	...
	UseLongFormModel bool `protobuf:"varint,5,opt,name=use_long_form_model,json=useLongFormModel,proto3" json:"use_long_form_model,omitempty"`
	...
	// If true, Dialogflow will call [cloud STT
	// v2](https://cloud.google.com/speech-to-text/v2/docs).
	UseSttV2 bool `protobuf:"varint,12,opt,name=use_stt_v2,json=useSttV2,proto3" json:"use_stt_v2,omitempty"`
}
...
func (x *SpeechToTextConfig) GetAlternativeLanguageCodes() []string {
	if x != nil {
...
func (x *SpeechToTextConfig) GetUseLongFormModel() bool {
	if x != nil {
		return x.UseLongFormModel
	}
	return false
}
...
func (x *SpeechToTextConfig) GetUseSttV2() bool {
	if x != nil {
		return x.UseSttV2
	}
	return false
...
// Configuration for a custom synthesis voice.
type VoiceSelectionParams_CustomVoiceParams struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	ReportedUsage VoiceSelectionParams_CustomVoiceParams_ReportedUsage `protobuf:"varint,3,opt,name=reported_usage,json=reportedUsage,proto3,enum=google.cloud.dialogflow.v2beta1.VoiceSelectionParams_CustomVoiceParams_ReportedUsage" json:"reported_usage,omitempty"`
}

func (x *VoiceSelectionParams_CustomVoiceParams) Reset() {
	*x = VoiceSelectionParams_CustomVoiceParams{}
	mi := &file_google_cloud_dialogflow_v2beta1_audio_config_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VoiceSelectionParams_CustomVoiceParams) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VoiceSelectionParams_CustomVoiceParams) ProtoMessage() {}

func (x *VoiceSelectionParams_CustomVoiceParams) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_audio_config_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VoiceSelectionParams_CustomVoiceParams.ProtoReflect.Descriptor instead.
func (*VoiceSelectionParams_CustomVoiceParams) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_audio_config_proto_rawDescGZIP(), []int{4, 0}
}

func (x *VoiceSelectionParams_CustomVoiceParams) GetModel() string {
	if x != nil {
		return x.Model
	}
	return ""
...
func (x *VoiceSelectionParams_CustomVoiceParams) GetReportedUsage() VoiceSelectionParams_CustomVoiceParams_ReportedUsage {
	if x != nil {
		return x.ReportedUsage
	}
	return VoiceSelectionParams_CustomVoiceParams_REPORTED_USAGE_UNSPECIFIED
}
...
var file_google_cloud_dialogflow_v2beta1_audio_config_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6c, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xf9, 0x07, 0x0a, 0x10,
	...
	,
	...
	0x72, 0x61, 0x6d, 0x73, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x6f, 0x69, 0x63, 0x65,
	0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x2e, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x55,
	0x73, 0x61, 0x67, 0x65, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x0d, 0x72, 0x65, 0x70, 0x6f, 0x72,
	...
	,
	...
	0x6f, 0x6e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x05, 0x76,
	0x6f, 0x69, 0x63, 0x65, 0x12, 0x62, 0x0a, 0x0e, 0x70, 0x72, 0x6f, 0x6e, 0x75, 0x6e, 0x63, 0x69,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x67,
	...
	,
	...
	0x50, 0x41, 0x10, 0x02, 0x22, 0x94, 0x02, 0x0a, 0x11, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x41,
	0x75, 0x64, 0x69, 0x6f, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x60, 0x0a, 0x0e, 0x61, 0x75,
	...
	,
	...
	0x52, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x3c, 0x0a, 0x1a, 0x61, 0x6c, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x5f,
	0x63, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x18, 0x61, 0x6c, 0x74,
	0x65, 0x72, 0x6e, 0x61, 0x74, 0x69, 0x76, 0x65, 0x4c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65,
	0x43, 0x6f, 0x64, 0x65, 0x73, 0x12, 0x45, 0x0a, 0x0b, 0x70, 0x68, 0x72, 0x61, 0x73, 0x65, 0x5f,
	0x73, 0x65, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x42, 0x24, 0xfa, 0x41, 0x21, 0x0a,
	...
	,
	...
	0x65, 0x5f, 0x68, 0x65, 0x72, 0x74, 0x7a, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x73,
	0x61, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x61, 0x74, 0x65, 0x48, 0x65, 0x72, 0x74, 0x7a, 0x12, 0x23,
	...
	,
	...
	0x57, 0x10, 0x06, 0x42, 0xe2, 0x02, 0xea, 0x41, 0x55, 0x0a, 0x1b, 0x61, 0x75, 0x74, 0x6f, 0x6d,
	...
	0x65, 0x74, 0x7d, 0x0a, 0x23, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77,
	0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x10, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x43, 0x63, 0x6c,
...
var file_google_cloud_dialogflow_v2beta1_audio_config_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_google_cloud_dialogflow_v2beta1_audio_config_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_google_cloud_dialogflow_v2beta1_audio_config_proto_goTypes = []any{
	...
	(VoiceSelectionParams_CustomVoiceParams_ReportedUsage)(0), // 5: google.cloud.dialogflow.v2beta1.VoiceSelectionParams.CustomVoiceParams.ReportedUsage
	(CustomPronunciationParams_PhoneticEncoding)(0),           // 6: google.cloud.dialogflow.v2beta1.CustomPronunciationParams.PhoneticEncoding
	(*SpeechContext)(nil),                                     // 7: google.cloud.dialogflow.v2beta1.SpeechContext
	(*SpeechWordInfo)(nil),                                    // 8: google.cloud.dialogflow.v2beta1.SpeechWordInfo
	(*BargeInConfig)(nil),                                     // 9: google.cloud.dialogflow.v2beta1.BargeInConfig
	(*InputAudioConfig)(nil),                                  // 10: google.cloud.dialogflow.v2beta1.InputAudioConfig
	(*VoiceSelectionParams)(nil),                              // 11: google.cloud.dialogflow.v2beta1.VoiceSelectionParams
	(*SynthesizeSpeechConfig)(nil),                            // 12: google.cloud.dialogflow.v2beta1.SynthesizeSpeechConfig
	(*CustomPronunciationParams)(nil),                         // 13: google.cloud.dialogflow.v2beta1.CustomPronunciationParams
	(*OutputAudioConfig)(nil),                                 // 14: google.cloud.dialogflow.v2beta1.OutputAudioConfig
	(*TelephonyDtmfEvents)(nil),                               // 15: google.cloud.dialogflow.v2beta1.TelephonyDtmfEvents
	(*SpeechToTextConfig)(nil),                                // 16: google.cloud.dialogflow.v2beta1.SpeechToTextConfig
	(*VoiceSelectionParams_CustomVoiceParams)(nil),            // 17: google.cloud.dialogflow.v2beta1.VoiceSelectionParams.CustomVoiceParams
	(*durationpb.Duration)(nil),                               // 18: google.protobuf.Duration
}
var file_google_cloud_dialogflow_v2beta1_audio_config_proto_depIdxs = []int32{
	18, // 0: google.cloud.dialogflow.v2beta1.SpeechWordInfo.start_offset:type_name -> google.protobuf.Duration
	18, // 1: google.cloud.dialogflow.v2beta1.SpeechWordInfo.end_offset:type_name -> google.protobuf.Duration
	18, // 2: google.cloud.dialogflow.v2beta1.BargeInConfig.no_barge_in_duration:type_name -> google.protobuf.Duration
	18, // 3: google.cloud.dialogflow.v2beta1.BargeInConfig.total_duration:type_name -> google.protobuf.Duration
	...
	7,  // 5: google.cloud.dialogflow.v2beta1.InputAudioConfig.speech_contexts:type_name -> google.cloud.dialogflow.v2beta1.SpeechContext
	...
	9,  // 7: google.cloud.dialogflow.v2beta1.InputAudioConfig.barge_in_config:type_name -> google.cloud.dialogflow.v2beta1.BargeInConfig
	18, // 8: google.cloud.dialogflow.v2beta1.InputAudioConfig.default_no_speech_timeout:type_name -> google.protobuf.Duration
	...
	17, // 10: google.cloud.dialogflow.v2beta1.VoiceSelectionParams.custom_voice:type_name -> google.cloud.dialogflow.v2beta1.VoiceSelectionParams.CustomVoiceParams
	11, // 11: google.cloud.dialogflow.v2beta1.SynthesizeSpeechConfig.voice:type_name -> google.cloud.dialogflow.v2beta1.VoiceSelectionParams
	13, // 12: google.cloud.dialogflow.v2beta1.SynthesizeSpeechConfig.pronunciations:type_name -> google.cloud.dialogflow.v2beta1.CustomPronunciationParams
	6,  // 13: google.cloud.dialogflow.v2beta1.CustomPronunciationParams.phonetic_encoding:type_name -> google.cloud.dialogflow.v2beta1.CustomPronunciationParams.PhoneticEncoding
	4,  // 14: google.cloud.dialogflow.v2beta1.OutputAudioConfig.audio_encoding:type_name -> google.cloud.dialogflow.v2beta1.OutputAudioEncoding
	12, // 15: google.cloud.dialogflow.v2beta1.OutputAudioConfig.synthesize_speech_config:type_name -> google.cloud.dialogflow.v2beta1.SynthesizeSpeechConfig
	0,  // 16: google.cloud.dialogflow.v2beta1.TelephonyDtmfEvents.dtmf_events:type_name -> google.cloud.dialogflow.v2beta1.TelephonyDtmf
	2,  // 17: google.cloud.dialogflow.v2beta1.SpeechToTextConfig.speech_model_variant:type_name -> google.cloud.dialogflow.v2beta1.SpeechModelVariant
	1,  // 18: google.cloud.dialogflow.v2beta1.SpeechToTextConfig.audio_encoding:type_name -> google.cloud.dialogflow.v2beta1.AudioEncoding
	5,  // 19: google.cloud.dialogflow.v2beta1.VoiceSelectionParams.CustomVoiceParams.reported_usage:type_name -> google.cloud.dialogflow.v2beta1.VoiceSelectionParams.CustomVoiceParams.ReportedUsage
