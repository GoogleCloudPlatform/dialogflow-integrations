...
func (Intent_Message_RbmStandaloneCard_CardOrientation) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 20, 0}
}
...
func (Intent_Message_RbmStandaloneCard_ThumbnailImageAlignment) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 20, 1}
}
...
func (Intent_Message_RbmCardContent_RbmMedia_Height) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 21, 0, 0}
}
...
func (Intent_Message_MediaContent_ResponseMediaType) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 25, 0}
}
...
func (Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction_UrlTypeHint) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 26, 0, 0, 0}
}
...
func (Intent_Message_ColumnProperties_HorizontalAlignment) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 28, 0}
}

// Represents a condition that may activate a follow event inpu
type Intent_ConditionalFollowupEventInput_FollowupEventCondition int32

const (
	// Not specified. Do not use.
	Intent_ConditionalFollowupEventInput_FOLLOWUP_EVENT_CONDITION_UNSPECIFIED Intent_ConditionalFollowupEventInput_FollowupEventCondition = 0
	// Webhook request timeout.
	Intent_ConditionalFollowupEventInput_WEBHOOK_TIMEOUT Intent_ConditionalFollowupEventInput_FollowupEventCondition = 1
	// Webhook error.
	Intent_ConditionalFollowupEventInput_WEBHOOK_ERROR Intent_ConditionalFollowupEventInput_FollowupEventCondition = 2
)

// Enum value maps for Intent_ConditionalFollowupEventInput_FollowupEventCondition.
var (
	Intent_ConditionalFollowupEventInput_FollowupEventCondition_name = map[int32]string{
		0: "FOLLOWUP_EVENT_CONDITION_UNSPECIFIED",
		1: "WEBHOOK_TIMEOUT",
		2: "WEBHOOK_ERROR",
	}
	Intent_ConditionalFollowupEventInput_FollowupEventCondition_value = map[string]int32{
		"FOLLOWUP_EVENT_CONDITION_UNSPECIFIED": 0,
		"WEBHOOK_TIMEOUT":                      1,
		"WEBHOOK_ERROR":                        2,
	}
)

func (x Intent_ConditionalFollowupEventInput_FollowupEventCondition) Enum() *Intent_ConditionalFollowupEventInput_FollowupEventCondition {
	p := new(Intent_ConditionalFollowupEventInput_FollowupEventCondition)
	*p = x
	return p
}

func (x Intent_ConditionalFollowupEventInput_FollowupEventCondition) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Intent_ConditionalFollowupEventInput_FollowupEventCondition) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_enumTypes[12].Descriptor()
}

func (Intent_ConditionalFollowupEventInput_FollowupEventCondition) Type() protoreflect.EnumType {
	return &file_google_cloud_dialogflow_v2beta1_intent_proto_enumTypes[12]
}

func (x Intent_ConditionalFollowupEventInput_FollowupEventCondition) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Intent_ConditionalFollowupEventInput_FollowupEventCondition.Descriptor instead.
func (Intent_ConditionalFollowupEventInput_FollowupEventCondition) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 6, 0}
}
...
type Intent struct {
	...
	// Represents a list of conditional messages.
	...
	// true to [messages][google.cloud.dialogflow.v2beta1.Intent.messages].
	ConditionalMessages []*Intent_ConditionalMessage `protobuf:"bytes,25,rep,name=conditional_messages,json=conditionalMessages,proto3" json:"conditional_messages,omitempty"`
	...
	FollowupEventInput *Intent_FollowupEventInput `protobuf:"bytes,23,opt,name=followup_event_input,json=followupEventInput,proto3" json:"followup_event_input,omitempty"`
	// Optional. The maximum duration to wait for an asynchronous
	// fulfillment to send/push the response to Dialogflow through
	...
	// since the time asynchronous fulfillment was invoked.
	MaxAsyncFulfillmentDuration *durationpb.Duration `protobuf:"bytes,24,opt,name=max_async_fulfillment_duration,json=maxAsyncFulfillmentDuration,proto3" json:"max_async_fulfillment_duration,omitempty"`
	...
	Condition string `protobuf:"bytes,26,opt,name=condition,proto3" json:"condition,omitempty"`
	// Optional. The list of conditional followup event inputs.
	ConditionalFollowupEventInputs []*Intent_ConditionalFollowupEventInput `protobuf:"bytes,27,rep,name=conditional_followup_event_inputs,json=conditionalFollowupEventInputs,proto3" json:"conditional_followup_event_inputs,omitempty"`
}
...
func (x *Intent) GetConditionalMessages() []*Intent_ConditionalMessage {
	if x != nil {
		return x.ConditionalMessages
	}
	return nil
}
...
func (x *Intent) GetFollowupEventInput() *Intent_FollowupEventInput {
	if x != nil {
...
func (x *Intent) GetMaxAsyncFulfillmentDuration() *durationpb.Duration {
	if x != nil {
		return x.MaxAsyncFulfillmentDuration
	}
	return nil
}

func (x *Intent) GetCondition() string {
	if x != nil {
		return x.Condition
	}
	return ""
...
func (x *Intent) GetConditionalFollowupEventInputs() []*Intent_ConditionalFollowupEventInput {
	if x != nil {
		return x.ConditionalFollowupEventInputs
	}
	return nil
}
...
type Intent_Parameter struct {
	...
	// Optional. The collection of rich message prompts that the agent can
	// present to the user in order to collect a value for the parameter.
	PromptMessages []*Intent_Message `protobuf:"bytes,9,rep,name=prompt_messages,json=promptMessages,proto3" json:"prompt_messages,omitempty"`
	...
	// of this parameter (slot-filling). By default the lifespan in context
	// should be 1.
	OutputDialogContexts []*Context `protobuf:"bytes,12,rep,name=output_dialog_contexts,json=outputDialogContexts,proto3" json:"output_dialog_contexts,omitempty"`
	// Optional. Number of reprompts for mandatory parameters. System will go to
	// 'no match' if parameter was not collected in specified number of
	// reprompts. Defaults to '0' that is effectively 'unlimited'.
	RepromptsCount int32 `protobuf:"varint,13,opt,name=reprompts_count,json=repromptsCount,proto3" json:"reprompts_count,omitempty"`
}
...
func (x *Intent_Parameter) GetPromptMessages() []*Intent_Message {
	if x != nil {
		return x.PromptMessages
	}
	return nil
}
...
func (x *Intent_Parameter) GetOutputDialogContexts() []*Context {
	if x != nil {
		return x.OutputDialogContexts
	}
	return nil
}

func (x *Intent_Parameter) GetRepromptsCount() int32 {
	if x != nil {
		return x.RepromptsCount
	}
	return 0
}
...
type Intent_Message struct {
	...
	//	*Intent_Message_TelephonyTerminateCall_
	//	*Intent_Message_AvayaPlayAudio_
	...
	// Optional. The condition used to activate the message.
	// This is a boolean logical expression. If it is true, the message is
	// selected. It can refer to context parameters in the form of
	// `#my-context-name.params.my-param-name`.
	//
	// See the
	// [conditions
	// reference](https://cloud.google.com/dialogflow/priv/docs/v3/condition).
	//
	// By default, the condition is true and the message is activated.
	Condition string `protobuf:"bytes,25,opt,name=condition,proto3" json:"condition,omitempty"`
...
func (x *Intent_Message) GetTelephonyTerminateCall() *Intent_Message_TelephonyTerminateCall {
	if x, ok := x.GetMessage().(*Intent_Message_TelephonyTerminateCall_); ok {
		return x.TelephonyTerminateCall
	}
	return nil
}

func (x *Intent_Message) GetAvayaPlayAudio() *Intent_Message_AvayaPlayAudio {
	if x, ok := x.GetMessage().(*Intent_Message_AvayaPlayAudio_); ok {
		return x.AvayaPlayAudio
	}
	return nil
}
...
func (x *Intent_Message) GetCondition() string {
	if x != nil {
		return x.Condition
	}
	return ""
...
type Intent_Message_TelephonyTerminateCall_ struct {
	// Terminates the call in Telephony Gateway.
	TelephonyTerminateCall *Intent_Message_TelephonyTerminateCall `protobuf:"bytes,16,opt,name=telephony_terminate_call,json=telephonyTerminateCall,proto3,oneof"`
}

type Intent_Message_AvayaPlayAudio_ struct {
	// Plays audio from a file in Avaya Browser.
	AvayaPlayAudio *Intent_Message_AvayaPlayAudio `protobuf:"bytes,21,opt,name=avaya_play_audio,json=avayaPlayAudio,proto3,oneof"`
}
...
func (*Intent_Message_TelephonyTerminateCall_) isIntent_Message_Message() {}

func (*Intent_Message_AvayaPlayAudio_) isIntent_Message_Message() {}
...
// Represents one conditional message.
// Each message defines a list of mutually exclusive cases. At query time, we
// evaluate the cases in order of their appearance in the list one at a time,
// until we encounter an activated case. For one conditional message at one
// time, only one case is activated.
// If none of the cases has a true condition, no case is activated and thus
// no message will be enqueued to the prompt.
type Intent_ConditionalMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Cases []*Intent_ConditionalMessage_Case `protobuf:"bytes,1,rep,name=cases,proto3" json:"cases,omitempty"`
}

func (x *Intent_ConditionalMessage) Reset() {
	*x = Intent_ConditionalMessage{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Intent_ConditionalMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Intent_ConditionalMessage) ProtoMessage() {}

func (x *Intent_ConditionalMessage) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Intent_ConditionalMessage.ProtoReflect.Descriptor instead.
func (*Intent_ConditionalMessage) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 3}
}

func (x *Intent_ConditionalMessage) GetCases() []*Intent_ConditionalMessage_Case {
	if x != nil {
		return x.Cases
	}
	return nil
...
func (*Intent_FollowupIntentInfo) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 4}
}
...
// Represents the event input for followup event, which is invoked after
// the intent is matched.
type Intent_FollowupEventInput struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// * MapValue type: If parameter's entity type is a composite entity then
	// use map, otherwise, depending on the parameter value type, it could be
	// one of string, number, boolean, null, list or map.
	// * MapValue value: If parameter's entity type is a composite entity then
	// use map from composite entity property names to property values,
...
func (x *Intent_FollowupEventInput) Reset() {
	*x = Intent_FollowupEventInput{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Intent_FollowupEventInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Intent_FollowupEventInput) ProtoMessage() {}

func (x *Intent_FollowupEventInput) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Intent_FollowupEventInput.ProtoReflect.Descriptor instead.
func (*Intent_FollowupEventInput) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 5}
}

func (x *Intent_FollowupEventInput) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Intent_FollowupEventInput) GetParameters() *structpb.Struct {
	if x != nil {
		return x.Parameters
	}
	return nil
...
// Represents a followup event input that is only activated on a specific
// condition.
// Like `followup_event_input`, an activated conditional followup event input
// makes the platform immediately invoke another `DetectIntent` call
// internally with the specified event as input.
type Intent_ConditionalFollowupEventInput struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The condition that activates the event input.
	Condition Intent_ConditionalFollowupEventInput_FollowupEventCondition `protobuf:"varint,1,opt,name=condition,proto3,enum=google.cloud.dialogflow.v2beta1.Intent_ConditionalFollowupEventInput_FollowupEventCondition" json:"condition,omitempty"`
	// The event input to trigger if the condition is activated.
	EventInput *Intent_FollowupEventInput `protobuf:"bytes,2,opt,name=event_input,json=eventInput,proto3" json:"event_input,omitempty"`
}

func (x *Intent_ConditionalFollowupEventInput) Reset() {
	*x = Intent_ConditionalFollowupEventInput{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Intent_ConditionalFollowupEventInput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Intent_ConditionalFollowupEventInput) ProtoMessage() {}

func (x *Intent_ConditionalFollowupEventInput) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Intent_ConditionalFollowupEventInput.ProtoReflect.Descriptor instead.
func (*Intent_ConditionalFollowupEventInput) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 6}
}

func (x *Intent_ConditionalFollowupEventInput) GetCondition() Intent_ConditionalFollowupEventInput_FollowupEventCondition {
	if x != nil {
		return x.Condition
	}
	return Intent_ConditionalFollowupEventInput_FOLLOWUP_EVENT_CONDITION_UNSPECIFIED
}

func (x *Intent_ConditionalFollowupEventInput) GetEventInput() *Intent_FollowupEventInput {
	if x != nil {
		return x.EventInput
	}
	return nil
...
// Terminates the call in Telephony Gateway.
type Intent_Message_TelephonyTerminateCall struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *Intent_Message_TelephonyTerminateCall) Reset() {
	*x = Intent_Message_TelephonyTerminateCall{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Intent_Message_TelephonyTerminateCall) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Intent_Message_TelephonyTerminateCall) ProtoMessage() {}

func (x *Intent_Message_TelephonyTerminateCall) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Intent_Message_TelephonyTerminateCall.ProtoReflect.Descriptor instead.
func (*Intent_Message_TelephonyTerminateCall) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 16}
}

// Plays audio from a file in Avaya Browser.
type Intent_Message_AvayaPlayAudio struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Intent_Message_AvayaPlayAudio) Reset() {
	*x = Intent_Message_AvayaPlayAudio{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Intent_Message_AvayaPlayAudio) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Intent_Message_AvayaPlayAudio) ProtoMessage() {}

func (x *Intent_Message_AvayaPlayAudio) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[36]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Intent_Message_AvayaPlayAudio.ProtoReflect.Descriptor instead.
func (*Intent_Message_AvayaPlayAudio) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 17}
}

func (x *Intent_Message_AvayaPlayAudio) GetAudioUri() string {
	if x != nil {
		return x.AudioUri
	}
	return ""
...
func (*Intent_Message_TableCardRow) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 29}
}
...
func (*Intent_Message_TableCardCell) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 30}
}
...
func (*Intent_Message_RbmCardContent_RbmMedia) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 21, 0}
}
...
func (x *Intent_Message_RbmSuggestedAction_RbmSuggestedActionOpenUri) Reset() {
	*x = Intent_Message_RbmSuggestedAction_RbmSuggestedActionOpenUri{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[57]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Intent_Message_RbmSuggestedAction_RbmSuggestedActionOpenUri) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 24, 1}
}
...
func (x *Intent_Message_RbmSuggestedAction_RbmSuggestedActionShareLocation) Reset() {
	*x = Intent_Message_RbmSuggestedAction_RbmSuggestedActionShareLocation{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Intent_Message_RbmSuggestedAction_RbmSuggestedActionShareLocation) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 24, 2}
}
...
func (x *Intent_Message_MediaContent_ResponseMediaObject) Reset() {
	*x = Intent_Message_MediaContent_ResponseMediaObject{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem) Reset() {
	*x = Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction) Reset() {
	*x = Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 2, 26, 0, 0}
}
...
// Represents a mutually exclusive case within this conditional message.
type Intent_ConditionalMessage_Case struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Required. The condition used to activate the case.
	// This is a boolean logical expression. If it is true, the response is
	// selected. It can refer to context parameters in the form of
	// `#my-context-name.params.my-param-name`. Note that we refer to the
	// context parameters after webhook and output contexts are processed.
	//
	// See the
	// [conditions
	// reference](https://cloud.google.com/dialogflow/priv/docs/v3/condition).
	//
	// For the last case, it may be empty, which enables a fallback condition
	// within this message.
	Condition string `protobuf:"bytes,1,opt,name=condition,proto3" json:"condition,omitempty"`
	// Optional. List of messages to prompt for this case.
	Messages []*Intent_Message `protobuf:"bytes,2,rep,name=messages,proto3" json:"messages,omitempty"`
	// Optional. List of conditional messages to prompt for this case.
	// Dialogflow recursively evaluates conditional messages in this list if
	// the case is activated. Messages appended by this list will follow the
	// ones defined in `messages` field.
	// We impose a limit on the recursion: the total number of
	// `ConditionalMessage` instances at all recursion levels must be less
	// than 100 to avoid creating an intent that is too big.
	ConditionalMessages []*Intent_ConditionalMessage `protobuf:"bytes,3,rep,name=conditional_messages,json=conditionalMessages,proto3" json:"conditional_messages,omitempty"`
}

func (x *Intent_ConditionalMessage_Case) Reset() {
	*x = Intent_ConditionalMessage_Case{}
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Intent_ConditionalMessage_Case) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Intent_ConditionalMessage_Case) ProtoMessage() {}

func (x *Intent_ConditionalMessage_Case) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[62]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Intent_ConditionalMessage_Case.ProtoReflect.Descriptor instead.
func (*Intent_ConditionalMessage_Case) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_intent_proto_rawDescGZIP(), []int{0, 3, 0}
}

func (x *Intent_ConditionalMessage_Case) GetCondition() string {
	if x != nil {
		return x.Condition
	}
	return ""
...
func (x *Intent_ConditionalMessage_Case) GetMessages() []*Intent_Message {
	if x != nil {
		return x.Messages
	}
	return nil
...
func (x *Intent_ConditionalMessage_Case) GetConditionalMessages() []*Intent_ConditionalMessage {
	if x != nil {
		return x.ConditionalMessages
	}
	return nil
...
var file_google_cloud_dialogflow_v2beta1_intent_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xb0, 0x6c, 0x0a, 0x06, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x17,
	...
	0x67, 0x65, 0x73, 0x12, 0x6d, 0x0a, 0x14, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	0x61, 0x6c, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x18, 0x19, 0x20, 0x03, 0x28,
	...
	,
	...
	0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2e, 0x46, 0x6f,
	0x6c, 0x6c, 0x6f, 0x77, 0x75, 0x70, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x70, 0x75, 0x74,
	0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x12, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x75, 0x70, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x63, 0x0a, 0x1e, 0x6d, 0x61, 0x78,
	0x5f, 0x61, 0x73, 0x79, 0x6e, 0x63, 0x5f, 0x66, 0x75, 0x6c, 0x66, 0x69, 0x6c, 0x6c, 0x6d, 0x65,
	...
	,
	...
	0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x56, 0x0a, 0x05, 0x70,
	0x61, 0x72, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3b, 0x2e, 0x67, 0x6f, 0x6f,
	...
	0x72, 0x74, 0x73, 0x12, 0x2f, 0x0a, 0x11, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x5f, 0x61, 0x64, 0x64,
	0x65, 0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x42, 0x03,
	0xe0, 0x41, 0x01, 0x52, 0x0f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x41, 0x64, 0x64, 0x65, 0x64, 0x43,
	0x6f, 0x75, 0x6e, 0x74, 0x1a, 0x74, 0x0a, 0x04, 0x50, 0x61, 0x72, 0x74, 0x12, 0x12, 0x0a, 0x04,
	...
	0x52, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x75, 0x73, 0x65, 0x72, 0x5f,
	0x64, 0x65, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x75,
	0x73, 0x65, 0x72, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x22, 0x3b, 0x0a, 0x04, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x14, 0x0a, 0x10, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45,
	0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x45, 0x58, 0x41, 0x4d,
	0x50, 0x4c, 0x45, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x08, 0x54, 0x45, 0x4d, 0x50, 0x4c, 0x41, 0x54,
	0x45, 0x10, 0x02, 0x1a, 0x02, 0x08, 0x01, 0x1a, 0xef, 0x03, 0x0a, 0x09, 0x50, 0x61, 0x72, 0x61,
	...
	,
	...
	,
	...
	0x74, 0x12, 0x4d, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	...
	0x12, 0x63, 0x0a, 0x0d, 0x71, 0x75, 0x69, 0x63, 0x6b, 0x5f, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x65,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x53, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x48, 0x00, 0x52, 0x0b, 0x73, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x12, 0x73, 0x0a, 0x13, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x6f, 0x75, 0x74, 0x5f, 0x73, 0x75,
	0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x41,
	...
	0x6e, 0x48, 0x00, 0x52, 0x11, 0x6c, 0x69, 0x6e, 0x6b, 0x4f, 0x75, 0x74, 0x53, 0x75, 0x67, 0x67,
	0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x5d, 0x0a, 0x0b, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x73,
	0x65, 0x6c, 0x65, 0x63, 0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f,
	...
	0x65, 0x6c, 0x65, 0x63, 0x74, 0x12, 0x69, 0x0a, 0x0f, 0x63, 0x61, 0x72, 0x6f, 0x75, 0x73, 0x65,
	0x6c, 0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3e,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69,
	0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31,
	0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e,
	...
	,
	...
	0x0c, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x21, 0x0a,
	0x09, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x19, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x09, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	0x12, 0x59, 0x0a, 0x08, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x18, 0x06, 0x20, 0x01,
	...
	,
	...
	,
	...
	0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32,
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2e, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x2e, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x05, 0x69, 0x6d, 0x61, 0x67,
	...
	0x74, 0x74, 0x6f, 0x6e, 0x52, 0x07, 0x62, 0x75, 0x74, 0x74, 0x6f, 0x6e, 0x73, 0x1a, 0xb9, 0x01,
	...
	0x69, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0d, 0x6f, 0x70, 0x65, 0x6e, 0x55, 0x72, 0x69,
	...
	,
	...
	,
	...
	0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61,
	0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e,
	0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x49,
	0x6d, 0x61, 0x67, 0x65, 0x52, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x1a, 0xcd, 0x02, 0x0a, 0x0e,
	0x43, 0x61, 0x72, 0x6f, 0x75, 0x73, 0x65, 0x6c, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x12, 0x59,
	...
	0x61, 0x72, 0x6f, 0x75, 0x73, 0x65, 0x6c, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x2e, 0x49, 0x74,
	0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x1a, 0xdf, 0x01, 0x0a, 0x04, 0x49, 0x74,
	0x65, 0x6d, 0x12, 0x52, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x3e, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e,
	0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74,
	0x61, 0x31, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2e, 0x52, 0x62, 0x6d, 0x4d, 0x65, 0x64, 0x69, 0x61, 0x52,
	0x05, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x12, 0x5f, 0x0a, 0x0b, 0x73, 0x75, 0x67, 0x67, 0x65, 0x73,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3d, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f,
	0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49, 0x6e,
	...
	,
	...
	0x65, 0x73, 0x74, 0x65, 0x64, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x69, 0x61, 0x6c, 0x48,
	0x00, 0x52, 0x04, 0x64, 0x69, 0x61, 0x6c, 0x12, 0x79, 0x0a, 0x08, 0x6f, 0x70, 0x65, 0x6e, 0x5f,
	0x75, 0x72, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x5c, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	...
	,
	...
	0x1a, 0x9c, 0x02, 0x0a, 0x13, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x65, 0x64,
	...
	0x0a, 0x0b, 0x6c, 0x61, 0x72, 0x67, 0x65, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f,
	0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32,
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2e, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x2e, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x48, 0x00, 0x52, 0x0a, 0x6c, 0x61,
	0x72, 0x67, 0x65, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x4b, 0x0a, 0x04, 0x69, 0x63, 0x6f, 0x6e,
	...
	0x04, 0x69, 0x63, 0x6f, 0x6e, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	0x5f, 0x75, 0x72, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x55, 0x72, 0x6c, 0x42, 0x07, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x22,
	0x43, 0x0a, 0x11, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x65, 0x64, 0x69, 0x61,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x23, 0x0a, 0x1f, 0x52, 0x45, 0x53, 0x50, 0x4f, 0x4e, 0x53, 0x45,
	...
	0x49, 0x4f, 0x10, 0x01, 0x1a, 0xe1, 0x07, 0x0a, 0x12, 0x42, 0x72, 0x6f, 0x77, 0x73, 0x65, 0x43,
	0x61, 0x72, 0x6f, 0x75, 0x73, 0x65, 0x6c, 0x43, 0x61, 0x72, 0x64, 0x12, 0x6f, 0x0a, 0x05, 0x69,
	0x74, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x59, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67,
	0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49, 0x6e, 0x74,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x56, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c,
	0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x75, 0x62, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x4b, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f,
	0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x05,
	0x69, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x6d, 0x0a, 0x11, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x5f,
	...
	,
	...
	,
	...
	,
	...
	0x6d, 0x65, 0x1a, 0x61, 0x0a, 0x12, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x75, 0x70, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	...
	,
	...
	,
	...
	0x67, 0x75, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x4c, 0x0a, 0x0b, 0x69, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x5f, 0x76, 0x69, 0x65, 0x77, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69,
	0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31,
	0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x56, 0x69, 0x65, 0x77, 0x52, 0x0a, 0x69, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x56, 0x69, 0x65, 0x77, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x61, 0x67, 0x65, 0x5f,
	...
	0x6b, 0x65, 0x6e, 0x22, 0x80, 0x01, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x49, 0x6e, 0x74, 0x65,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c,
	0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49,
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52, 0x07, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x26,
	0x0a, 0x0f, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6e, 0x65, 0x78, 0x74, 0x50, 0x61, 0x67,
	0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xc8, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x49, 0x6e,
	...
	0x65, 0x6e, 0x74, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x28, 0x0a, 0x0d, 0x6c, 0x61, 0x6e,
	...
	0x77, 0x22, 0x95, 0x02, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x74, 0x65,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x61, 0x70, 0x69, 0x73, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x49, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x52, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x44, 0x0a, 0x06, 0x69,
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f,
	0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49, 0x6e,
	...
	,
	...
	0x0a, 0x0b, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5f, 0x76, 0x69, 0x65, 0x77, 0x18, 0x04, 0x20,
	...
	0x52, 0x0a, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x56, 0x69, 0x65, 0x77, 0x22, 0x53, 0x0a, 0x13,
	...
	0x65, 0x22, 0xae, 0x03, 0x0a, 0x19, 0x42, 0x61, 0x74, 0x63, 0x68, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x74, 0x12, 0x2a, 0x0a, 0x10, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5f, 0x62, 0x61, 0x74, 0x63,
	0x68, 0x5f, 0x75, 0x72, 0x69, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0e, 0x69,
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x42, 0x61, 0x74, 0x63, 0x68, 0x55, 0x72, 0x69, 0x12, 0x5e, 0x0a,
	0x13, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5f, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x69, 0x6e,
	0x6c, 0x69, 0x6e, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67,
	0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49, 0x6e, 0x74,
	...
	,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x93, 0x02, 0xda, 0x41, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e,
	0x74, 0xda, 0x41, 0x14, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x2c, 0x6c, 0x61, 0x6e, 0x67, 0x75,
	0x61, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0xec, 0x01, 0x5a,
	...
	0x7d, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x5a, 0x3b, 0x12, 0x39, 0x2f, 0x76, 0x32,
	...
	0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x2f, 0x2a, 0x7d, 0x2f, 0x69,
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x5a, 0x47, 0x12, 0x45, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74,
	...
	0x65, 0x6e, 0x74, 0x73, 0x2f, 0x2a, 0x7d, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x12,
	...
	,
	...
	0x61, 0x67, 0x65, 0x6e, 0x74, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x2f, 0x2a, 0x7d,
	0x12, 0x9a, 0x02, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x6e,
	...
	0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f,
	0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	0x22, 0xaa, 0x01, 0xda, 0x41, 0x0d, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x2c, 0x69, 0x6e, 0x74,
	...
	0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x76, 0x3a, 0x06, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5a,
	0x40, 0x3a, 0x06, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x36, 0x2f, 0x76, 0x32, 0x62, 0x65,
	...
	0x73, 0x22, 0x2a, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x7b, 0x70, 0x61, 0x72,
	0x65, 0x6e, 0x74, 0x3d, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x2a, 0x2f, 0x61,
	0x67, 0x65, 0x6e, 0x74, 0x7d, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x12, 0xd3, 0x02,
	0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x34,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69,
	0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31,
	...
	0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76,
	0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xe3, 0x01,
	...
	0x61, 0x74, 0x65, 0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x84, 0x01, 0x3a,
	0x06, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5a, 0x47, 0x3a, 0x06, 0x69, 0x6e, 0x74, 0x65, 0x6e,
	0x74, 0x32, 0x3d, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x7b, 0x69, 0x6e, 0x74,
	0x65, 0x6e, 0x74, 0x2e, 0x6e, 0x61, 0x6d, 0x65, 0x3d, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	0x73, 0x2f, 0x2a, 0x2f, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x2a, 0x2f,
	0x61, 0x67, 0x65, 0x6e, 0x74, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x2f, 0x2a, 0x7d,
	0x32, 0x31, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x7b, 0x69, 0x6e, 0x74, 0x65,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x73, 0x2f, 0x2a, 0x7d, 0x12, 0x8b, 0x03, 0x0a, 0x12, 0x42, 0x61, 0x74, 0x63,
	0x68, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x3a,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69,
	0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31,
	...
	0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x99, 0x02, 0xca, 0x41, 0x54, 0x0a,
	...
	0x75, 0x63, 0x74, 0xda, 0x41, 0x17, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x2c, 0x69, 0x6e, 0x74,
	...
	0x74, 0x63, 0x68, 0x5f, 0x69, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x84,
	0x01, 0x3a, 0x01, 0x2a, 0x5a, 0x47, 0x3a, 0x01, 0x2a, 0x22, 0x42, 0x2f, 0x76, 0x32, 0x62, 0x65,
	0x74, 0x61, 0x31, 0x2f, 0x7b, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x3d, 0x70, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x73, 0x2f, 0x2a, 0x2f, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x2f, 0x2a, 0x2f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x7d, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	0x73, 0x3a, 0x62, 0x61, 0x74, 0x63, 0x68, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x22, 0x36, 0x2f,
	...
	,
	...
	0x22, 0x36, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x7b, 0x70, 0x61, 0x72, 0x65,
	...
	0x63, 0x68, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x1a, 0x78, 0xca, 0x41, 0x19, 0x64, 0x69, 0x61,
	...
	0x6f, 0x77, 0x42, 0xa0, 0x01, 0x0a, 0x23, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c,
	0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x0b, 0x49, 0x6e, 0x74, 0x65,
...
var file_google_cloud_dialogflow_v2beta1_intent_proto_enumTypes = make([]protoimpl.EnumInfo, 13)
var file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_google_cloud_dialogflow_v2beta1_intent_proto_goTypes = []any{
	...
	(Intent_ConditionalFollowupEventInput_FollowupEventCondition)(0),                        // 12: google.cloud.dialogflow.v2beta1.Intent.ConditionalFollowupEventInput.FollowupEventCondition
	(*Intent)(nil),                                                                 // 13: google.cloud.dialogflow.v2beta1.Intent
	(*ListIntentsRequest)(nil),                                                     // 14: google.cloud.dialogflow.v2beta1.ListIntentsRequest
	(*ListIntentsResponse)(nil),                                                    // 15: google.cloud.dialogflow.v2beta1.ListIntentsResponse
	(*GetIntentRequest)(nil),                                                       // 16: google.cloud.dialogflow.v2beta1.GetIntentRequest
	(*CreateIntentRequest)(nil),                                                    // 17: google.cloud.dialogflow.v2beta1.CreateIntentRequest
	(*UpdateIntentRequest)(nil),                                                    // 18: google.cloud.dialogflow.v2beta1.UpdateIntentRequest
	(*DeleteIntentRequest)(nil),                                                    // 19: google.cloud.dialogflow.v2beta1.DeleteIntentRequest
	(*BatchUpdateIntentsRequest)(nil),                                              // 20: google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequest
	(*BatchUpdateIntentsResponse)(nil),                                             // 21: google.cloud.dialogflow.v2beta1.BatchUpdateIntentsResponse
	(*BatchDeleteIntentsRequest)(nil),                                              // 22: google.cloud.dialogflow.v2beta1.BatchDeleteIntentsRequest
	(*IntentBatch)(nil),                                                            // 23: google.cloud.dialogflow.v2beta1.IntentBatch
	(*Intent_TrainingPhrase)(nil),                                                  // 24: google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase
	(*Intent_Parameter)(nil),                                                       // 25: google.cloud.dialogflow.v2beta1.Intent.Parameter
	(*Intent_Message)(nil),                                                         // 26: google.cloud.dialogflow.v2beta1.Intent.Message
	(*Intent_ConditionalMessage)(nil),                                              // 27: google.cloud.dialogflow.v2beta1.Intent.ConditionalMessage
	(*Intent_FollowupIntentInfo)(nil),                                              // 28: google.cloud.dialogflow.v2beta1.Intent.FollowupIntentInfo
	(*Intent_FollowupEventInput)(nil),                                              // 29: google.cloud.dialogflow.v2beta1.Intent.FollowupEventInput
	(*Intent_ConditionalFollowupEventInput)(nil),                                   // 30: google.cloud.dialogflow.v2beta1.Intent.ConditionalFollowupEventInput
	(*Intent_TrainingPhrase_Part)(nil),                                             // 31: google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.Part
	(*Intent_Message_Text)(nil),                                                    // 32: google.cloud.dialogflow.v2beta1.Intent.Message.Text
	(*Intent_Message_Image)(nil),                                                   // 33: google.cloud.dialogflow.v2beta1.Intent.Message.Image
	(*Intent_Message_QuickReplies)(nil),                                            // 34: google.cloud.dialogflow.v2beta1.Intent.Message.QuickReplies
	(*Intent_Message_Card)(nil),                                                    // 35: google.cloud.dialogflow.v2beta1.Intent.Message.Card
	(*Intent_Message_SimpleResponse)(nil),                                          // 36: google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponse
	(*Intent_Message_SimpleResponses)(nil),                                         // 37: google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponses
	(*Intent_Message_BasicCard)(nil),                                               // 38: google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard
	(*Intent_Message_Suggestion)(nil),                                              // 39: google.cloud.dialogflow.v2beta1.Intent.Message.Suggestion
	(*Intent_Message_Suggestions)(nil),                                             // 40: google.cloud.dialogflow.v2beta1.Intent.Message.Suggestions
	(*Intent_Message_LinkOutSuggestion)(nil),                                       // 41: google.cloud.dialogflow.v2beta1.Intent.Message.LinkOutSuggestion
	(*Intent_Message_ListSelect)(nil),                                              // 42: google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect
	(*Intent_Message_CarouselSelect)(nil),                                          // 43: google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect
	(*Intent_Message_SelectItemInfo)(nil),                                          // 44: google.cloud.dialogflow.v2beta1.Intent.Message.SelectItemInfo
	(*Intent_Message_TelephonyPlayAudio)(nil),                                      // 45: google.cloud.dialogflow.v2beta1.Intent.Message.TelephonyPlayAudio
	(*Intent_Message_TelephonySynthesizeSpeech)(nil),                               // 46: google.cloud.dialogflow.v2beta1.Intent.Message.TelephonySynthesizeSpeech
	(*Intent_Message_TelephonyTransferCall)(nil),                                   // 47: google.cloud.dialogflow.v2beta1.Intent.Message.TelephonyTransferCall
	(*Intent_Message_TelephonyTerminateCall)(nil),                                  // 48: google.cloud.dialogflow.v2beta1.Intent.Message.TelephonyTerminateCall
	(*Intent_Message_AvayaPlayAudio)(nil),                                          // 49: google.cloud.dialogflow.v2beta1.Intent.Message.AvayaPlayAudio
	(*Intent_Message_RbmText)(nil),                                                 // 50: google.cloud.dialogflow.v2beta1.Intent.Message.RbmText
	(*Intent_Message_RbmCarouselCard)(nil),                                         // 51: google.cloud.dialogflow.v2beta1.Intent.Message.RbmCarouselCard
	(*Intent_Message_RbmStandaloneCard)(nil),                                       // 52: google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard
	(*Intent_Message_RbmCardContent)(nil),                                          // 53: google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent
	(*Intent_Message_RbmSuggestion)(nil),                                           // 54: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestion
	(*Intent_Message_RbmSuggestedReply)(nil),                                       // 55: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedReply
	(*Intent_Message_RbmSuggestedAction)(nil),                                      // 56: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction
	(*Intent_Message_MediaContent)(nil),                                            // 57: google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent
	(*Intent_Message_BrowseCarouselCard)(nil),                                      // 58: google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard
	(*Intent_Message_TableCard)(nil),                                               // 59: google.cloud.dialogflow.v2beta1.Intent.Message.TableCard
	(*Intent_Message_ColumnProperties)(nil),                                        // 60: google.cloud.dialogflow.v2beta1.Intent.Message.ColumnProperties
	(*Intent_Message_TableCardRow)(nil),                                            // 61: google.cloud.dialogflow.v2beta1.Intent.Message.TableCardRow
	(*Intent_Message_TableCardCell)(nil),                                           // 62: google.cloud.dialogflow.v2beta1.Intent.Message.TableCardCell
	(*Intent_Message_Card_Button)(nil),                                             // 63: google.cloud.dialogflow.v2beta1.Intent.Message.Card.Button
	(*Intent_Message_BasicCard_Button)(nil),                                        // 64: google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.Button
	(*Intent_Message_BasicCard_Button_OpenUriAction)(nil),                          // 65: google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.Button.OpenUriAction
	(*Intent_Message_ListSelect_Item)(nil),                                         // 66: google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.Item
	(*Intent_Message_CarouselSelect_Item)(nil),                                     // 67: google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect.Item
	(*Intent_Message_RbmCardContent_RbmMedia)(nil),                                 // 68: google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.RbmMedia
	(*Intent_Message_RbmSuggestedAction_RbmSuggestedActionDial)(nil),               // 69: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.RbmSuggestedActionDial
	(*Intent_Message_RbmSuggestedAction_RbmSuggestedActionOpenUri)(nil),            // 70: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.RbmSuggestedActionOpenUri
	(*Intent_Message_RbmSuggestedAction_RbmSuggestedActionShareLocation)(nil),      // 71: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.RbmSuggestedActionShareLocation
	(*Intent_Message_MediaContent_ResponseMediaObject)(nil),                        // 72: google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.ResponseMediaObject
	(*Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem)(nil),               // 73: google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem
	(*Intent_Message_BrowseCarouselCard_BrowseCarouselCardItem_OpenUrlAction)(nil), // 74: google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlAction
	(*Intent_ConditionalMessage_Case)(nil),                                         // 75: google.cloud.dialogflow.v2beta1.Intent.ConditionalMessage.Case
	(*Context)(nil),                                                                // 76: google.cloud.dialogflow.v2beta1.Context
...
var file_google_cloud_dialogflow_v2beta1_intent_proto_depIdxs = []int32{
	...
	24,  // 1: google.cloud.dialogflow.v2beta1.Intent.training_phrases:type_name -> google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase
	76,  // 2: google.cloud.dialogflow.v2beta1.Intent.output_contexts:type_name -> google.cloud.dialogflow.v2beta1.Context
	25,  // 3: google.cloud.dialogflow.v2beta1.Intent.parameters:type_name -> google.cloud.dialogflow.v2beta1.Intent.Parameter
	26,  // 4: google.cloud.dialogflow.v2beta1.Intent.messages:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message
	27,  // 5: google.cloud.dialogflow.v2beta1.Intent.conditional_messages:type_name -> google.cloud.dialogflow.v2beta1.Intent.ConditionalMessage
	3,   // 6: google.cloud.dialogflow.v2beta1.Intent.default_response_platforms:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Platform
	28,  // 7: google.cloud.dialogflow.v2beta1.Intent.followup_intent_info:type_name -> google.cloud.dialogflow.v2beta1.Intent.FollowupIntentInfo
	29,  // 8: google.cloud.dialogflow.v2beta1.Intent.followup_event_input:type_name -> google.cloud.dialogflow.v2beta1.Intent.FollowupEventInput
	77,  // 9: google.cloud.dialogflow.v2beta1.Intent.max_async_fulfillment_duration:type_name -> google.protobuf.Duration
	30,  // 10: google.cloud.dialogflow.v2beta1.Intent.conditional_followup_event_inputs:type_name -> google.cloud.dialogflow.v2beta1.Intent.ConditionalFollowupEventInput
	0,   // 11: google.cloud.dialogflow.v2beta1.ListIntentsRequest.intent_view:type_name -> google.cloud.dialogflow.v2beta1.IntentView
	13,  // 12: google.cloud.dialogflow.v2beta1.ListIntentsResponse.intents:type_name -> google.cloud.dialogflow.v2beta1.Intent
	0,   // 13: google.cloud.dialogflow.v2beta1.GetIntentRequest.intent_view:type_name -> google.cloud.dialogflow.v2beta1.IntentView
	13,  // 14: google.cloud.dialogflow.v2beta1.CreateIntentRequest.intent:type_name -> google.cloud.dialogflow.v2beta1.Intent
	0,   // 15: google.cloud.dialogflow.v2beta1.CreateIntentRequest.intent_view:type_name -> google.cloud.dialogflow.v2beta1.IntentView
	13,  // 16: google.cloud.dialogflow.v2beta1.UpdateIntentRequest.intent:type_name -> google.cloud.dialogflow.v2beta1.Intent
	78,  // 17: google.cloud.dialogflow.v2beta1.UpdateIntentRequest.update_mask:type_name -> google.protobuf.FieldMask
	0,   // 18: google.cloud.dialogflow.v2beta1.UpdateIntentRequest.intent_view:type_name -> google.cloud.dialogflow.v2beta1.IntentView
	23,  // 19: google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequest.intent_batch_inline:type_name -> google.cloud.dialogflow.v2beta1.IntentBatch
	78,  // 20: google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequest.update_mask:type_name -> google.protobuf.FieldMask
	0,   // 21: google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequest.intent_view:type_name -> google.cloud.dialogflow.v2beta1.IntentView
	13,  // 22: google.cloud.dialogflow.v2beta1.BatchUpdateIntentsResponse.intents:type_name -> google.cloud.dialogflow.v2beta1.Intent
	13,  // 23: google.cloud.dialogflow.v2beta1.BatchDeleteIntentsRequest.intents:type_name -> google.cloud.dialogflow.v2beta1.Intent
	13,  // 24: google.cloud.dialogflow.v2beta1.IntentBatch.intents:type_name -> google.cloud.dialogflow.v2beta1.Intent
	2,   // 25: google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.type:type_name -> google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.Type
	31,  // 26: google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.parts:type_name -> google.cloud.dialogflow.v2beta1.Intent.TrainingPhrase.Part
	26,  // 27: google.cloud.dialogflow.v2beta1.Intent.Parameter.prompt_messages:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message
	76,  // 28: google.cloud.dialogflow.v2beta1.Intent.Parameter.output_dialog_contexts:type_name -> google.cloud.dialogflow.v2beta1.Context
	32,  // 29: google.cloud.dialogflow.v2beta1.Intent.Message.text:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Text
	33,  // 30: google.cloud.dialogflow.v2beta1.Intent.Message.image:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Image
	34,  // 31: google.cloud.dialogflow.v2beta1.Intent.Message.quick_replies:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.QuickReplies
	35,  // 32: google.cloud.dialogflow.v2beta1.Intent.Message.card:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Card
	79,  // 33: google.cloud.dialogflow.v2beta1.Intent.Message.payload:type_name -> google.protobuf.Struct
	37,  // 34: google.cloud.dialogflow.v2beta1.Intent.Message.simple_responses:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponses
	38,  // 35: google.cloud.dialogflow.v2beta1.Intent.Message.basic_card:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard
	40,  // 36: google.cloud.dialogflow.v2beta1.Intent.Message.suggestions:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Suggestions
	41,  // 37: google.cloud.dialogflow.v2beta1.Intent.Message.link_out_suggestion:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.LinkOutSuggestion
	42,  // 38: google.cloud.dialogflow.v2beta1.Intent.Message.list_select:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect
	43,  // 39: google.cloud.dialogflow.v2beta1.Intent.Message.carousel_select:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect
	45,  // 40: google.cloud.dialogflow.v2beta1.Intent.Message.telephony_play_audio:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.TelephonyPlayAudio
	46,  // 41: google.cloud.dialogflow.v2beta1.Intent.Message.telephony_synthesize_speech:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.TelephonySynthesizeSpeech
	47,  // 42: google.cloud.dialogflow.v2beta1.Intent.Message.telephony_transfer_call:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.TelephonyTransferCall
	48,  // 43: google.cloud.dialogflow.v2beta1.Intent.Message.telephony_terminate_call:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.TelephonyTerminateCall
	49,  // 44: google.cloud.dialogflow.v2beta1.Intent.Message.avaya_play_audio:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.AvayaPlayAudio
	50,  // 45: google.cloud.dialogflow.v2beta1.Intent.Message.rbm_text:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmText
	52,  // 46: google.cloud.dialogflow.v2beta1.Intent.Message.rbm_standalone_rich_card:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard
	51,  // 47: google.cloud.dialogflow.v2beta1.Intent.Message.rbm_carousel_rich_card:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmCarouselCard
	58,  // 48: google.cloud.dialogflow.v2beta1.Intent.Message.browse_carousel_card:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard
	59,  // 49: google.cloud.dialogflow.v2beta1.Intent.Message.table_card:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.TableCard
	57,  // 50: google.cloud.dialogflow.v2beta1.Intent.Message.media_content:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent
	3,   // 51: google.cloud.dialogflow.v2beta1.Intent.Message.platform:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Platform
	75,  // 52: google.cloud.dialogflow.v2beta1.Intent.ConditionalMessage.cases:type_name -> google.cloud.dialogflow.v2beta1.Intent.ConditionalMessage.Case
	79,  // 53: google.cloud.dialogflow.v2beta1.Intent.FollowupEventInput.parameters:type_name -> google.protobuf.Struct
	12,  // 54: google.cloud.dialogflow.v2beta1.Intent.ConditionalFollowupEventInput.condition:type_name -> google.cloud.dialogflow.v2beta1.Intent.ConditionalFollowupEventInput.FollowupEventCondition
	29,  // 55: google.cloud.dialogflow.v2beta1.Intent.ConditionalFollowupEventInput.event_input:type_name -> google.cloud.dialogflow.v2beta1.Intent.FollowupEventInput
	63,  // 56: google.cloud.dialogflow.v2beta1.Intent.Message.Card.buttons:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Card.Button
	36,  // 57: google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponses.simple_responses:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponse
	33,  // 58: google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.image:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Image
	64,  // 59: google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.buttons:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.Button
	39,  // 60: google.cloud.dialogflow.v2beta1.Intent.Message.Suggestions.suggestions:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Suggestion
	66,  // 61: google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.items:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.Item
	67,  // 62: google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect.items:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect.Item
	54,  // 63: google.cloud.dialogflow.v2beta1.Intent.Message.RbmText.rbm_suggestion:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestion
	4,   // 64: google.cloud.dialogflow.v2beta1.Intent.Message.RbmCarouselCard.card_width:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmCarouselCard.CardWidth
	53,  // 65: google.cloud.dialogflow.v2beta1.Intent.Message.RbmCarouselCard.card_contents:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent
	5,   // 66: google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.card_orientation:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.CardOrientation
	6,   // 67: google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.thumbnail_image_alignment:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment
	53,  // 68: google.cloud.dialogflow.v2beta1.Intent.Message.RbmStandaloneCard.card_content:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent
	68,  // 69: google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.media:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.RbmMedia
	54,  // 70: google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.suggestions:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestion
	55,  // 71: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestion.reply:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedReply
	56,  // 72: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestion.action:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction
	69,  // 73: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.dial:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.RbmSuggestedActionDial
	70,  // 74: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.open_url:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.RbmSuggestedActionOpenUri
	71,  // 75: google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.share_location:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmSuggestedAction.RbmSuggestedActionShareLocation
	8,   // 76: google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.media_type:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.ResponseMediaType
	72,  // 77: google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.media_objects:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.ResponseMediaObject
	73,  // 78: google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.items:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem
	9,   // 79: google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.image_display_options:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.ImageDisplayOptions
	33,  // 80: google.cloud.dialogflow.v2beta1.Intent.Message.TableCard.image:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Image
	60,  // 81: google.cloud.dialogflow.v2beta1.Intent.Message.TableCard.column_properties:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.ColumnProperties
	61,  // 82: google.cloud.dialogflow.v2beta1.Intent.Message.TableCard.rows:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.TableCardRow
	64,  // 83: google.cloud.dialogflow.v2beta1.Intent.Message.TableCard.buttons:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.Button
	11,  // 84: google.cloud.dialogflow.v2beta1.Intent.Message.ColumnProperties.horizontal_alignment:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.ColumnProperties.HorizontalAlignment
	62,  // 85: google.cloud.dialogflow.v2beta1.Intent.Message.TableCardRow.cells:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.TableCardCell
	65,  // 86: google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.Button.open_uri_action:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.Button.OpenUriAction
	44,  // 87: google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.Item.info:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.SelectItemInfo
	33,  // 88: google.cloud.dialogflow.v2beta1.Intent.Message.ListSelect.Item.image:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Image
	44,  // 89: google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect.Item.info:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.SelectItemInfo
	33,  // 90: google.cloud.dialogflow.v2beta1.Intent.Message.CarouselSelect.Item.image:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Image
	7,   // 91: google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.RbmMedia.height:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.RbmCardContent.RbmMedia.Height
	33,  // 92: google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.ResponseMediaObject.large_image:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Image
	33,  // 93: google.cloud.dialogflow.v2beta1.Intent.Message.MediaContent.ResponseMediaObject.icon:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Image
	74,  // 94: google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.open_uri_action:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlAction
	33,  // 95: google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.image:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.Image
	10,  // 96: google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlAction.url_type_hint:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message.BrowseCarouselCard.BrowseCarouselCardItem.OpenUrlAction.UrlTypeHint
	26,  // 97: google.cloud.dialogflow.v2beta1.Intent.ConditionalMessage.Case.messages:type_name -> google.cloud.dialogflow.v2beta1.Intent.Message
	27,  // 98: google.cloud.dialogflow.v2beta1.Intent.ConditionalMessage.Case.conditional_messages:type_name -> google.cloud.dialogflow.v2beta1.Intent.ConditionalMessage
	14,  // 99: google.cloud.dialogflow.v2beta1.Intents.ListIntents:input_type -> google.cloud.dialogflow.v2beta1.ListIntentsRequest
	16,  // 100: google.cloud.dialogflow.v2beta1.Intents.GetIntent:input_type -> google.cloud.dialogflow.v2beta1.GetIntentRequest
	17,  // 101: google.cloud.dialogflow.v2beta1.Intents.CreateIntent:input_type -> google.cloud.dialogflow.v2beta1.CreateIntentRequest
	18,  // 102: google.cloud.dialogflow.v2beta1.Intents.UpdateIntent:input_type -> google.cloud.dialogflow.v2beta1.UpdateIntentRequest
	19,  // 103: google.cloud.dialogflow.v2beta1.Intents.DeleteIntent:input_type -> google.cloud.dialogflow.v2beta1.DeleteIntentRequest
	20,  // 104: google.cloud.dialogflow.v2beta1.Intents.BatchUpdateIntents:input_type -> google.cloud.dialogflow.v2beta1.BatchUpdateIntentsRequest
	22,  // 105: google.cloud.dialogflow.v2beta1.Intents.BatchDeleteIntents:input_type -> google.cloud.dialogflow.v2beta1.BatchDeleteIntentsRequest
	15,  // 106: google.cloud.dialogflow.v2beta1.Intents.ListIntents:output_type -> google.cloud.dialogflow.v2beta1.ListIntentsResponse
	13,  // 107: google.cloud.dialogflow.v2beta1.Intents.GetIntent:output_type -> google.cloud.dialogflow.v2beta1.Intent
	13,  // 108: google.cloud.dialogflow.v2beta1.Intents.CreateIntent:output_type -> google.cloud.dialogflow.v2beta1.Intent
	13,  // 109: google.cloud.dialogflow.v2beta1.Intents.UpdateIntent:output_type -> google.cloud.dialogflow.v2beta1.Intent
	80,  // 110: google.cloud.dialogflow.v2beta1.Intents.DeleteIntent:output_type -> google.protobuf.Empty
	81,  // 111: google.cloud.dialogflow.v2beta1.Intents.BatchUpdateIntents:output_type -> google.longrunning.Operation
	81,  // 112: google.cloud.dialogflow.v2beta1.Intents.BatchDeleteIntents:output_type -> google.longrunning.Operation
...
func file_google_cloud_dialogflow_v2beta1_intent_proto_init() {
	...
	file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[13].OneofWrappers = []any{
		...
		(*Intent_Message_TelephonyTerminateCall_)(nil),
		(*Intent_Message_AvayaPlayAudio_)(nil),
	...
	file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[33].OneofWrappers = []any{
		(*Intent_Message_TelephonySynthesizeSpeech_Text)(nil),
		(*Intent_Message_TelephonySynthesizeSpeech_Ssml)(nil),
	}
	file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[41].OneofWrappers = []any{
		(*Intent_Message_RbmSuggestion_Reply)(nil),
		(*Intent_Message_RbmSuggestion_Action)(nil),
	}
	file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[43].OneofWrappers = []any{
	...
	file_google_cloud_dialogflow_v2beta1_intent_proto_msgTypes[59].OneofWrappers = []any{
