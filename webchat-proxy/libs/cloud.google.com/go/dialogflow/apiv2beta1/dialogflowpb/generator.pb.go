...
const (
	...
	// Triggers by tool call completion.
	TriggerEvent_TOOL_CALL_COMPLETION TriggerEvent = 5
)
...
func (SummarizationSection_Type) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{13, 0}
}
...
func (RaiSettings_RaiCategoryConfig_RaiCategory) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{26, 0, 0}
}
...
func (RaiSettings_RaiCategoryConfig_SensitivityLevel) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{26, 0, 1}
}
...
type AgentCoachingContext struct {
	...
	// Optional. Search configuration for agent coaching. This is used for general
	// articles search.
	SearchConfig *SearchConfig `protobuf:"bytes,5,opt,name=search_config,json=searchConfig,proto3" json:"search_config,omitempty"`
...
func (x *AgentCoachingContext) GetSearchConfig() *SearchConfig {
	if x != nil {
...
// Search configuration for agent coaching articles/instructions.
type SearchConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Required. The search engine to use for the agent coaching
	// articles/instructions. Format:
	// `projects/{project}/locations/global/collections/default_collection/engines/{engine_id}`
	SearchEngine string `protobuf:"bytes,1,opt,name=search_engine,json=searchEngine,proto3" json:"search_engine,omitempty"`
	// Optional. The datastore ids linked to the search engine. This field is used
	// to filter the search on the datastores. If empty, the search will be
	// performed on all the datastores in the search engine. Formats:
	// `projects/{project}/locations/{location}/collections/{collection}/dataStores/{data_store}`
	// `projects/{project}/locations/{location}/dataStores/{data_store}`
	Datastores []string `protobuf:"bytes,2,rep,name=datastores,proto3" json:"datastores,omitempty"`
	// Optional. The relevance score threshold for the search results. If the
	// relevance score of a search result is below this threshold, the result will
	// be filtered out. Default value: 0.7.
	RelevanceScoreThreshold float64 `protobuf:"fixed64,3,opt,name=relevance_score_threshold,json=relevanceScoreThreshold,proto3" json:"relevance_score_threshold,omitempty"`
}
...
func (x *SearchConfig) GetSearchEngine() string {
	if x != nil {
...
func (x *SearchConfig) GetDatastores() []string {
	if x != nil {
		return x.Datastores
	}
	return nil
...
func (x *SearchConfig) GetRelevanceScoreThreshold() float64 {
	if x != nil {
		return x.RelevanceScoreThreshold
	}
	return 0
}
...
// Translation customization that customer can configure.
type TranslationCustomization struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Optional. Translation of specific glossaries in agent and customer
	// languages.
	GlossaryTerms []*TranslationCustomization_GlossaryTerm `protobuf:"bytes,1,rep,name=glossary_terms,json=glossaryTerms,proto3" json:"glossary_terms,omitempty"`
}

func (x *TranslationCustomization) Reset() {
	*x = TranslationCustomization{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TranslationCustomization) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TranslationCustomization) ProtoMessage() {}

func (x *TranslationCustomization) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TranslationCustomization.ProtoReflect.Descriptor instead.
func (*TranslationCustomization) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{15}
}

func (x *TranslationCustomization) GetGlossaryTerms() []*TranslationCustomization_GlossaryTerm {
	if x != nil {
...
// Translation context that customer can configure.
// NEXT_ID: 8
type TranslationContext struct {
	...
	// Required. The language code used by the agent. At least one of
	// agent_language_code and customer_language_code must be English (en-US).
	// Supported languages:
	// - English (en-US)
	// - Japanese (ja-JP)
	// - French (fr-FR)
	...
	// - German (de-DE)
	// - Italian (it-IT)
	AgentLanguageCode string `protobuf:"bytes,1,opt,name=agent_language_code,json=agentLanguageCode,proto3" json:"agent_language_code,omitempty"`
	// Required. The language code used by the customer. At least one of
	// agent_language_code and customer_language_code must be English (en-US).
	// Supported languages:
	// - English (en-US)
	// - Japanese (ja-JP)
	...
	// - German (de-DE)
	// - Italian (it-IT)
	CustomerLanguageCode string `protobuf:"bytes,2,opt,name=customer_language_code,json=customerLanguageCode,proto3" json:"customer_language_code,omitempty"`
	// Optional. Version of the feature. If not set, default to latest version.
	// Current candidates are ["1.0"].
	Version string `protobuf:"bytes,4,opt,name=version,proto3" json:"version,omitempty"`
	// Optional. Customized translation for specific glossaries and sentences.
	TranslationCustomization *TranslationCustomization `protobuf:"bytes,5,opt,name=translation_customization,json=translationCustomization,proto3" json:"translation_customization,omitempty"`
}

func (x *TranslationContext) Reset() {
	*x = TranslationContext{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TranslationContext) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TranslationContext) ProtoMessage() {}

func (x *TranslationContext) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TranslationContext.ProtoReflect.Descriptor instead.
func (*TranslationContext) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{16}
}

func (x *TranslationContext) GetAgentLanguageCode() string {
	if x != nil {
		return x.AgentLanguageCode
	}
	return ""
}

func (x *TranslationContext) GetCustomerLanguageCode() string {
	if x != nil {
		return x.CustomerLanguageCode
	}
	return ""
}

func (x *TranslationContext) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *TranslationContext) GetTranslationCustomization() *TranslationCustomization {
	if x != nil {
		return x.TranslationCustomization
	}
	return nil
}
...
func (x *Generator) GetTranslationContext() *TranslationContext {
	if x, ok := x.GetContext().(*Generator_TranslationContext); ok {
...
type Generator_TranslationContext struct {
	// Input of Translation feature.
	TranslationContext *TranslationContext `protobuf:"bytes,19,opt,name=translation_context,json=translationContext,proto3,oneof"`
}
...
func (*Generator_TranslationContext) isGenerator_Context() {}
...
// Agent coaching article snippet.
type AgentCoachingArticleSnippet struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Optional. Snippet of the article.
	Snippet string `protobuf:"bytes,1,opt,name=snippet,proto3" json:"snippet,omitempty"`
	// Optional. Link to the article.
	ArticleLink string `protobuf:"bytes,2,opt,name=article_link,json=articleLink,proto3" json:"article_link,omitempty"`
...
func (x *AgentCoachingArticleSnippet) Reset() {
	*x = AgentCoachingArticleSnippet{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AgentCoachingArticleSnippet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AgentCoachingArticleSnippet) ProtoMessage() {}

func (x *AgentCoachingArticleSnippet) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AgentCoachingArticleSnippet.ProtoReflect.Descriptor instead.
func (*AgentCoachingArticleSnippet) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{21}
}

func (x *AgentCoachingArticleSnippet) GetSnippet() string {
	if x != nil {
		return x.Snippet
	}
	return ""
...
func (x *AgentCoachingArticleSnippet) GetArticleLink() string {
	if x != nil {
...
func (x *AgentCoachingArticleSnippet) GetArticleTitle() string {
	if x != nil {
...
type AgentCoachingSuggestion struct {
	...
	// Optional. Article snippets applicable based on the current context.
	ApplicableArticleSnippets []*AgentCoachingArticleSnippet `protobuf:"bytes,7,rep,name=applicable_article_snippets,json=applicableArticleSnippets,proto3" json:"applicable_article_snippets,omitempty"`
	...
	// Output only. Version of the agent coaching generator.
	Version string `protobuf:"bytes,11,opt,name=version,proto3" json:"version,omitempty"`
}

func (x *AgentCoachingSuggestion) Reset() {
	*x = AgentCoachingSuggestion{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AgentCoachingSuggestion) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{22}
}
...
func (x *AgentCoachingSuggestion) GetApplicableArticleSnippets() []*AgentCoachingArticleSnippet {
	if x != nil {
		return x.ApplicableArticleSnippets
	}
	return nil
}
...
func (x *AgentCoachingSuggestion) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
// Translation suggestion for both agent and customer.
type TranslationSuggestion struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Output only. The original message from the last utterance in the
	// conversation.
	OriginalMessage *MessageEntry `protobuf:"bytes,1,opt,name=original_message,json=originalMessage,proto3" json:"original_message,omitempty"`
	// Output only. The translated message from the last utterance in the
	// conversation.
	TranslatedMessage *MessageEntry `protobuf:"bytes,2,opt,name=translated_message,json=translatedMessage,proto3" json:"translated_message,omitempty"`
}

func (x *TranslationSuggestion) Reset() {
	*x = TranslationSuggestion{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TranslationSuggestion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TranslationSuggestion) ProtoMessage() {}

func (x *TranslationSuggestion) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TranslationSuggestion.ProtoReflect.Descriptor instead.
func (*TranslationSuggestion) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{23}
}

func (x *TranslationSuggestion) GetOriginalMessage() *MessageEntry {
	if x != nil {
...
func (x *TranslationSuggestion) GetTranslatedMessage() *MessageEntry {
	if x != nil {
...
type GeneratorSuggestion struct {
	...
	//	*GeneratorSuggestion_TranslationSuggestion
...
func (*GeneratorSuggestion) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{24}
}
...
func (x *GeneratorSuggestion) GetTranslationSuggestion() *TranslationSuggestion {
	if x, ok := x.GetSuggestion().(*GeneratorSuggestion_TranslationSuggestion); ok {
		return x.TranslationSuggestion
	}
	return nil
}
...
type GeneratorSuggestion_TranslationSuggestion struct {
	// Optional. Suggested translation of the last utterance in the
	// conversation.
	TranslationSuggestion *TranslationSuggestion `protobuf:"bytes,6,opt,name=translation_suggestion,json=translationSuggestion,proto3,oneof"`
}
...
func (*GeneratorSuggestion_TranslationSuggestion) isGeneratorSuggestion_Suggestion() {}
...
func (*SuggestionDedupingConfig) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{25}
}
...
func (*RaiSettings) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{26}
}
...
// Translation of a specific glossary in both agent and customer languages.
type TranslationCustomization_GlossaryTerm struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Required. The glossary in agent language.
	AgentLanguageGlossary string `protobuf:"bytes,1,opt,name=agent_language_glossary,json=agentLanguageGlossary,proto3" json:"agent_language_glossary,omitempty"`
	// Required. The glossary in customer language.
	CustomerLanguageGlossary string `protobuf:"bytes,2,opt,name=customer_language_glossary,json=customerLanguageGlossary,proto3" json:"customer_language_glossary,omitempty"`
}

func (x *TranslationCustomization_GlossaryTerm) Reset() {
	*x = TranslationCustomization_GlossaryTerm{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TranslationCustomization_GlossaryTerm) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TranslationCustomization_GlossaryTerm) ProtoMessage() {}

func (x *TranslationCustomization_GlossaryTerm) ProtoReflect() protoreflect.Message {
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[28]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TranslationCustomization_GlossaryTerm.ProtoReflect.Descriptor instead.
func (*TranslationCustomization_GlossaryTerm) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{15, 0}
}

func (x *TranslationCustomization_GlossaryTerm) GetAgentLanguageGlossary() string {
	if x != nil {
		return x.AgentLanguageGlossary
	}
	return ""
}

func (x *TranslationCustomization_GlossaryTerm) GetCustomerLanguageGlossary() string {
	if x != nil {
		return x.CustomerLanguageGlossary
	}
	return ""
}
...
func (*SummarySuggestion_SummarySection) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{20, 0}
}
...
type AgentCoachingSuggestion_Sources struct {
	...
	// Output only. Source article snippet indexes for the suggestion. This is
	// the index of the applicable_article_snippets field.
	ArticleSnippetIndexes []int32 `protobuf:"varint,1,rep,packed,name=article_snippet_indexes,json=articleSnippetIndexes,proto3" json:"article_snippet_indexes,omitempty"`
	// Output only. Search query for the article snippet.
	ArticleSnippetSearchQuery string `protobuf:"bytes,3,opt,name=article_snippet_search_query,json=articleSnippetSearchQuery,proto3" json:"article_snippet_search_query,omitempty"`
...
func (*AgentCoachingSuggestion_Sources) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{22, 0}
}

func (x *AgentCoachingSuggestion_Sources) GetArticleSnippetIndexes() []int32 {
	if x != nil {
		return x.ArticleSnippetIndexes
	}
	return nil
}

func (x *AgentCoachingSuggestion_Sources) GetArticleSnippetSearchQuery() string {
	if x != nil {
		return x.ArticleSnippetSearchQuery
	}
	return ""
}
...
func (x *AgentCoachingSuggestion_DuplicateCheckResult) Reset() {
	*x = AgentCoachingSuggestion_DuplicateCheckResult{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AgentCoachingSuggestion_DuplicateCheckResult) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{22, 1}
}
...
func (x *AgentCoachingSuggestion_AgentActionSuggestion) Reset() {
	*x = AgentCoachingSuggestion_AgentActionSuggestion{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AgentCoachingSuggestion_AgentActionSuggestion) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{22, 2}
}
...
func (x *AgentCoachingSuggestion_SampleResponse) Reset() {
	*x = AgentCoachingSuggestion_SampleResponse{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AgentCoachingSuggestion_SampleResponse) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{22, 3}
}
...
func (x *AgentCoachingSuggestion_DuplicateCheckResult_DuplicateSuggestion) Reset() {
	*x = AgentCoachingSuggestion_DuplicateCheckResult_DuplicateSuggestion{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AgentCoachingSuggestion_DuplicateCheckResult_DuplicateSuggestion) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{22, 1, 0}
}
...
func (x *GeneratorSuggestion_ToolCallInfo) Reset() {
	*x = GeneratorSuggestion_ToolCallInfo{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GeneratorSuggestion_ToolCallInfo) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{24, 0}
}
...
func (x *RaiSettings_RaiCategoryConfig) Reset() {
	*x = RaiSettings_RaiCategoryConfig{}
	mi := &file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RaiSettings_RaiCategoryConfig) Descriptor() ([]byte, []int) {
	return file_google_cloud_dialogflow_v2beta1_generator_proto_rawDescGZIP(), []int{26, 0}
}
...
var file_google_cloud_dialogflow_v2beta1_generator_proto_rawDesc = []byte{
	...
	0x70, 0x22, 0xe1, 0x02, 0x0a, 0x14, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x61, 0x63, 0x68,
	...
	0x63, 0x65, 0x12, 0x57, 0x0a, 0x0d, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x5f, 0x63, 0x6f, 0x6e,
	...
	0x65, 0x61, 0x72, 0x63, 0x68, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x62, 0x0a, 0x0c, 0x69,
	...
	,
	...
	,
	...
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x53, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20,
	...
	0x69, 0x6f, 0x6e, 0x53, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x42,
	0x03, 0xe0, 0x41, 0x01, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xce, 0x01, 0x0a, 0x04, 0x54,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x16, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63,
	0x61, 0x62, 0x6c, 0x65, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x12, 0x81, 0x01, 0x0a, 0x1b, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x62, 0x6c, 0x65, 0x5f,
	0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x5f, 0x73, 0x6e, 0x69, 0x70, 0x70, 0x65, 0x74, 0x73,
	...
	0x61, 0x63, 0x68, 0x69, 0x6e, 0x67, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x53, 0x6e, 0x69,
	0x70, 0x70, 0x65, 0x74, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x19, 0x61, 0x70, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x62, 0x6c, 0x65, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x53, 0x6e, 0x69, 0x70,
	0x70, 0x65, 0x74, 0x73, 0x12, 0x8d, 0x01, 0x0a, 0x18, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x61,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x4e, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f,
	...
	0x6e, 0x2e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x75, 0x67,
	0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x16, 0x61, 0x67,
	0x65, 0x6e, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x12, 0x77, 0x0a, 0x10, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x5f, 0x72,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x47,
	...
	,
	...
	0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x80, 0x02, 0x0a, 0x13, 0x44, 0x75, 0x70,
	...
	0x73, 0x77, 0x65, 0x72, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x5f, 0x0a, 0x07, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f,
	...
	,
	...
	0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x1a, 0xa6, 0x02, 0x0a, 0x0e, 0x53, 0x61,
	0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x28, 0x0a, 0x0d,
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x74, 0x65, 0x78, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x52, 0x0c, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x54, 0x65, 0x78, 0x74, 0x12, 0x5f, 0x0a, 0x07, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x88, 0x01, 0x0a, 0x16, 0x64, 0x75, 0x70, 0x6c,
	0x69, 0x63, 0x61, 0x74, 0x65, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x5f, 0x72, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x4d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c,
	0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x41, 0x67, 0x65, 0x6e, 0x74,
	...
	0x6b, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x03, 0xe0, 0x41, 0x03, 0x52, 0x14, 0x64, 0x75,
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x22, 0xd9, 0x01, 0x0a, 0x15, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x53, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x5d, 0x0a, 0x10,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65,
	0x74, 0x61, 0x31, 0x2e, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x42, 0xda,
	...
	0x7d, 0x12, 0xf2, 0x01, 0x0a, 0x0e, 0x4c, 0x69, 0x73, 0x74, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61,
	0x74, 0x6f, 0x72, 0x73, 0x12, 0x36, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c,
	0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76,
	0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x47, 0x65, 0x6e, 0x65, 0x72,
	0x61, 0x74, 0x6f, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x37, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x6f, 0xda, 0x41, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x60, 0x5a, 0x29, 0x12, 0x27, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74,
	...
	0x73, 0x12, 0x33, 0x2f, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x7b, 0x70, 0x61, 0x72,
	0x65, 0x6e, 0x74, 0x3d, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x2a, 0x2f, 0x6c,
	0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x2a, 0x7d, 0x2f, 0x67, 0x65, 0x6e, 0x65,
	0x72, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x12, 0xa6, 0x01, 0x0a, 0x0f, 0x44, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x37, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x35, 0x2a, 0x33, 0x2f, 0x76, 0x32, 0x62,
	...
	,
	...
	0x68, 0x2f, 0x64, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x42, 0xa0, 0x02, 0xea,
	0x41, 0x7a, 0x0a, 0x25, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x79, 0x65, 0x6e, 0x67,
	0x69, 0x6e, 0x65, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x70, 0x69, 0x73, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x45, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x12, 0x51, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	...
	0x6e, 0x65, 0x73, 0x2f, 0x7b, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x7d, 0x0a, 0x23, 0x63, 0x6f,
	0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x64,
	0x69, 0x61, 0x6c, 0x6f, 0x67, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x76, 0x32, 0x62, 0x65, 0x74, 0x61,
	0x31, 0x42, 0x0e, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x50, 0x72, 0x6f, 0x74,
...
var file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_google_cloud_dialogflow_v2beta1_generator_proto_goTypes = []any{
	...
	(*SearchConfig)(nil),                                  // 17: google.cloud.dialogflow.v2beta1.SearchConfig
	(*SummarizationSection)(nil),                          // 18: google.cloud.dialogflow.v2beta1.SummarizationSection
	(*SummarizationContext)(nil),                          // 19: google.cloud.dialogflow.v2beta1.SummarizationContext
	(*TranslationCustomization)(nil),                      // 20: google.cloud.dialogflow.v2beta1.TranslationCustomization
	(*TranslationContext)(nil),                            // 21: google.cloud.dialogflow.v2beta1.TranslationContext
	(*FreeFormContext)(nil),                               // 22: google.cloud.dialogflow.v2beta1.FreeFormContext
	(*Generator)(nil),                                     // 23: google.cloud.dialogflow.v2beta1.Generator
	(*FreeFormSuggestion)(nil),                            // 24: google.cloud.dialogflow.v2beta1.FreeFormSuggestion
	(*SummarySuggestion)(nil),                             // 25: google.cloud.dialogflow.v2beta1.SummarySuggestion
	(*AgentCoachingArticleSnippet)(nil),                   // 26: google.cloud.dialogflow.v2beta1.AgentCoachingArticleSnippet
	(*AgentCoachingSuggestion)(nil),                       // 27: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion
	(*TranslationSuggestion)(nil),                         // 28: google.cloud.dialogflow.v2beta1.TranslationSuggestion
	(*GeneratorSuggestion)(nil),                           // 29: google.cloud.dialogflow.v2beta1.GeneratorSuggestion
	(*SuggestionDedupingConfig)(nil),                      // 30: google.cloud.dialogflow.v2beta1.SuggestionDedupingConfig
	(*RaiSettings)(nil),                                   // 31: google.cloud.dialogflow.v2beta1.RaiSettings
	nil,                                                   // 32: google.cloud.dialogflow.v2beta1.FewShotExample.ExtraInfoEntry
	(*TranslationCustomization_GlossaryTerm)(nil),         // 33: google.cloud.dialogflow.v2beta1.TranslationCustomization.GlossaryTerm
	(*SummarySuggestion_SummarySection)(nil),              // 34: google.cloud.dialogflow.v2beta1.SummarySuggestion.SummarySection
	(*AgentCoachingSuggestion_Sources)(nil),               // 35: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.Sources
	(*AgentCoachingSuggestion_DuplicateCheckResult)(nil),  // 36: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.DuplicateCheckResult
	(*AgentCoachingSuggestion_AgentActionSuggestion)(nil), // 37: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.AgentActionSuggestion
	(*AgentCoachingSuggestion_SampleResponse)(nil),        // 38: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.SampleResponse
	(*AgentCoachingSuggestion_DuplicateCheckResult_DuplicateSuggestion)(nil), // 39: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.DuplicateCheckResult.DuplicateSuggestion
	(*GeneratorSuggestion_ToolCallInfo)(nil),                                 // 40: google.cloud.dialogflow.v2beta1.GeneratorSuggestion.ToolCallInfo
	(*RaiSettings_RaiCategoryConfig)(nil),                                    // 41: google.cloud.dialogflow.v2beta1.RaiSettings.RaiCategoryConfig
	(*fieldmaskpb.FieldMask)(nil),                                            // 42: google.protobuf.FieldMask
	(*timestamppb.Timestamp)(nil),                                            // 43: google.protobuf.Timestamp
	(*AgentCoachingInstruction)(nil),                                         // 44: google.cloud.dialogflow.v2beta1.AgentCoachingInstruction
	(*ToolCall)(nil),                                                         // 45: google.cloud.dialogflow.v2beta1.ToolCall
	(*ToolCallResult)(nil),                                                   // 46: google.cloud.dialogflow.v2beta1.ToolCallResult
	(*emptypb.Empty)(nil),                                                    // 47: google.protobuf.Empty
}
var file_google_cloud_dialogflow_v2beta1_generator_proto_depIdxs = []int32{
	23, // 0: google.cloud.dialogflow.v2beta1.CreateGeneratorRequest.generator:type_name -> google.cloud.dialogflow.v2beta1.Generator
	23, // 1: google.cloud.dialogflow.v2beta1.ListGeneratorsResponse.generators:type_name -> google.cloud.dialogflow.v2beta1.Generator
	23, // 2: google.cloud.dialogflow.v2beta1.UpdateGeneratorRequest.generator:type_name -> google.cloud.dialogflow.v2beta1.Generator
	42, // 3: google.cloud.dialogflow.v2beta1.UpdateGeneratorRequest.update_mask:type_name -> google.protobuf.FieldMask
	1,  // 4: google.cloud.dialogflow.v2beta1.MessageEntry.role:type_name -> google.cloud.dialogflow.v2beta1.MessageEntry.Role
	43, // 5: google.cloud.dialogflow.v2beta1.MessageEntry.create_time:type_name -> google.protobuf.Timestamp
	...
	18, // 7: google.cloud.dialogflow.v2beta1.SummarizationSectionList.summarization_sections:type_name -> google.cloud.dialogflow.v2beta1.SummarizationSection
	...
	32, // 9: google.cloud.dialogflow.v2beta1.FewShotExample.extra_info:type_name -> google.cloud.dialogflow.v2beta1.FewShotExample.ExtraInfoEntry
	...
	29, // 11: google.cloud.dialogflow.v2beta1.FewShotExample.output:type_name -> google.cloud.dialogflow.v2beta1.GeneratorSuggestion
	17, // 12: google.cloud.dialogflow.v2beta1.AgentCoachingContext.search_config:type_name -> google.cloud.dialogflow.v2beta1.SearchConfig
	44, // 13: google.cloud.dialogflow.v2beta1.AgentCoachingContext.instructions:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingInstruction
	2,  // 14: google.cloud.dialogflow.v2beta1.SummarizationSection.type:type_name -> google.cloud.dialogflow.v2beta1.SummarizationSection.Type
	18, // 15: google.cloud.dialogflow.v2beta1.SummarizationContext.summarization_sections:type_name -> google.cloud.dialogflow.v2beta1.SummarizationSection
	14, // 16: google.cloud.dialogflow.v2beta1.SummarizationContext.few_shot_examples:type_name -> google.cloud.dialogflow.v2beta1.FewShotExample
	33, // 17: google.cloud.dialogflow.v2beta1.TranslationCustomization.glossary_terms:type_name -> google.cloud.dialogflow.v2beta1.TranslationCustomization.GlossaryTerm
	20, // 18: google.cloud.dialogflow.v2beta1.TranslationContext.translation_customization:type_name -> google.cloud.dialogflow.v2beta1.TranslationCustomization
	22, // 19: google.cloud.dialogflow.v2beta1.Generator.free_form_context:type_name -> google.cloud.dialogflow.v2beta1.FreeFormContext
	16, // 20: google.cloud.dialogflow.v2beta1.Generator.agent_coaching_context:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingContext
	19, // 21: google.cloud.dialogflow.v2beta1.Generator.summarization_context:type_name -> google.cloud.dialogflow.v2beta1.SummarizationContext
	21, // 22: google.cloud.dialogflow.v2beta1.Generator.translation_context:type_name -> google.cloud.dialogflow.v2beta1.TranslationContext
	15, // 23: google.cloud.dialogflow.v2beta1.Generator.inference_parameter:type_name -> google.cloud.dialogflow.v2beta1.InferenceParameter
	0,  // 24: google.cloud.dialogflow.v2beta1.Generator.trigger_event:type_name -> google.cloud.dialogflow.v2beta1.TriggerEvent
	43, // 25: google.cloud.dialogflow.v2beta1.Generator.create_time:type_name -> google.protobuf.Timestamp
	43, // 26: google.cloud.dialogflow.v2beta1.Generator.update_time:type_name -> google.protobuf.Timestamp
	30, // 27: google.cloud.dialogflow.v2beta1.Generator.suggestion_deduping_config:type_name -> google.cloud.dialogflow.v2beta1.SuggestionDedupingConfig
	34, // 28: google.cloud.dialogflow.v2beta1.SummarySuggestion.summary_sections:type_name -> google.cloud.dialogflow.v2beta1.SummarySuggestion.SummarySection
	44, // 29: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.applicable_instructions:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingInstruction
	26, // 30: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.applicable_article_snippets:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingArticleSnippet
	37, // 31: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.agent_action_suggestions:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.AgentActionSuggestion
	38, // 32: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.sample_responses:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.SampleResponse
	11, // 33: google.cloud.dialogflow.v2beta1.TranslationSuggestion.original_message:type_name -> google.cloud.dialogflow.v2beta1.MessageEntry
	11, // 34: google.cloud.dialogflow.v2beta1.TranslationSuggestion.translated_message:type_name -> google.cloud.dialogflow.v2beta1.MessageEntry
	24, // 35: google.cloud.dialogflow.v2beta1.GeneratorSuggestion.free_form_suggestion:type_name -> google.cloud.dialogflow.v2beta1.FreeFormSuggestion
	25, // 36: google.cloud.dialogflow.v2beta1.GeneratorSuggestion.summary_suggestion:type_name -> google.cloud.dialogflow.v2beta1.SummarySuggestion
	27, // 37: google.cloud.dialogflow.v2beta1.GeneratorSuggestion.agent_coaching_suggestion:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion
	28, // 38: google.cloud.dialogflow.v2beta1.GeneratorSuggestion.translation_suggestion:type_name -> google.cloud.dialogflow.v2beta1.TranslationSuggestion
	40, // 39: google.cloud.dialogflow.v2beta1.GeneratorSuggestion.tool_call_info:type_name -> google.cloud.dialogflow.v2beta1.GeneratorSuggestion.ToolCallInfo
	41, // 40: google.cloud.dialogflow.v2beta1.RaiSettings.rai_category_configs:type_name -> google.cloud.dialogflow.v2beta1.RaiSettings.RaiCategoryConfig
	39, // 41: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.DuplicateCheckResult.duplicate_suggestions:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.DuplicateCheckResult.DuplicateSuggestion
	35, // 42: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.AgentActionSuggestion.sources:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.Sources
	36, // 43: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.AgentActionSuggestion.duplicate_check_result:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.DuplicateCheckResult
	35, // 44: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.SampleResponse.sources:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.Sources
	36, // 45: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.SampleResponse.duplicate_check_result:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.DuplicateCheckResult
	35, // 46: google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.DuplicateCheckResult.DuplicateSuggestion.sources:type_name -> google.cloud.dialogflow.v2beta1.AgentCoachingSuggestion.Sources
	45, // 47: google.cloud.dialogflow.v2beta1.GeneratorSuggestion.ToolCallInfo.tool_call:type_name -> google.cloud.dialogflow.v2beta1.ToolCall
	46, // 48: google.cloud.dialogflow.v2beta1.GeneratorSuggestion.ToolCallInfo.tool_call_result:type_name -> google.cloud.dialogflow.v2beta1.ToolCallResult
	3,  // 49: google.cloud.dialogflow.v2beta1.RaiSettings.RaiCategoryConfig.category:type_name -> google.cloud.dialogflow.v2beta1.RaiSettings.RaiCategoryConfig.RaiCategory
	4,  // 50: google.cloud.dialogflow.v2beta1.RaiSettings.RaiCategoryConfig.sensitivity_level:type_name -> google.cloud.dialogflow.v2beta1.RaiSettings.RaiCategoryConfig.SensitivityLevel
	5,  // 51: google.cloud.dialogflow.v2beta1.Generators.CreateGenerator:input_type -> google.cloud.dialogflow.v2beta1.CreateGeneratorRequest
	6,  // 52: google.cloud.dialogflow.v2beta1.Generators.GetGenerator:input_type -> google.cloud.dialogflow.v2beta1.GetGeneratorRequest
	7,  // 53: google.cloud.dialogflow.v2beta1.Generators.ListGenerators:input_type -> google.cloud.dialogflow.v2beta1.ListGeneratorsRequest
	9,  // 54: google.cloud.dialogflow.v2beta1.Generators.DeleteGenerator:input_type -> google.cloud.dialogflow.v2beta1.DeleteGeneratorRequest
	10, // 55: google.cloud.dialogflow.v2beta1.Generators.UpdateGenerator:input_type -> google.cloud.dialogflow.v2beta1.UpdateGeneratorRequest
	23, // 56: google.cloud.dialogflow.v2beta1.Generators.CreateGenerator:output_type -> google.cloud.dialogflow.v2beta1.Generator
	23, // 57: google.cloud.dialogflow.v2beta1.Generators.GetGenerator:output_type -> google.cloud.dialogflow.v2beta1.Generator
	8,  // 58: google.cloud.dialogflow.v2beta1.Generators.ListGenerators:output_type -> google.cloud.dialogflow.v2beta1.ListGeneratorsResponse
	47, // 59: google.cloud.dialogflow.v2beta1.Generators.DeleteGenerator:output_type -> google.protobuf.Empty
	23, // 60: google.cloud.dialogflow.v2beta1.Generators.UpdateGenerator:output_type -> google.cloud.dialogflow.v2beta1.Generator
...
func file_google_cloud_dialogflow_v2beta1_generator_proto_init() {
	...
	file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[18].OneofWrappers = []any{
		(*Generator_FreeFormContext)(nil),
		(*Generator_AgentCoachingContext)(nil),
		(*Generator_SummarizationContext)(nil),
		(*Generator_TranslationContext)(nil),
		(*Generator_PublishedModel)(nil),
	}
	file_google_cloud_dialogflow_v2beta1_generator_proto_msgTypes[24].OneofWrappers = []any{
		...
		(*GeneratorSuggestion_TranslationSuggestion)(nil),
	}
	type x struct{}
