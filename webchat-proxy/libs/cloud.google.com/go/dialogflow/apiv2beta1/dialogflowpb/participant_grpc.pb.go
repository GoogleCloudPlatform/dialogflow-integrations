...
const (
	...
	Participants_SuggestSmartComposeAnswers_FullMethodName  = "/google.cloud.dialogflow.v2beta1.Participants/SuggestSmartComposeAnswers"
	Participants_SuggestDialogflowAssists_FullMethodName    = "/google.cloud.dialogflow.v2beta1.Participants/SuggestDialogflowAssists"
	...
	Participants_BidiEndpointInteract_FullMethodName        = "/google.cloud.dialogflow.v2beta1.Participants/BidiEndpointInteract"
)
...
type ParticipantsClient interface {
	...
	// Gets smart compose suggestions for a participant based on specific
	// historical messages.
	SuggestSmartComposeAnswers(ctx context.Context, in *SuggestSmartComposeAnswersRequest, opts ...grpc.CallOption) (*SuggestSmartComposeAnswersResponse, error)
	// Gets Dialogflow assist answers for a participant based on specific
	// historical messages.
	SuggestDialogflowAssists(ctx context.Context, in *SuggestDialogflowAssistsRequest, opts ...grpc.CallOption) (*SuggestDialogflowAssistsResponse, error)
	...
	// Bidirectional interaction of an endpoint with the conversation.
	// The endpoint sends messages and events to the conversation and receives
	// messages from the conversation about other endpoints or the conversation
	// itself.
	BidiEndpointInteract(ctx context.Context, opts ...grpc.CallOption) (Participants_BidiEndpointInteractClient, error)
}
...
func (c *participantsClient) SuggestSmartComposeAnswers(ctx context.Context, in *SuggestSmartComposeAnswersRequest, opts ...grpc.CallOption) (*SuggestSmartComposeAnswersResponse, error) {
	out := new(SuggestSmartComposeAnswersResponse)
	err := c.cc.Invoke(ctx, Participants_SuggestSmartComposeAnswers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *participantsClient) SuggestDialogflowAssists(ctx context.Context, in *SuggestDialogflowAssistsRequest, opts ...grpc.CallOption) (*SuggestDialogflowAssistsResponse, error) {
	out := new(SuggestDialogflowAssistsResponse)
	err := c.cc.Invoke(ctx, Participants_SuggestDialogflowAssists_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *participantsClient) BidiEndpointInteract(ctx context.Context, opts ...grpc.CallOption) (Participants_BidiEndpointInteractClient, error) {
	stream, err := c.cc.NewStream(ctx, &Participants_ServiceDesc.Streams[2], Participants_BidiEndpointInteract_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &participantsBidiEndpointInteractClient{stream}
	return x, nil
}

type Participants_BidiEndpointInteractClient interface {
	Send(*BidiEndpointInteractRequest) error
	Recv() (*BidiEndpointInteractResponse, error)
	grpc.ClientStream
}

type participantsBidiEndpointInteractClient struct {
	grpc.ClientStream
}

func (x *participantsBidiEndpointInteractClient) Send(m *BidiEndpointInteractRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *participantsBidiEndpointInteractClient) Recv() (*BidiEndpointInteractResponse, error) {
	m := new(BidiEndpointInteractResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type ParticipantsServer interface {
	...
	// Gets smart compose suggestions for a participant based on specific
	// historical messages.
	SuggestSmartComposeAnswers(context.Context, *SuggestSmartComposeAnswersRequest) (*SuggestSmartComposeAnswersResponse, error)
	// Gets Dialogflow assist answers for a participant based on specific
	// historical messages.
	SuggestDialogflowAssists(context.Context, *SuggestDialogflowAssistsRequest) (*SuggestDialogflowAssistsResponse, error)
	// Gets knowledge assist suggestions based on historical messages.
	...
	// messages from the conversation about other endpoints or the conversation
	// itself.
	BidiEndpointInteract(Participants_BidiEndpointInteractServer) error
}
...
func (UnimplementedParticipantsServer) SuggestSmartComposeAnswers(context.Context, *SuggestSmartComposeAnswersRequest) (*SuggestSmartComposeAnswersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SuggestSmartComposeAnswers not implemented")
}
func (UnimplementedParticipantsServer) SuggestDialogflowAssists(context.Context, *SuggestDialogflowAssistsRequest) (*SuggestDialogflowAssistsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SuggestDialogflowAssists not implemented")
}
...
func (UnimplementedParticipantsServer) BidiEndpointInteract(Participants_BidiEndpointInteractServer) error {
	return status.Errorf(codes.Unimplemented, "method BidiEndpointInteract not implemented")
}
...
func _Participants_SuggestSmartComposeAnswers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SuggestSmartComposeAnswersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ParticipantsServer).SuggestSmartComposeAnswers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Participants_SuggestSmartComposeAnswers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParticipantsServer).SuggestSmartComposeAnswers(ctx, req.(*SuggestSmartComposeAnswersRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Participants_SuggestDialogflowAssists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SuggestDialogflowAssistsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ParticipantsServer).SuggestDialogflowAssists(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Participants_SuggestDialogflowAssists_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParticipantsServer).SuggestDialogflowAssists(ctx, req.(*SuggestDialogflowAssistsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Participants_BidiEndpointInteract_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ParticipantsServer).BidiEndpointInteract(&participantsBidiEndpointInteractServer{stream})
}

type Participants_BidiEndpointInteractServer interface {
	Send(*BidiEndpointInteractResponse) error
	Recv() (*BidiEndpointInteractRequest, error)
	grpc.ServerStream
}

type participantsBidiEndpointInteractServer struct {
	grpc.ServerStream
}

func (x *participantsBidiEndpointInteractServer) Send(m *BidiEndpointInteractResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *participantsBidiEndpointInteractServer) Recv() (*BidiEndpointInteractRequest, error) {
	m := new(BidiEndpointInteractRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var Participants_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SuggestSmartComposeAnswers",
			Handler:    _Participants_SuggestSmartComposeAnswers_Handler,
		},
		{
			MethodName: "SuggestDialogflowAssists",
			Handler:    _Participants_SuggestDialogflowAssists_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "BidiEndpointInteract",
			Handler:       _Participants_BidiEndpointInteract_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
