...
const (
	Documents_ListDocuments_FullMethodName    = "/google.cloud.dialogflow.v2beta1.Documents/ListDocuments"
	Documents_GetDocument_FullMethodName      = "/google.cloud.dialogflow.v2beta1.Documents/GetDocument"
	Documents_CreateDocument_FullMethodName   = "/google.cloud.dialogflow.v2beta1.Documents/CreateDocument"
	Documents_ImportDocuments_FullMethodName  = "/google.cloud.dialogflow.v2beta1.Documents/ImportDocuments"
	Documents_DeleteDocument_FullMethodName   = "/google.cloud.dialogflow.v2beta1.Documents/DeleteDocument"
	Documents_UpdateDocument_FullMethodName   = "/google.cloud.dialogflow.v2beta1.Documents/UpdateDocument"
	Documents_ReloadDocument_FullMethodName   = "/google.cloud.dialogflow.v2beta1.Documents/ReloadDocument"
	Documents_ExportDocument_FullMethodName   = "/google.cloud.dialogflow.v2beta1.Documents/ExportDocument"
	Documents_GenerateDocument_FullMethodName = "/google.cloud.dialogflow.v2beta1.Documents/GenerateDocument"
)
...
type DocumentsClient interface {
	...
	//
	// - `metadata`:
	// [GenerateDocumentOperationMetadata][google.cloud.dialogflow.v2beta1.GenerateDocumentOperationMetadata]
	// - `response`: [Document][google.cloud.dialogflow.v2beta1.Document]
	GenerateDocument(ctx context.Context, in *GenerateDocumentRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
}
...
func (c *documentsClient) GenerateDocument(ctx context.Context, in *GenerateDocumentRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, Documents_GenerateDocument_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DocumentsServer interface {
	...
	// [GenerateDocumentOperationMetadata][google.cloud.dialogflow.v2beta1.GenerateDocumentOperationMetadata]
	// - `response`: [Document][google.cloud.dialogflow.v2beta1.Document]
	GenerateDocument(context.Context, *GenerateDocumentRequest) (*longrunningpb.Operation, error)
}
...
func (UnimplementedDocumentsServer) GenerateDocument(context.Context, *GenerateDocumentRequest) (*longrunningpb.Operation, error) {
...
func _Documents_GenerateDocument_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateDocumentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DocumentsServer).GenerateDocument(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Documents_GenerateDocument_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocumentsServer).GenerateDocument(ctx, req.(*GenerateDocumentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Documents_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Documents_GenerateDocument_Handler,
		},
	},
